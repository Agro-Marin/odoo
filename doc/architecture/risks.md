...
gate — all 55 are structural and DB-free — and not caught by either DB-free test
tier.
...
**What.** The 55 boundary checkers read import graphs, call graphs,
reached-member sets and documents. None executes the framework. A change can
satisfy all 55 and both DB-free tiers and still be wrong.
