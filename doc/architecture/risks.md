...
| R4 | "Enforced" means structural only — 61 gates cannot see behaviour | High | 2026-08-08 | — |
...
gate — all 61 are structural and DB-free — and not caught by either DB-free test
tier.
...
**What.** The 61 boundary checkers read import graphs, call graphs,
reached-member sets and documents. None executes the framework. A change can
satisfy all 61 and both DB-free tiers and still be wrong.
