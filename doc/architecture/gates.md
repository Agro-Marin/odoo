...
| `c901_addons` | the same gate over `addons/`, where the 613 bundled modules and most business logic live and complexity was unbounded. The two trees move by different hands |
