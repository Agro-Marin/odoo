...
sixty-seven boundary checkers are structural and DB-free: they read import graphs,
call graphs, reached-member sets and documents. A change can satisfy all
sixty-seven, and Tier 1 and Tier 2, and still be wrong — renaming `OrmCore`'s slots
