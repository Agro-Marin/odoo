...
| `http/` `[serving]` → `[features]` | 29 serving → features | 1 | counting import *statements*; by symbol it is 61 against 2 |
...
supplies it — **59 of the 105 come from `odoo.libs`**, the other 46 arriving
