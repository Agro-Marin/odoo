...
§2.4.3   Non-test methods declared on a model class                 25,363
...
§2.4.13  Functions nested inside model methods                         572
...
**A ``bool`` return does not make a predicate** ``[review]``. **350** functions in
