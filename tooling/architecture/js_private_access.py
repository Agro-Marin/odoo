...
MEASURED (regenerated by --update-doc; do not hand-edit)
    cross_tree=0 cross_tree_writes=0 cross_tree_addons=0 total=42 declared=0 module_internal=42 undeclared=0 writes=0 unowned=34 files=3 public_members=342
"""
