...
MEASURED (regenerated by --update-doc; do not hand-edit)
    points=492 sites=1977 single_use=272 owners=127 subclasses=1175 patch_sites=70
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.update_doc:
        changed = doc_measured.update(here, metrics(detailed))
        print(f"{'rewrote' if changed else 'already fresh:'} MEASURED block")
        return 0
    if args.check_doc:
        problems = doc_measured.check(here, metrics(detailed))
