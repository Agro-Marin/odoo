...
class StockWarehouse(models.Model):
    ...
    def _update_global_route_resupply_subcontractor(self):
        route_id = self._get_or_create_global_route('mrp_subcontracting.route_resupply_subcontractor_mto',
        ...
        rules.update({
            ...
            'subcontracting_pull_id': {
                ...
                'create_values': {
                    ...
                    'action': 'pull',
                    'auto': 'manual',
                    'route_id': self._get_or_create_global_route('mrp_subcontracting.route_resupply_subcontractor_mto', _('Resupply Subcontractor on Order')).id,
