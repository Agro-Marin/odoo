...
class AccountEdiXmlOioubl_201(models.AbstractModel):
    ...
    def _export_invoice_constraints(self, invoice, vals):
        ...
        for partner_type in ("supplier", "customer"):
            ...
            constraints[f"oioubl201_{partner_type}_vat_required"] = (
    ...
    def _add_invoice_payment_means_nodes(self, document_node, vals):
        ...
        payment_means_node["cbc:PaymentMeansCode"]["_text"] = PAYMENT_MEANS_CODE[
            "unknown"
        ]
        ...
        document_node["cac:PaymentTerms"] = [
            {
                ...
                "cbc:Amount": {
                    "_text": self.format_float(
                        sign * line.amount_currency,
                        self._get_currency_decimal_places(line.currency_id),
                    ),
    ...
    def _add_invoice_monetary_total_nodes(self, document_node, vals):
        ...
        tax_exclusive_amount = (
            monetary_total_node["cbc:TaxInclusiveAmount"]["_text"]
            - monetary_total_node["cbc:TaxExclusiveAmount"]["_text"]
        )
    ...
    def _get_party_node(self, vals):
        ...
        if partner.peppol_endpoint and partner.peppol_eas in EAS_SCHEME_ID_MAPPING:
            ...
            if (
                scheme_id in ("DK:CVR", "FR:SIRET") or scheme_id[3:] == "VAT"
            ) and endpoint_id.isnumeric():
    ...
    def _get_tax_category_node(self, vals):
        ...
        grouping_key = {
            **grouping_key,
            "tax_category_code": UBL_TO_OIOUBL_TAX_CATEGORY_ID_MAPPING.get(
                grouping_key["tax_category_code"]
            ),
        }
        tax_category_node = super()._get_tax_category_node(
        ...
        tax_category_node["cbc:ID"]["schemeAgencyID"] = (
            DANISH_NATIONAL_IT_AND_TELECOM_AGENCY_ID
        )

        tax_category_node["cac:TaxScheme"]["cbc:ID"]["schemeID"] = (
            "urn:oioubl:id:taxschemeid-1.5"
        )
