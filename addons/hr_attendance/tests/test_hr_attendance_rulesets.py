...
class TestHrAttendanceOvertime(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.company.resource_calendar_id = cls.env.company.resource_calendar_id = (
    ...
    def test_daily_overtime_8_hours_rule(self):
        with freeze_time("2021-01-04"):
            ...
            self.assertAlmostEqual(
                attendance.employee_id.total_overtime,
                2,
                2,
                msg="2 hours overtime at 150% should yield 2 hours total overtime",
            )
    ...
    def test_daily_overtime_10_hours_rule(self):
        ...
        with freeze_time("2021-01-04"):
            ...
            self.assertAlmostEqual(
                ...
                4.0,
                2,
                msg="2 hours overtime at 200% should yield 4 hours total overtime",
            )
    ...
    def test_no_overtime(self):
        ...
        with freeze_time("2021-01-04"):
            ...
            self.assertAlmostEqual(
                ...
                0.0,
                2,
                msg="No overtime should be recorded for 8 hours or less",
            )
    ...
    def test_partial_week(self):
        ...
        with freeze_time("2021-01-04"):
            ...
            self.assertAlmostEqual(
                ...
                12.0,
                2,
                msg="3 days of 2 hours overtime at 200% should yield 12 hours total overtime",
            )
