...
class TestHrAttendanceOvertime(HttpCase):
        ...
        early_attendance2 = self.env["hr.attendance"].create(
            {
                ...
                "check_in": datetime(
                    2024, 5, 30, 3, 0
                ),  # 23:00 NY prev day -- attendance should be for the 29th
    ...
    def test_auto_check_out_lunch_period(self):
        ...
        with freeze_time("2024-01-01 22:00:00"):
            ...
            self.assertEqual(
                morning.worked_hours + afternoon.worked_hours, 9
            )  # 8 hours from calendar's attendances + 1 hour of tolerance
