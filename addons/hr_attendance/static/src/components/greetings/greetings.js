...
export class KioskGreetings extends Component {
    ...
    setup() {
        ...
        if (this.props.employeeData.display_overtime) {
            this.overtimeToday = this.formatFloatTime(
                this.props.employeeData.overtime_today,
            );
            this.totalOvertime = this.formatFloatTime(
                this.props.employeeData.total_overtime,
            );
        }
