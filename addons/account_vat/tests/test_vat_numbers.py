...
class TestStructure(TransactionCase):
    ...
    def test_parent_validation(self):
        ...
        with patch('odoo.addons.account_vat.models.res_partner.check_vies', type(self)._vies_check_func):
    ...
    def test_no_vies_revalidation_when_creating_company_from_contact(self):
        ...
        with patch('odoo.addons.account_vat.models.res_partner.check_vies',
