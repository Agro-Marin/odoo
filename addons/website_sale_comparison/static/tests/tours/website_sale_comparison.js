...
registry.category("web_tour.tours").add("product_comparison", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger:
                '[name="product_comparison_bottom_bar_row"]:contains("Color T-Shirt")',
        },
        {
            content: "check products name are correct in the comparelist",
            trigger:
                '[name="product_comparison_bottom_bar_row"]:contains("Color Pants")',
        },
        {
        ...
        },
        {
            ...
            trigger:
                '[name="product_comparison_bottom_bar_row"]:not(:contains("Color T-Shirt"))',
        },
        {
        ...
        },
        {
            ...
            trigger:
                '[name="product_comparison_bottom_bar_row"]:contains("Color Shoes (Red)")',
        },
        {
        ...
        {
            content:
                "click on compare button to add in comparison list when variant changed",
            trigger: ".o_add_compare_dyn",
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger:
                '.o_notification:contains("You can compare up to 4 products at a time.")',
        },
        {
        ...
        },
        {
            ...
            trigger:
                '.product_summary:contains("Color Pants") button:contains("Add to Cart")',
            run: "click",
        },
        clickOnElement(
            "Add to cart",
