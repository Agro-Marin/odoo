...
class TestFrenchLeaves(TransactionCase):
    ...
    def test_no_differences(self):
        ...
        self.assertEqual(
            leave.number_of_days, 5, "The number of days should be equal to 5."
        )
    ...
    def test_last_day_half(self):
        ...
        self.assertEqual(
            leave.number_of_days, 0.5, "The number of days should be equal to 0.5."
        )
        leave.request_date_from_period = "pm"
        leave.request_date_to_period = "pm"
        # This however should push the date_to
        self.assertEqual(
            leave.number_of_days, 2.5, "The number of days should be equal to 2.5."
        )
    ...
    def test_2_weeks_calendar(self):
        ...
        self.assertEqual(
            leave.number_of_days, 3, "The number of days should be equal to 3."
        )
        leave.unlink()
        ...
        self.assertEqual(
            leave.number_of_days, 8, "The number of days should be equal to 3."
        )
        leave.unlink()
        ...
        with self.assertQueryCount(118):
            ...
            _logger.info(
                "French Leave Creation: --- %s seconds ---", time.time() - start_time
            )
        self.assertEqual(
            leave.number_of_days, 8, "The number of days should be equal to 3."
        )
    ...
    def test_leave_type_half_day_different_working_hours(self):
        ...
        self.assertNotEqual(
            ...
            8.0,
            "Company and employee hours per day should not match in this case",
        )
    ...
    def test_leave_employee_different_schedule_from_company(self):
        ...
        work_hours_data = leave_1.employee_id._list_work_time_per_day(
            leave_1.date_from, leave_1.date_to
        )
    ...
    def test_holiday_in_week(self):
        ...
        self.env["resource.calendar.leaves"].with_company(self.company).create(
            {
                "name": "Public Holiday",
                "calendar_id": False,
                "date_from": fields.Datetime.from_string("2024-12-26 00:00:00")
                .replace(tzinfo=tz)
                .astimezone(UTC)
                .replace(tzinfo=None),
                "date_to": fields.Datetime.from_string("2024-12-26 23:59:59")
                .replace(tzinfo=tz)
                .astimezone(UTC)
                .replace(tzinfo=None),
                "resource_id": False,
        ...
        self.assertEqual(
            ...
            4.0,
            "Public holidays for French part-time employees should be considered",
        )
