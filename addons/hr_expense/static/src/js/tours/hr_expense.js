...
registry.category("web_tour.tours").add("hr_expense_tour", {
    ...
    steps: () => [
        stepUtils.showAppsMenuItem(),
        {
            ...
            content: markup(
                _t(
                    "<b>Wasting time recording your receipts?</b> Let’s try a better way.",
                ),
            ),
        ...
        ...stepUtils.statusbarButtonsSteps(
            ...
            markup(
                _t(
                    "Once your <b>Expense</b> is ready, you can submit it to your manager and wait for approval.",
                ),
            ),
        ),
        {
        ...
        },
        {
            ...
            content: _t(
                "The status of all your current expenses is visible from here.",
            ),
            tooltipPosition: "bottom",
            run: "click",
        },
        ...
        },
        {
            ...
            content: _t(
                "Let's check out where you can manage all your employees expenses",
            ),
            tooltipPosition: "bottom",
            run: "click",
        },
        ...
        ...stepUtils.statusbarButtonsSteps(
            _t("Approve"),
            _t(
                "Managers can approve the expense here, then an accountant can post the accounting entries.",
            ),
        ),
    ],
});
