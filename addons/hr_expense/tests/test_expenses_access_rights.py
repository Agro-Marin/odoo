...
class TestExpensesAccessRights(TestExpenseCommon, HttpCase):
    ...
    def test_expense_access_rights_user(self):
        ...
        self.start_tour(
            "/odoo", "hr_expense_access_rights_test_tour", login="test-expense"
        )
    ...
    def test_expense_team_approver_cant_approve_expense_of_employee_he_does_not_manage(
        self,
    ):
        another_standard_user = new_test_user(
            self.env, login="another_standard_user", groups="base.group_user"
        )
        another_standard_user_team_approver = new_test_user(
            self.env,
            login="another_standard_user_manager",
        ...
        expense = (
            self.env["hr.expense"]
            .with_user(another_standard_user)
            .create(
                {
                    "name": "Superboy costume washing",
