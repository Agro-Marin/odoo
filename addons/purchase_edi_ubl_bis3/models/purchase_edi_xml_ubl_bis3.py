...
class PurchaseEdiXmlUbl_Bis3(models.AbstractModel):
    ...
    def _add_purchase_order_base_lines_vals(self, vals):
        ...
        base_lines = [
            ...
            for line in purchase_order.line_ids.filtered(
        ...
        document_node.update(
            {
                ...
                "cbc:Note": {"_text": html2plaintext(purchase_order.notes)}
    ...
    def _prepare_order_vals(self, order, tree):
        ...
        allowance_charges_line_vals, allowance_charges_logs = (
            self._import_document_allowance_charges(tree, order, "purchase")
        )
