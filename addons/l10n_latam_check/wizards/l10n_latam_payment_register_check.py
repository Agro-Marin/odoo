...
class L10n_LatamPaymentRegisterCheck(models.TransientModel):
    ...
    @api.depends('payment_register_id.payment_channel_id.code', 'payment_register_id.partner_id')
    def _compute_bank_id(self):
        new_third_party_checks = self.filtered(lambda x: x.payment_register_id.payment_channel_id.code == 'new_third_party_checks')
