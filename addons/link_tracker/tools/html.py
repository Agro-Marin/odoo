...
def find_links_with_urls_and_labels(
    root_nodes, base_url, skip_regex=None, skip_prefix=None, skip_list=None
):
...
def _get_label_from_elements(
    elements: Iterable[etree._Element], image_prefix: str = "[media] "
) -> str:
