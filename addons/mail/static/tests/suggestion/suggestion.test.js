...
test("[text composer] mention a channel thread", async () => {
    ...
    await contains(".o-mail-Composer-suggestion:eq(1):has(i.fa-comments)", {
    ...
    await press("Enter");
    await contains(".o-mail-Message a.o_channel_redirect:has(i.fa-comments)", {
...
test("mention a channel thread", async () => {
    ...
    await click(".o-mail-Composer-suggestion:eq(1)");
    await contains(
        ".o-mail-Composer-html.odoo-editor-editable a.o_channel_redirect:has(i.fa-comments)",
        { text: "General > ThreadOne" }
    );
    await press("Enter");
    await contains(".o-mail-Message a.o_channel_redirect:has(i.fa-comments)", {
