...
class DiscussChannelMember(models.Model):
    ...
    seen_message_id = fields.Many2one(
    ...
    rtc_inviting_session_id = fields.Many2one(
    ...
    def _constrains_no_public_member(self):
        for member in self:
        ...
        return [
            ...
            Store.Attr(
                ...
                lambda m: Store.One(
                    ...
                    extra_fields=(
                        self.env["res.partner"]._get_store_mention_fields()
