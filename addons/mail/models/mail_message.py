...
class MailMessage(models.Model):
    ...
    message_type = fields.Selection(
        ...
        "\n'mail_poll': generated for a poll",
    )
    ...
    ended_poll_ids: MailPoll = fields.One2many("mail.poll", "end_message_id")
    started_poll_ids: MailPoll = fields.One2many("mail.poll", "start_message_id")
    ...
    def _is_empty(self) -> bool:
        ...
        return (
            ...
            and not (
                self.message_type == "mail_poll"
                and (self.started_poll_ids or self.ended_poll_ids)
            )
        )
