...
(technically: Server Actions) to be triggered for each incoming mail.
    ...
    "assets": {
        ...
        "mail.assets_discuss_public_test_tours": [
            ...
            # Keep tour_recorder_state.js — tour_service.js imports it.
            # Only remove the recorder UI component and its template.
            ("remove", "web_tour/static/src/js/tour_recorder/tour_recorder.js"),
            ("remove", "web_tour/static/src/js/tour_recorder/tour_recorder.xml"),
        ...
        "web.assets_unit_tests": [
            ...
            ),  # to remove when all legacy tests are ported
