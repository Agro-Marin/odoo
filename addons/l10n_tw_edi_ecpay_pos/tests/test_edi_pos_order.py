...
class L10nTWITestEdiPosOrder(L10nTWITestEdi, TestPoSCommon):
    ...
    def test_01_pos_data_to_invoice(self):
        ...
        with self.with_pos_session():
            ...
            self.assertEqual(
                invoice.l10n_tw_edi_carrier_type, order.l10n_tw_edi_carrier_type
            )
            self.assertEqual(
                invoice.l10n_tw_edi_carrier_number, order.l10n_tw_edi_carrier_number
            )
    ...
    def test_02_invoiced_order_then_invoiced_refund(self):
        with self.with_pos_session():
            ...
            self.assertEqual(
                refund.account_move.l10n_tw_edi_ecpay_invoice_id,
                invoice.l10n_tw_edi_ecpay_invoice_id,
            )
            self.assertEqual(
                refund.account_move.l10n_tw_edi_invoice_create_date,
                invoice.l10n_tw_edi_invoice_create_date,
            )
