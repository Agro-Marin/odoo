...
registry
    .category("web_tour.tours")
    .add("l10n_tw_edi_ecpay_pos.ecpay_check_love_code_tour", {
        steps: () =>
            [
                Chrome.startPoS(),
                Dialog.confirm("Open Register"),
...
registry
    .category("web_tour.tours")
    .add("l10n_tw_edi_ecpay_pos.ecpay_check_print_invoice_tour", {
        steps: () =>
            [
                Chrome.startPoS(),
                Dialog.confirm("Open Register"),
...
registry
    .category("web_tour.tours")
    .add("l10n_tw_edi_ecpay_pos.ecpay_toggle_invoice_tour", {
        steps: () =>
            [
                Chrome.startPoS(),
                Dialog.confirm("Open Register"),
