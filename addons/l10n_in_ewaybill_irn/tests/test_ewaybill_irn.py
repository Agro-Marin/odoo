...
class TestEwaybillJson(L10nInTestInvoicingCommon):
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.env.company.write({"l10n_in_edi_feature": True})
        cls.invoice_a = cls.init_invoice(
            "out_invoice", post=True, products=cls.product_a, partner=cls.partner_a
        )
    ...
    def test_ewaybill_irn(self):
        ...
        self.partner_b.write({"vat": False, "name": "Atlas"})
