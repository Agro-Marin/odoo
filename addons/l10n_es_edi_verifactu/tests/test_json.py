...
class TestL10nEsEdiVerifactuJson(TestL10nEsEdiVerifactuCommon):
    ...
    def test_huella_generation(self):
        ...
        fingerprint = self.env["l10n_es_edi_verifactu.document"]._fingerprint(
            render_values
        )
        self.assertEqual(
            fingerprint,
    ...
    def test_invoice_1_and_credit_note(self):
                    ...
                    Command.create(
                        {
                            ...
                            "price_unit": 100.0,
                            "tax_ids": [Command.set(self.tax21_goods.ids)],
                        }
                    ),
                    Command.create(
                        {
                            "product_id": self.product_1.id,
                            "price_unit": 200.0,
                            "tax_ids": [Command.set(self.tax21_services.ids)],
                        }
                    ),
                    Command.create(
                        {
                            "product_id": self.product_1.id,
                            "price_unit": 1000.0,
                            "tax_ids": [Command.set(self.tax10_goods.ids)],
                        }
                    ),
                ],
            }
        ...
        self.assertEqual(
            batch_dict,
            self._json_file_to_dict(
                "l10n_es_edi_verifactu/tests/files/test_invoice_1.json"
            ),
        )
        ...
        with self._mock_last_document(None):
            document = credit_note._l10n_es_edi_verifactu_create_documents()[
                credit_note
            ]
        self.assertFalse(document.errors)
        with self._mock_zeep_registration_operation_certificate_issue():
        ...
        self.assertEqual(
            batch_dict,
            self._json_file_to_dict(
                "l10n_es_edi_verifactu/tests/files/test_invoice_1_credit_note.json"
            ),
        )
    ...
    def test_invoice_1_and_substitution(self):
        ...
        self.assertEqual(
            batch_dict,
            self._json_file_to_dict(
                "l10n_es_edi_verifactu/tests/files/test_invoice_1_reversal_for_substitution.json"
            ),
        )
        ...
        with self._mock_last_document(None):
            document = substitution_move._l10n_es_edi_verifactu_create_documents()[
                substitution_move
            ]
        self.assertFalse(document.errors)
        with self._mock_zeep_registration_operation_certificate_issue():
        ...
        self.assertEqual(
            batch_dict,
            self._json_file_to_dict(
                "l10n_es_edi_verifactu/tests/files/test_invoice_1_correction_substitution.json"
            ),
        )
    ...
    def test_invoice_2(self):
                    ...
                    Command.create(
                        {
                            ...
                            "tax_ids": [
                                Command.set(
                                    (
                                        self.tax10_goods + self.tax1p4_services_recargo
                                    ).ids
                                )
                            ],
                        }
        ...
        self.assertEqual(
            batch_dict,
            self._json_file_to_dict(
                "l10n_es_edi_verifactu/tests/files/test_invoice_2.json"
            ),
        )
    ...
    def test_invoice_3(self):
                    ...
                    Command.create(
                        {
                            ...
                            "tax_ids": [
                                Command.set(
                                    (self.tax10_goods + self.tax1_withholding).ids
                                )
                            ],
                        }
                    ),
        ...
        self.assertEqual(
            batch_dict,
            self._json_file_to_dict(
                "l10n_es_edi_verifactu/tests/files/test_invoice_3.json"
            ),
        )
    ...
    def test_invoice_4(self):
        ...
        self.assertEqual(
            batch_dict,
            self._json_file_to_dict(
                "l10n_es_edi_verifactu/tests/files/test_invoice_4.json"
            ),
        )
    ...
    def test_invoice_export(self):
                    ...
                    Command.create(
                        {
                            "product_id": self.product_1.id,
                            "price_unit": 100.0,
                            "tax_ids": [Command.set(self.tax0_exento_export.ids)],
                        }
                    ),
                ],
            }
        ...
        self.assertEqual(
            batch_dict,
            self._json_file_to_dict(
                "l10n_es_edi_verifactu/tests/files/test_invoice_export.json"
            ),
        )
    ...
    def test_invoice_multicurrency_1(self):
        ...
        self.assertEqual(
            batch_dict,
            self._json_file_to_dict(
                "l10n_es_edi_verifactu/tests/files/test_invoice_multi_currency_1.json"
            ),
        )
    ...
    def test_multiple_invoices_with_predecessor(self):
        ...
        dummy_start_document = (
            self.env["l10n_es_edi_verifactu.document"]
            .sudo()
            .create(
                [
                    {
        ...
        dummy_start_document.sudo().json_attachment_id = (
        ...
        with self._mock_last_document(dummy_start_document):
            document1_reversed = invoices[0]._l10n_es_edi_verifactu_create_documents()[
                invoices[0]
            ]
        ...
        document1 = invoices[0]._l10n_es_edi_verifactu_create_documents(
            cancellation=True
        )[invoices[0]]
        ...
        self.assertEqual(
            batch_dict,
            self._json_file_to_dict(
                "l10n_es_edi_verifactu/tests/files/test_multiple_invoices_with_predecessor.json"
            ),
        )
    ...
    def test_invoice_cancellation_1(self):
        ...
        with self._mock_last_document(None):
            invoice_document = invoice._l10n_es_edi_verifactu_create_documents()[
                invoice
            ]
        ...
        cancellation_document = invoice._l10n_es_edi_verifactu_create_documents(
            cancellation=True
        )[invoice]
        ...
        self.assertEqual(
            batch_dict,
            self._json_file_to_dict(
                "l10n_es_edi_verifactu/tests/files/test_invoice_cancellation_1.json"
            ),
        )
    ...
    def test_invoice_simplified_partner(self):
        ...
        self.assertEqual(
            batch_dict,
            self._json_file_to_dict(
                "l10n_es_edi_verifactu/tests/files/test_invoice_simplified_partner.json"
            ),
        )
