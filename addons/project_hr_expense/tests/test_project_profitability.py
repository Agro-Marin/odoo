...
class TestProjectHrExpenseProfitabilityCommon(TestExpenseCommon):
    def check_project_profitability_before_creating_and_approving_expense(
        self, expense, project, project_profitability_items_empty
    ):
...
class TestProjectHrExpenseProfitability(
    TestProjectProfitabilityCommon, TestProjectHrExpenseProfitabilityCommon
):
    def test_project_profitability(self):
        ...
        self.check_project_profitability_before_creating_and_approving_expense(
            expense, self.project, self.project_profitability_items_empty
        )
