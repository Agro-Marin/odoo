...
class TestUtm(TestUTMCommon):
    ...
    def test_find_or_create_record(self):
        ...
        source_3_2 = self.env['mixin.utm']._get_or_create_record('utm.source', 'Source 3 [2]')
        ...
        source_4_2 = self.env['mixin.utm']._get_or_create_record('utm.source', 'Source 4 [2]')
        self.assertNotIn(source_4_2, source_1 | source_2 | source_3 | source_3_2)
        self.assertEqual(source_4_2.name, 'Source 4 [2]')
        source_4_2_bis = self.env['mixin.utm']._get_or_create_record('utm.source', 'Source 4 [2]')
    ...
    def test_find_or_create_with_archived_record(self):
        ...
        campaign = self.env['mixin.utm']._get_or_create_record('utm.campaign', 'Archived Campaign')
