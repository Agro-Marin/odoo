...
class StockPicking(models.Model):
    ...
    def _compute_l10n_ar_delivery_guide_flags(self):
        ...
        for picking in self:
            ...
            picking.l10n_ar_allow_generate_delivery_guide = (
                picking.state == "done"
                and has_doc_type
                and not picking.l10n_ar_delivery_guide_number
            )
            picking.l10n_ar_allow_send_delivery_guide = bool(
    ...
    def l10n_ar_action_create_delivery_guide(self):
        ...
        if not self.l10n_ar_delivery_guide_number:
            ...
            if (
                not int(picking_type.l10n_ar_sequence_number_start)
                <= new_sequence_number
            ...
            self.l10n_ar_cai_data = {
                ...
                "cai_expiration_date": picking_type.l10n_ar_cai_expiration_date.strftime(
                    "%Y-%m-%d"
                ),
    ...
    def l10n_ar_action_send_delivery_guide(self):
        ...
        pdf_content, __ = (
            self.env["ir.actions.report"].sudo()._render_qweb_pdf(pdf_action, self.id)
        )
