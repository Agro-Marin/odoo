...
class TestPoSProductVariants(ProductVariantsCommon, TestPointOfSaleHttpCommon):
    def test_integration_dynamic_variant_price(self):
        ...
        self.start_tour(
            ...
            "test_integration_dynamic_variant_price",
            login="pos_user",
        )
    ...
    def test_integration_always_variant_price(self):
        ...
        self.start_tour(
            "/pos/ui?config_id=%d" % self.main_pos_config.id,
            "test_integration_always_variant_price",
            login="pos_user",
        )
    ...
    def test_integration_never_variant_price(self):
        ...
        self.start_tour(
            "/pos/ui?config_id=%d" % self.main_pos_config.id,
            "test_integration_never_variant_price",
            login="pos_user",
        )
    ...
    def test_integration_dynamic_always_variant_price(self):
        ...
        self.env["product.template.attribute.line"].create(
            [
                ...
                },
                {
                    ...
                    "value_ids": [
                        Command.set(
                            [self.size_attribute_s.id, self.size_attribute_m.id]
                        )
                    ],
                },
            ]
        ...
        self.env["product.product"].create(
            {
                ...
                "product_template_attribute_value_ids": [
                    (6, 0, (ptav_dyn2 + ptav_always1).ids)
                ],
                "pos_categ_ids": [Command.set(self.pos_desk_misc_test.ids)],
            }
        )
        ...
        self.start_tour(
            "/pos/ui?config_id=%d" % self.main_pos_config.id,
            "test_integration_dynamic_always_variant_price",
            login="pos_user",
        )
    ...
    def test_integration_dynamic_never_variant_price(self):
        ...
        self.start_tour(
            "/pos/ui?config_id=%d" % self.main_pos_config.id,
            "test_integration_dynamic_never_variant_price",
            login="pos_user",
        )
    ...
    def test_integration_always_never_variant_price(self):
        ...
        self.start_tour(
            "/pos/ui?config_id=%d" % self.main_pos_config.id,
            "test_integration_always_never_variant_price",
            login="pos_user",
        )
    ...
    def test_integration_dynamic_always_never_variant_price(self):
        ...
        self.env["product.product"].create(
            {
                ...
                "product_tmpl_id": product_template.id,
                "product_template_attribute_value_ids": [
                    (6, 0, (ptav_dyn2 + ptav_always1 + ptav_never1).ids)
                ],
                "pos_categ_ids": [Command.set(self.pos_desk_misc_test.ids)],
            }
        )
        ...
        self.start_tour(
            "/pos/ui?config_id=%d" % self.main_pos_config.id,
            "test_integration_dynamic_always_never_variant_price",
            login="pos_user",
        )
