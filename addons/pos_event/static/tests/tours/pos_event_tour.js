...
registry.category("web_tour.tours").add("SellingEventInPos", {
    steps: () =>
        [
            ...
            EventTourUtils.confirmIsBlocked(),
...
registry
    ...
    .add("test_orderline_price_remain_same_as_ticket_price", {
        steps: () =>
            [
                Chrome.startPoS(),
                Dialog.confirm("Open Register"),
                ...
                EventTourUtils.increaseQuantityOfTicket("Ticket VIP"),
                Dialog.confirm(),
                EventTourUtils.answerTicketSelectQuestion(
                    "1",
                    "Question1",
                    "Q1-Answer1",
                ),
...
registry.category("web_tour.tours").add("test_pos_event_registration_not_mandatory", {
    steps: () =>
        [
            ...
            EventTourUtils.increaseQuantityOfTicket("Ticket Basic"),
            Dialog.confirm(),
            EventTourUtils.answerGlobalTextQuestion("Email", "not-an-email"),
            EventTourUtils.answerGlobalTextQuestion("Name", "Name 1"),
            EventTourUtils.globalQuestionIsInvalid("Email"),
            EventTourUtils.confirmIsBlocked(),
