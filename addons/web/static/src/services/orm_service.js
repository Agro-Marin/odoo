...
// Re-export x2ManyCommands from its canonical location in the model layer.
// Addons import from this path — keep the re-export for backward compatibility.
export { x2ManyCommands } from "@web/model/relational_model/commands";
