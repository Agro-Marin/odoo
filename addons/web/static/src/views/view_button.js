...
/** @module @web/views/view_button */

/**
 * The view button module's published interface.
 *
 * Everything under `views/view_button/` that another addon imports today is re-exported here,
 ...
 *
 * A face is a SIBLING file, not `view_button/index.js`:
 * `ir_qweb_assets._specifier_to_static_url` maps `@web/views/view_button` to
 * `/web/static/src/views/view_button.js` by appending `.js`, with no directory-index step.
 */

export { ViewButton } from "./view_button/view_button.js";
export { useViewButtons } from "./view_button/view_button_hook.js";
