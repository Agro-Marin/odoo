...
/** @module @web/components/signature */

/**
 * The signature module's published interface.
 *
 * Everything under `components/signature/` that another addon imports today is re-exported here,
 ...
 *
 * A face is a SIBLING file, not `signature/index.js`:
 * `ir_qweb_assets._specifier_to_static_url` maps `@web/components/signature` to
 * `/web/static/src/components/signature.js` by appending `.js`, with no directory-index step.
 */

export { NameAndSignature } from "./signature/name_and_signature.js";
export { SignatureDialog } from "./signature/signature_dialog.js";
