...
/** @module @web/ui/tooltip */

/**
 * The tooltip module's published interface.
 *
 * Everything under `ui/tooltip/` that another addon imports today is re-exported here,
 ...
 *
 * A face is a SIBLING file, not `tooltip/index.js`:
 * `ir_qweb_assets._specifier_to_static_url` maps `@web/ui/tooltip` to
 * `/web/static/src/ui/tooltip.js` by appending `.js`, with no directory-index step.
 */

export { Tooltip } from "./tooltip/tooltip.js";
export { OPEN_DELAY } from "./tooltip/tooltip_service.js";
