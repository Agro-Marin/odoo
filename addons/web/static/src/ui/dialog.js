...
/** @module @web/ui/dialog */

/**
 * The dialog module's published interface.
 *
 * Everything under `ui/dialog/` that another addon imports today is re-exported here,
 ...
 *
 * A face is a SIBLING file, not `dialog/index.js`:
 * `ir_qweb_assets._specifier_to_static_url` maps `@web/ui/dialog` to
 * `/web/static/src/ui/dialog.js` by appending `.js`, with no directory-index step.
 */
...
} from "./dialog/confirmation_dialog.js";
