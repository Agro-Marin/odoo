...
/**
 * Regression guards for the `@web/services` audit fixes. Each test pins a
...
} from "@web/services/commands/command_palette";
...
import { _makeUser, user, userBus } from "@web/services/user";
