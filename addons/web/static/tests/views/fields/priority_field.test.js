...
test("PriorityField when not set", async () => {
    ...
    expect(".o_field_widget .o_priority a.o_priority_star.fa-solid.fa-star").toHaveCount(0, {
        message: "should have no full star since there is no value",
    });

    expect(".o_field_widget .o_priority a.o_priority_star.fa-regular.fa-star").toHaveCount(2, {
...
test("PriorityField in form view", async () => {
    ...
    expect(".o_field_widget .o_priority:not(.o_field_empty)").toHaveCount(1);
    expect(".o_field_widget .o_priority a.o_priority_star").toHaveCount(2);
    expect(".o_field_widget .o_priority a.o_priority_star.fa-solid.fa-star").toHaveCount(1);
    expect(".o_field_widget .o_priority a.o_priority_star.fa-regular.fa-star").toHaveCount(1);

    // click on the second star in edit mode
    await click(".o_field_widget .o_priority a.o_priority_star.fa-regular.fa-star:last");
    await animationFrame();

    expect(".o_field_widget .o_priority a.o_priority_star").toHaveCount(2);
    expect(".o_field_widget .o_priority a.o_priority_star.fa-solid.fa-star").toHaveCount(2);
    expect(".o_field_widget .o_priority a.o_priority_star.fa-regular.fa-star").toHaveCount(0);
});
...
test("PriorityField hover a star in form view", async () => {
    ...
    // hover last star
    const star = ".o_field_widget .o_priority a.o_priority_star.fa-regular.fa-star:last";
    await hover(star);
    await animationFrame();
    expect(".o_field_widget .o_priority a.o_priority_star").toHaveCount(2);
    expect(".o_field_widget .o_priority a.o_priority_star.fa-solid.fa-star").toHaveCount(2, {
...
test("PriorityField can write after adding a record -- kanban", async () => {
    ...
    expect(".o_kanban_record .fa-solid.fa-star").toHaveCount(0);

    await click(".o_priority a.o_priority_star.fa-regular.fa-star");
    // wait for web_save
    await animationFrame();
    expect.verifySteps(['web_save [[1],{"selection":"1"}]']);
    expect(".o_kanban_record .fa-solid.fa-star").toHaveCount(1);
    ...
    expect(".o_kanban_record .fa-solid.fa-star").toHaveCount(2);
});
...
test("PriorityField in editable list view", async () => {
    ...
    expect(".o_data_row:first-child .o_priority a.o_priority_star.fa-solid.fa-star").toHaveCount(
        1,
        {
    ...
    expect(
        ".o_data_row:first-child .o_priority a.o_priority_star.fa-regular.fa-star",
    ).toHaveCount(1, {
    ...
    await click(".o_priority a.o_priority_star.fa-solid.fa-star");
    await animationFrame();
    ...
    await click(".o_priority a.o_priority_star.fa-regular.fa-star:last");
    await animationFrame();

    expect(".o_data_row:last-child .o_priority a.o_priority_star").toHaveCount(2, {
        message: "should still have two stars",
    });
    expect(".o_data_row:last-child .o_priority a.o_priority_star.fa-solid.fa-star").toHaveCount(
        2,
        {
            message:
    ...
    expect(
        ".o_data_row:last-child .o_priority a.o_priority_star.fa-regular.fa-star",
    ).toHaveCount(0, {
...
test("PriorityField hover in editable list view", async () => {
    ...
    // hover last star
    const star = ".o_data_row:first-child .o_priority a.o_priority_star.fa-regular.fa-star:last";
    await hover(star);
    await animationFrame();
...
test("PriorityField with readonly attribute", async () => {
    ...
    expect("span.o_priority_star.fa-regular.fa-star.o_disabled").toHaveCount(2, {
        message: "stars of priority widget should rendered with span tag if readonly",
    });
    await hover(".o_priority_star.fa-regular.fa-star:last");
    await animationFrame();
    expect.step("hover");
    expect(".o_field_widget .o_priority a.o_priority_star.fa-solid.fa-star").toHaveCount(0, {
        message: "should have no full stars on hover since the field is readonly",
    });
    await click(".o_priority_star.fa-regular.fa-star:last");
    await animationFrame();
    expect.step("click");
    expect("span.o_priority_star.fa-regular.fa-star.o_disabled").toHaveCount(2, {
        message: "should still have two stars",
...
test('PriorityField edited by the smart action "Set priority..."', async () => {
    ...
    expect("a.fa-solid.fa-star").toHaveCount(1);
    ...
    await animationFrame();
    expect("a.fa-solid.fa-star").toHaveCount(2);
});
