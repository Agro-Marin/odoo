...
| `static/src/` | 882 JavaScript/OWL source files across 249 directories (FSD layers) | `DIRECTORY_MAP.md` |
...
| **Primitives** | `core/` | Registry, utils, reactivity, browser abstraction, l10n, network + ORM, errors, py_js, tree, debug, hotkeys, navigation, `lib/` lazy ESM loaders | 201 JS |
...
| JavaScript (src) | 882 (880 carry `@ts-check`; `module_loader.js` + `service_worker.js` are the two exclusions) |
