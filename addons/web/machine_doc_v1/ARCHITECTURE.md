...
| `static/src/` | 883 JavaScript/OWL source files across 249 directories (FSD layers) | `DIRECTORY_MAP.md` |
...
| JavaScript (src) | 883 (881 carry `@ts-check`; `module_loader.js` + `service_worker.js` are the two exclusions) |
