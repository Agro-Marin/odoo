    ...
    _get_website_event_steps() {
        return [
            ...super._get_website_event_steps(),
            {
                ...
                content: markup(
                    _t(
                        "Use this <b>shortcut</b> to easily access your event web page.",
                    ),
                ),
            ...
            },
            {
                ...
                content: markup(
                    _t(
                        "With the Edit button, you can <b>customize</b> the web page visitors will see when registering.",
                    ),
                ),
                tooltipPosition: "bottom",
                run: "click",
            ...
            }),
            {
                ...
                content: markup(
                    _t("Don't forget to click <b>save</b> when you're done."),
                ),
                tooltipPosition: "bottom",
                run: "click",
            },
            ...
            },
            {
                ...
                content: markup(
                    _t(
                        "Looking great! Let's now <b>publish</b> this page so that it becomes <b>visible</b> on your website!",
                    ),
                ),
                tooltipPosition: "bottom",
                run: "click",
            ...
            },
            {
                ...
                content: _t(
                    "This shortcut will bring you right back to the event form.",
                ),
                tooltipPosition: "bottom",
                run: "click",
            },
