...
class TestHrLeaveMandatoryDays(TransactionCase):
    ...
    def test_get_mandatory_days(self):
        mandatory_days = self.employee_emp.get_mandatory_days(
    ...
    def test_multiple_employees_mandatory_days(self):
        ...
        post_production_department, deployment_department = self.env[
            "hr.department"
        ].create(
            [
                {
        ...
        mandatory_days = (self.employee_emp + employee_emp_2).get_mandatory_days(
            "2021-11-01", "2021-11-30"
        )
