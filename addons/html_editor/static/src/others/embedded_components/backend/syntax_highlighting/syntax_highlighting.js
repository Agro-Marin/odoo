...
export class EmbeddedSyntaxHighlightingComponent extends Component {
    ...
    /**
     * Toggle line wrapping for this code block. The flag lives in the embedded
     * state so it survives a save, and the class is put on the host so the
     * readonly renderer picks it up without a component.
     */
    toggleCodeWrap() {
