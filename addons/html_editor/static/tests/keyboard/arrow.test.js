...
describe("Around icons", () => {
    test("should correctly move cursor over icons (ArrowRight) (1)", async () => {
        await testEditor({
            contentBefore: `<p>abc[]<span class="fa-solid fa-music"></span>def</p>`,
            contentBeforeEdit: `<p>abc[]\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeffdef</p>`,
            stepFunction: keyPress("ArrowRight"),
            contentAfterEdit: `<p>abc\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>[]\ufeffdef</p>`,
            contentAfter: `<p>abc<span class="fa-solid fa-music"></span>[]def</p>`,
        });
    });

    test("should correctly move cursor over icons (ArrowRight) (2)", async () => {
        await testEditor({
            contentBefore: `<p><span class="fa-solid fa-music"></span>[]<span class="fa-solid fa-music"></span></p><p><br></p>`,
            contentBeforeEdit: `<p>\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff[]<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff</p><p><br></p>`,
            stepFunction: keyPress("ArrowRight"),
            contentAfterEdit: `<p>\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>[]\ufeff</p><p><br></p>`,
            contentAfter: `<p><span class="fa-solid fa-music"></span><span class="fa-solid fa-music"></span>[]</p><p><br></p>`,
        });
    });

    test("should correctly move cursor over icons (ArrowRight) (3)", async () => {
        await testEditor({
            contentBefore: `<p><span class="fa-solid fa-music"></span>[]<br><span class="fa-solid fa-music"></span></p><p><br></p>`,
            contentBeforeEdit: `<p>\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff[]<br>\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff</p><p><br></p>`,
            stepFunction: keyPress("ArrowRight"),
            contentAfterEdit: `<p>\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff<br>\ufeff[]<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff</p><p><br></p>`,
            contentAfter: `<p><span class="fa-solid fa-music"></span><br>[]<span class="fa-solid fa-music"></span></p><p><br></p>`,
        });
    });
    ...
    test("should correctly move cursor over icons (ArrowLeft) (2)", async () => {
        await testEditor({
            contentBefore: `<p><span class="fa-solid fa-music"></span><br><span class="fa-solid fa-music"></span>[]</p>`,
            contentBeforeEdit: `<p>\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff<br>\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff[]</p>`,
            stepFunction: keyPress("ArrowLeft"),
            contentAfterEdit: `<p>\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff<br>\ufeff[]<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff</p>`,
            contentAfter: `<p><span class="fa-solid fa-music"></span><br>[]<span class="fa-solid fa-music"></span></p>`,
        });
    });
    test("should correctly move cursor over icons (ArrowUp) (1)", async () => {
        await testEditor({
            contentBefore: `<p><br></p><p><span class="fa-solid fa-music"></span></p><p>[]<br></p>`,
            contentBeforeEdit: `<p><br></p><p>\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff</p><p o-we-hint-text='Type "/" for commands' class="o-we-hint">[]<br></p>`,
            stepFunction: keyPress("ArrowUp"),
            contentAfterEdit: `<p><br></p><p>[]\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff</p><p><br></p>`,
            contentAfter: `<p><br></p><p>[]<span class="fa-solid fa-music"></span></p><p><br></p>`,
        });
    });

    test("should correctly move cursor over icons (ArrowUp) (2)", async () => {
        await testEditor({
            contentBefore: `<p><br></p><p><span class="fa-solid fa-music"></span><br>[]<span class="fa-solid fa-music"></span></p>`,
            contentBeforeEdit: `<p><br></p><p>\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff<br>\ufeff[]<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff</p>`,
            stepFunction: keyPress("ArrowDown"),
            contentAfterEdit: `<p><br></p><p>\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff<br>\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff[]</p>`,
            contentAfter: `<p><br></p><p><span class="fa-solid fa-music"></span><br><span class="fa-solid fa-music"></span>[]</p>`,
        });
    });
    test("should correctly move cursor over icons (ArrowDown) (1)", async () => {
        await testEditor({
            contentBefore: `<p>[]<br></p><p><span class="fa-solid fa-music"></span></p><p><br></p>`,
            contentBeforeEdit: `<p o-we-hint-text='Type "/" for commands' class="o-we-hint">[]<br></p><p>\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff</p><p><br></p>`,
            stepFunction: keyPress("ArrowDown"),
            contentAfterEdit: `<p><br></p><p>[]\ufeff<span class="fa-solid fa-music" contenteditable="false">\u200b</span>\ufeff</p><p><br></p>`,
            contentAfter: `<p><br></p><p>[]<span class="fa-solid fa-music"></span></p><p><br></p>`,
        });
...
describe("Around invisible chars in RTL languages", () => {
    describe("ZWS", () => {
        ...
        test("should move past the zws (ArrowLeft)", async () => {
            ...
            const pFirstChild = el.firstChild.firstChild;
            const pThirdChild = el.firstChild.childNodes[2];
    ...
    describe("ZWNBSP", () => {
        ...
        test("should move into a link (ArrowLeft)", async () => {
            ...
            const selection = editor.document.getSelection();
            expect(selection.anchorNode).toBe(link.firstChild);
            expect(selection.anchorOffset).toBe(1);
            expect(getContent(el)).toBe(
        ...
        test("should move into a link (ArrowRight)", async () => {
            ...
            const link = el.firstChild.childNodes[2];
            const pFifthChild = el.firstChild.childNodes[4];
            const link2ndChild = link.childNodes[1];
        ...
        test("should move out of a link (ArrowLeft)", async () => {
            ...
            const selection = editor.document.getSelection();
            expect(selection.anchorNode).toBe(el.firstChild.childNodes[3]);
            expect(selection.anchorOffset).toBe(1);
            expect(getContent(el)).toBe(
