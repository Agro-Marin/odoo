...
test("should be able to apply color on icon along with text", async () => {
    await testEditor({
        contentBefore:
            '<p>a[bc\ufeff<span class="fa-solid fa-martini-glass-empty" contenteditable="false">\u200b</span>\ufeffde]f</p>',
        stepFunction: setColor("rgb(255, 0, 0)", "color"),
        contentAfterEdit:
            '<p>a<font style="color: rgb(255, 0, 0);">[bc</font><font style="color: rgb(255, 0, 0);">\ufeff<span class="fa-solid fa-martini-glass-empty" contenteditable="false">\u200b</span>\ufeff</font><font style="color: rgb(255, 0, 0);">de]</font>f</p>',
        contentAfter:
            '<p>a<font style="color: rgb(255, 0, 0);">[bc<span class="fa-solid fa-martini-glass-empty"></span>de]</font>f</p>',
    });
});
...
test("should be able to change color of an icon", async () => {
    await testEditor({
        contentBefore:
            '<p><font style="color: rgb(255, 0, 0);">\ufeff<span class="fa-solid fa-martini-glass-empty" contenteditable="false">[]\u200b</span>\ufeff</font></p>',
        stepFunction: setColor("rgb(255, 255, 0)", "color"),
        contentAfterEdit:
            '<p><font style="color: rgb(255, 255, 0);">\ufeff[<span class="fa-solid fa-martini-glass-empty" contenteditable="false">\u200b</span>]\ufeff</font></p>',
        contentAfter:
            '<p><font style="color: rgb(255, 255, 0);">[<span class="fa-solid fa-martini-glass-empty"></span>]</font></p>',
    });
});
...
test("should be able to remove color of an icon", async () => {
    await testEditor({
        ...
        contentAfter: '<p>[<span class="fa-solid fa-martini-glass-empty"></span>]</p>',
    });
});
...
test("doesn't change the color of the whole section when there's an icon next to the selection", async () => {
    await testEditor({
        ...
        <section style="color: rgb(255, 0, 0);">
            <p>a[bc]d</p>
            <span class="fa-solid fa-martini-glass-empty" contenteditable="false">\u200b</span>
        </section>`,
        stepFunction: setColor("rgb(0, 0, 255)", "color"),
        contentAfterEdit: `
        ...
        <section style="color: rgb(255, 0, 0);">
            <p>a<font style="color: rgb(0, 0, 255);">[bc]</font>d</p>
            <span class="fa-solid fa-martini-glass-empty"></span>
        </section>`,
    });
});
