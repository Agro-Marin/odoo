...
test("should delete star rating elements when delete is pressed twice", async () => {
    await testEditor({
        contentBefore: `<p><span contenteditable="false" class="o_stars o_three_stars"><i class="fa-regular fa-star" contenteditable="false">\u200B</i><i class="o_stars fa-regular fa-star" contenteditable="false">\u200B</i><i class="o_stars fa-regular fa-star" contenteditable="false">\u200B</i></span>[]</p>`,
...
test("stars line should be reachable with up/down", async () => {
    ...
    const stars = `<span contenteditable="false" class="o_stars"><i class="fa-regular fa-star" contenteditable="false">\u200B</i><i class="fa-regular fa-star" contenteditable="false">\u200B</i><i class="fa-regular fa-star" contenteditable="false">\u200B</i></span>`;
