"""Tests for image modification without data parameter."""
...
class TestModifyImageNoData(HttpCase):
    """Test modify_image controller when no data parameter is provided."""

    def setUp(self) -> None:
        """Set up authentication and sample pixel data."""
        super().setUp()
        self.authenticate("admin", "admin")
        self.pixel = "R0lGODlhAQABAIAAAP///wAAACwAAAAAAQABAAACAkQBADs="

    def test_modify_image_no_data(self) -> None:
        """Test modify_image creates a copy when called without data parameter."""
