"""Tests for html_editor view inheritance and structure handling."""
...
class TestViews(TransactionCase):
    """Test QWeb view inheritance, oe_structure, and name deduplication."""

    def setUp(self) -> None:
        """Set up two QWeb views for inheritance tests."""
        super().setUp()
    ...
    def test_infinite_inherit_loop(self) -> None:
        """Verify _views_get handles circular t-call and inheritance without recursion error."""
    ...
    def test_oe_structure_as_inherited_view(self) -> None:
        """Test saving content into an oe_structure creates an extension child view."""
        View = self.env["ir.ui.view"]
        ...
        value = (
            """<div class="oe_structure" id="oe_structure_test_view_oe_structure" data-oe-id="%s"
    ...
    def test_find_available_name(self) -> None:
        """Test _find_available_name appends incrementing suffixes."""
        View = self.env["ir.ui.view"]
