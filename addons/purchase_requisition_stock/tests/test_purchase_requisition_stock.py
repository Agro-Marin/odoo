...
class TestPurchaseRequisitionStock(TestPurchaseRequisitionCommon):
    ...
    def test_02_purchase_requisition_stock(self):
        ...
        self.assertEqual(purchase1.line_ids.price_unit, 50, 'The price on the purchase order is not the supplierinfo one')
        ...
        self.assertEqual(purchase2.line_ids.price_unit, 50, 'The price on the purchase order is not the blanquet order one')
    ...
    def test_04_purchase_requisition_stock(self):
        ...
        self.assertEqual(orig_po.line_ids.product_id, alt_po.line_ids.product_id,
                         "Alternative PO should have copied the product to purchase from original PO")
        self.assertEqual(orig_po.line_ids.product_qty, alt_po.line_ids.product_qty,
