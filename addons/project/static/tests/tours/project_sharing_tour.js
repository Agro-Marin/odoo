...
const projectSharingSteps = [
    ...
    },
    {
        ...
        content:
            'Select the user portal as collaborator to the "Project Sharing" project.',
        run: "edit Georges",
    },
    {
    ...
    {
        trigger:
            'div[name="step_id"] div.o_statusbar_status button[aria-checked="false"]:contains(Done)',
...
registry.category("web_tour.tours").add("portal_project_sharing_tour", {
    ...
    steps: () => {
        ...
        return projectSharingSteps.slice(
            projectSharingStepIndex,
            projectSharingSteps.length,
        );
    },
});
...
registry
    ...
    .add("portal_project_sharing_tour_with_disallowed_milestones", {
        url: "/my/projects",
        steps: () => [
            {
                id: "project_sharing_feature",
...
registry
    .category("web_tour.tours")
    .add("test_04_project_sharing_chatter_message_reactions", {
        url: "/my/projects",
        steps: () => [
            {
                trigger: "table > tbody > tr a:has(span:contains(Project Sharing))",
            ...
            { trigger: ".o_project_sharing" },
            {
                trigger: ".o_kanban_record:contains('Test Task with messages')",
                run: "click",
            },
...
registry
    .category("web_tour.tours")
    .add("portal_project_sharing_chatter_mention_users", {
        url: "/my/projects",
        steps: () => [
            {
                trigger: "table > tbody > tr a:has(span:contains(Project Sharing))",
