r"""Pre-migration: ``project.project`` favorites move onto ``mixin.user.favorite``.
...
``project_project_res_users_rel``, with columns ``project_project_id`` and
...
OLD_RELATION = "project_favorite_user_rel"
NEW_RELATION = "project_project_res_users_rel"
COLUMNS = (("project_id", "project_project_id"), ("user_id", "res_users_id"))
