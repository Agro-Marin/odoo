...
class TestProjectTaskMailTrackingDuration(MailTrackingDurationMixinCase):
    ...
    def test_project_task_mail_tracking_duration(self) -> None:
        self._test_record_duration_tracking()

    def test_project_task_mail_tracking_duration_batch(self) -> None:
        self._test_record_duration_tracking_batch()

    def test_project_task_queries_batch_mail_tracking_duration(self) -> None:
    ...
    def test_task_mail_tracking_duration_during_onchange_stage(self) -> None:
        ...
        self.assertEqual(
            ...
            final_tracking[str(self.stage_1.id)],
        )
