...
class TestProjectBase(TestProjectCommon):
    ...
    def test_planned_dates_consistency_for_project(self) -> None:
        ...
        self.assertEqual(
            fields.Date.to_string(self.project_goats.date_start),
            "2021-09-27",
            "The start date should be set.",
        )
        self.assertEqual(
            fields.Date.to_string(self.project_goats.date),
            "2021-09-28",
        ...
        self.assertFalse(
            fields.Date.to_string(self.project_goats.date_start),
            "The start date should be unset.",
        )
        self.assertFalse(
            fields.Date.to_string(self.project_goats.date),
            "The expiration date should be unset as well.",
        )
        ...
        self.assertFalse(
            fields.Date.to_string(self.project_goats.date),
            "The expiration date should be unset.",
        )
        self.assertFalse(
            fields.Date.to_string(self.project_goats.date_start),
        ...
        self.assertFalse(
            fields.Date.to_string(self.project_goats.date),
            "The expiration date should stay be unset.",
        )
        ...
        for p in projects:
            self.assertEqual(
                fields.Date.to_string(p.date_start),
                "2021-09-27",
                f"The start date of {p.name} should be updated.",
            )
            self.assertEqual(
                fields.Date.to_string(p.date),
                "2021-09-28",
        ...
        self.assertEqual(
            fields.Date.to_string(self.project_pigs.date_start),
            "2021-09-27",
            "The start date should not be updated.",
        )
        self.assertEqual(
            fields.Date.to_string(self.project_pigs.date),
            "2021-09-28",
            "The expiration date should not be updated.",
        )
        ...
        for p in projects:
            self.assertFalse(
                fields.Date.to_string(p.date_start),
                f"The start date of {p.name} should be set to False.",
            )
            self.assertFalse(
                fields.Date.to_string(p.date),
                f"The expiration date of {p.name} should be set to False.",
            )
        ...
        for p in projects:
            self.assertFalse(
                fields.Date.to_string(p.date_start),
                f"The start date of {p.name} should not be updated.",
            )
            self.assertFalse(
                fields.Date.to_string(p.date),
                f"The expiration date of {p.name} should not be updated.",
            )
