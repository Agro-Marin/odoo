...
class TestPlanningOverlap(TestProjectCommon):
    ...
    def test_different_users_overlap(self):
        ...
        self.assertEqual(
            self.task_1.planning_overlap,
            Markup(
                "<p>Armande ProjectUser has 1 tasks at the same time. Bastien ProjectManager has 1 tasks at the same time.</p>"
            ),
        )
        self.assertEqual(
            self.task_2.planning_overlap,
            Markup(
                "<p>Armande ProjectUser has 1 tasks at the same time. Bastien ProjectManager has 1 tasks at the same time.</p>"
            ),
        )
    ...
    def test_same_user_overlap(self):
        ...
        self.assertEqual(
            self.task_1.planning_overlap,
            Markup("<p>Armande ProjectUser has 1 tasks at the same time.</p>"),
        )
        self.assertEqual(
            self.task_2.planning_overlap,
            Markup("<p>Armande ProjectUser has 1 tasks at the same time.</p>"),
    ...
    def test_same_user_overlap_with_allocated_hours_less_than_workable_hours(self):
        ...
        self.assertFalse(
            self.task_1.planning_overlap,
            "planning_overlap should be set to False, as the 2 tasks overlap\
