...
class BaseDocumentLayout(models.TransientModel):
    ...
    def _default_report_footer(self):
        ...
        if self.env.company.external_report_layout_id == self.env.ref('l10n_din5008.external_layout_din5008'):
            ...
            footer_fields = [field for field in [company.phone_ids._primary().number, company.email, company.website] if isinstance(field, str) and len(field) > 0]
    ...
    bank_ids = fields.Many2many(related='company_id.partner_id.bank_ids', readonly=True)
