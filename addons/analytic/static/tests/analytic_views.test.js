...
beforeEach(async () => {
    ...
    const eu = env["account.analytic.plan"].create({
        name: "Europe",
        parent_id: root,
        root_id: root,
    });
    const be = env["account.analytic.plan"].create({
        name: "Belgium",
        parent_id: eu,
        root_id: root,
    });
    const fr = env["account.analytic.plan"].create({
        name: "France",
        parent_id: eu,
        root_id: root,
    });
    const am = env["account.analytic.plan"].create({
        name: "America",
        parent_id: root,
        root_id: root,
    });
    const us = env["account.analytic.plan"].create({
        name: "USA",
        parent_id: am,
        root_id: root,
    });
...
test("Analytic hierachy in list view", async () => {
    ...
    await contains(
        ".o_group_by_menu .o_accordion_values .o-dropdown-item:last",
    ).click();
