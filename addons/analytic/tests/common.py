...
class AnalyticCommon(BaseCommon):
    ...
    def setUpClass(cls):
        ...
        cls.analytic_plan_offset = len(
            cls.env["account.analytic.plan"].get_relevant_plans()
        )
        cls.analytic_plan_1, cls.analytic_plan_2 = cls.env[
        ...
        (
            ...
            cls.analytic_account_3,
            cls.analytic_account_4,
    ...
    def setup_independent_user(cls):
        ...
        core_group_ids = (
            ...
            cls.env.ref("helpdesk.group_helpdesk_user", raise_if_not_found=False)
            or cls.env["res.groups"]
        )
        problematic_group_ids = default_groups.filtered(
            lambda g: g.all_implied_ids & core_group_ids
        )
