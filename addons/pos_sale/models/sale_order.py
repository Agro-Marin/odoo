...
class SaleOrder(models.Model):
    ...
    @api.depends('transaction_ids.state', 'transaction_ids.amount', 'line_ids', 'amount_total', 'line_ids.invoice_lines.parent_state', 'line_ids.invoice_lines.price_total', 'line_ids.pos_order_line_ids')
