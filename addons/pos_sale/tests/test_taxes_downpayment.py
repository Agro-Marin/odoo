...
class TestTaxesDownPaymentPOS(
    TestTaxCommonPOS, TestTaxCommonSale, TestTaxesDownPayment
):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_taxes_l10n_in_pos(self):
        ...
        self.ensure_products_on_document(
            round_per_line_excluded_tests[0][1], "product_1"
        )
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_in_pos_downpayment_round_per_line_price_excluded",
            [
        ...
        self.ensure_products_on_document(
            round_globally_excluded_tests[0][1], "product_2"
        )
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_in_pos_downpayment_round_globally_price_excluded",
            [
        ...
        self.ensure_products_on_document(
            round_per_line_included_tests[0][1], "product_3"
        )
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_in_pos_downpayment_round_per_line_price_included",
            [
        ...
        self.ensure_products_on_document(
            round_globally_included_tests[0][1], "product_4"
        )
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_in_pos_downpayment_round_globally_price_included",
            [
    ...
    def test_taxes_l10n_br_pos(self):
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_br_pos_downpayment_round_per_line_price_excluded",
            [
                round_per_line_excluded_tests[0],
            ],
        )
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_br_pos_downpayment_round_globally_price_excluded",
            [
                round_globally_excluded_tests[0],
            ],
        )
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_br_pos_downpayment_round_per_line_price_included",
            [
                round_per_line_included_tests[0],
            ],
        )
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_br_pos_downpayment_round_globally_price_included",
            [
                round_globally_included_tests[0],
            ],
        )
    ...
    def test_taxes_l10n_be_pos(self):
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_be_pos_downpayment_round_per_line_price_excluded",
            [
                round_per_line_excluded_tests[0],
            ],
        )
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_be_pos_downpayment_round_globally_price_excluded",
            [
                round_globally_excluded_tests[0],
            ],
        )
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_be_pos_downpayment_round_per_line_price_included",
            [
                round_per_line_included_tests[0],
            ],
        )
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_be_pos_downpayment_round_globally_price_included",
            [
                round_globally_included_tests[0],
            ],
        )
