...
class TestItEdiDoiRemaining(TestItEdiDoi):
    ...
    def test_overinvoiced_sale_order_and_credit_note(self):
        ...
        independent_order = self.create_sale_order(
            declaration,
            [
                Command.create(
                    {
            ...
            self.env["sale.advance.payment.inv"].with_context(
                {
                    ...
                    "active_ids": [order.id],
                    "active_id": order.id,
                    "default_journal_id": self.company_data_2[
        ...
        invoice.invoice_line_ids[
            0
        ].price_unit = 2000  # 1000 more than the sales order declaration amount
