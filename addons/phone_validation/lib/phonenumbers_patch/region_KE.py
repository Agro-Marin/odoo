...
PHONE_METADATA_KE = PhoneMetadata(
    id="KE",
    country_code=254,
    international_prefix="000",
    general_desc=PhoneNumberDesc(
        national_number_pattern="(?:[17]\\d\\d|900)\\d{6}|(?:2|80)0\\d{6,7}|[4-6]\\d{6,8}",
        possible_length=(7, 8, 9, 10),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="(?:4[245]|5[1-79]|6[01457-9])\\d{5,7}|(?:4[136]|5[08]|62)\\d{7}|(?:[24]0|66)\\d{6,7}",
        example_number="202012345",
        possible_length=(7, 8, 9),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="(?:1(?:0[0-8]|1[0-7]|2[014]|30)|7\\d\\d)\\d{6}",
