...
PHONE_METADATA_IL = PhoneMetadata(
    id="IL",
    country_code=972,
    international_prefix="0(?:0|1[2-9])",
    general_desc=PhoneNumberDesc(
        national_number_pattern="1\\d{6}(?:\\d{3,5})?|[57]\\d{8}|[1-489]\\d{7}",
        possible_length=(7, 8, 9, 10, 11, 12),
    ),
    fixed_line=PhoneNumberDesc(
        national_number_pattern="153\\d{8,9}|29[1-9]\\d{5}|(?:2[0-8]|[3489]\\d)\\d{6}",
        example_number="21234567",
        possible_length=(8, 11, 12),
        possible_length_local_only=(7,),
    ),
    mobile=PhoneNumberDesc(
        national_number_pattern="55410\\d{4}|5(?:(?:[02][02-9]|[149][2-9]|[36]\\d|8[3-7])\\d|5(?:01|2\\d|3[0-3]|4[34]|5[0-25689]|6[6-8]|7[0-267]|8[7-9]|9[1-9]))\\d{5}",
    ...
    voip=PhoneNumberDesc(
        national_number_pattern="7(?:38(?:0\\d|5[0-259]|88)|8(?:33|55|77|81)\\d)\\d{4}|7(?:18|2[23]|3[237]|47|6[258]|7\\d|82|9[2-9])\\d{6}",
    ...
    no_international_dialling=PhoneNumberDesc(
        national_number_pattern="1700\\d{6}", possible_length=(10,)
    ),
    national_prefix="0",
    national_prefix_for_parsing="0",
    number_format=[
        NumberFormat(
            pattern="(\\d{4})(\\d{3})", format="\\1-\\2", leading_digits_pattern=["125"]
        ),
        NumberFormat(
            pattern="(\\d{4})(\\d{2})(\\d{2})",
            format="\\1-\\2-\\3",
        ...
        NumberFormat(
            pattern="(\\d{4})(\\d{6})", format="\\1-\\2", leading_digits_pattern=["159"]
        ),
        NumberFormat(
