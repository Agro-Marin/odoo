        ...
        for resource in resources:
            self.assertEqual(
                ...
                [
                    ...
                    (
                        datetime(2025, 7, 31, 0, 0, tzinfo=UTC),
                        datetime(2025, 7, 31, 23, 59, 59, 999999, tzinfo=UTC),
                        self.env["resource.calendar.attendance"],
                    ),
                    (
                        datetime(2025, 8, 1, 0, 0, tzinfo=UTC),
                        datetime(2025, 8, 1, 23, 59, 59, 999999, tzinfo=UTC),
                        self.env["resource.calendar.attendance"],
                    ),
                    (
                        datetime(2025, 8, 2, 0, 0, tzinfo=UTC),
