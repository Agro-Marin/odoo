...
class ResConfigSettings(models.TransientModel):
    ...
    hr_presence_control_login = fields.Boolean(
        related="company_id.hr_presence_control_login", readonly=False
    )
    hr_presence_control_email = fields.Boolean(
        related="company_id.hr_presence_control_email", readonly=False
    )
    hr_presence_control_ip = fields.Boolean(
        related="company_id.hr_presence_control_ip", readonly=False
    )
    module_hr_attendance = fields.Boolean(
        related="company_id.hr_presence_control_attendance", readonly=False
    )
