...
class HrEmployeePublic(models.Model):
    ...
    image_1920 = fields.Image(
        "Image", related="employee_id.image_1920", compute_sudo=True
    )
    image_1024 = fields.Image(
        "Image 1024", related="employee_id.image_1024", compute_sudo=True
    )
    image_512 = fields.Image(
        "Image 512", related="employee_id.image_512", compute_sudo=True
    )
    image_256 = fields.Image(
        "Image 256", related="employee_id.image_256", compute_sudo=True
    )
    image_128 = fields.Image(
        "Image 128", related="employee_id.image_128", compute_sudo=True
    )
    avatar_1920 = fields.Image(
        "Avatar", related="employee_id.avatar_1920", compute_sudo=True
    )
    avatar_1024 = fields.Image(
        "Avatar 1024", related="employee_id.avatar_1024", compute_sudo=True
    )
    avatar_512 = fields.Image(
        "Avatar 512", related="employee_id.avatar_512", compute_sudo=True
    )
    avatar_256 = fields.Image(
        "Avatar 256", related="employee_id.avatar_256", compute_sudo=True
    )
    avatar_128 = fields.Image(
        "Avatar 128", related="employee_id.avatar_128", compute_sudo=True
    )
    ...
    birthday_public_display_string = fields.Char(
        "Public Date of Birth", related="employee_id.birthday_public_display_string"
    )
