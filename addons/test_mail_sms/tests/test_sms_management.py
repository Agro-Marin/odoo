...
class TestSMSActionsCommon(SMSCommon, TestSMSRecipients):
    ...
    def setUpClass(cls):
        ...
        cls.msg = cls.test_record.message_post(
            body="TEST BODY", author_id=cls.partner_employee.id
        )
        cls.sms_p1 = cls.env["sms.sms"].create(
            {
                ...
                "number": cls.partner_1._phone_get_number().number,
        ...
        cls.notif_p1 = cls.env["mail.notification"].create(
            {
                ...
                "sms_number": cls.partner_1._phone_get_number().number,
        ...
        cls.sms_p2 = cls.env["sms.sms"].create(
            {
                ...
                "mail_message_id": cls.msg.id,
                "number": cls.partner_2._phone_get_number().number,
        ...
        cls.notif_p2 = cls.env["mail.notification"].create(
            {
                ...
                "sms_number": cls.partner_2._phone_get_number().number,
...
class TestSMSActions(TestSMSActionsCommon):
    def test_sms_notify_cancel(self):
        ...
        with self.with_user("employee"):
            ...
            self.assertEqual(
                (self.notif_p1 | self.notif_p2).mapped("notification_status"),
                ["canceled", "canceled"],
            )
    ...
    def test_sms_set_cancel(self):
        ...
        self.assertSMSNotification(
            [
                {
                    ...
                    "number": self.notif_p1.sms_number,
                    "state": "canceled",
                    "failure_type": "sms_number_format",
                },
                {
                    "partner": self.partner_2,
                    "number": self.notif_p2.sms_number,
                    "state": "exception",
                    "failure_type": "sms_credit",
                },
            ],
            ...
            self.msg,
            check_sms=False,
        )  # do not check new sms as they already exist
        ...
        self.assertEqual(
            ...
            self.env["bus.bus"],
            "SMS: no bus notifications unless asked",
        )
        self.assertSMSNotification(
            [
                {
    ...
    def test_sms_set_error(self):
        self._reset_bus()
        (self.sms_p1 + self.sms_p2).with_context(
