...
import { useBus, useChildRef, useService, useServices } from "@web/core/utils/hooks";
...
export class WebsiteBuilderClientAction extends Component {
    ...
    setup() {
        ...
        // html_builder.snippets registers with website.website_builder_assets,
        // after setup: it is looked up once that bundle has loaded.
        ...
        onMounted(() => {
            ...
            if (!this.ui.isSmall) {
                loadBundle("website.website_builder_assets")
                    .then(() =>
                        this.appServices["html_builder.snippets"]
