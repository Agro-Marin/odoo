declare module "plugins" {
    ...
    import {
        content_manually_updated_handlers,
        EditInteractionShared,
    } from "@website/builder/plugins/edit_interaction_plugin";
    ...
    import {
        AnimateOptionShared,
        remove_hover_effect_handlers,
        set_hover_effect_handlers,
    ...
    import {
        ...
        DynamicSnippetOptionShared,
    } from "@website/builder/plugins/options/dynamic_snippet_option_plugin";
    import {
        footer_templates_providers,
        FooterOptionShared,
    } from "@website/builder/plugins/options/footer_option_plugin";
    import {
        get_gallery_items_handlers,
        reorder_items_handlers,
    } from "@website/builder/plugins/options/gallery_element_option_plugin";
    ...
    import {
        theme_options,
        ThemeTabShared,
    } from "@website/builder/plugins/theme/theme_tab_plugin";
    ...
    export type WebsiteResourcesAccess = BuilderResourcesAccess &
        ResourcesTypesFactory<WebsiteResourcesList>;
