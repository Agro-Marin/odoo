...
test("header_standard is started when there is an element header.o_header_standard", async () => {
    const { core } = await startInteractions(
        getTemplateWithoutHideOnScroll("o_header_standard"),
    );
...
const behaviorWithout = [
    ...
    },
    {
        ...
        classList:
            "o_header_affixed o_header_is_scrolled o_header_standard o_top_fixed_element",
    },
];
...
test.tags("desktop");
test("[scroll] Template with o_header_hide_on_scroll (desktop)", async () => {
    const { core } = await startInteractions(
        getTemplateWithHideOnScroll("o_header_standard"),
    );
    const wrapwrap = queryOne("#wrapwrap");
    const header = queryOne("header");
    const main = queryOne("main");
...
test.tags("mobile");
test("[scroll] Template with o_header_hide_on_scroll (mobile)", async () => {
    const { core } = await startInteractions(
        getTemplateWithHideOnScroll("o_header_standard"),
    );
    const wrapwrap = queryOne("#wrapwrap");
