...
class TestWebsiteResUsers(TransactionCase):
    ...
    def test_multi_website_multi_company(self):
        ...
        website_1 = self.env["website"].create(
            {"name": "Website 1", "company_id": company_1.id}
        )
        ...
        self._create_and_check_portal_user(
            False, company_1, company_2, website_1, website_2
        )
        self._create_and_check_portal_user(
            True, company_1, company_2, website_1, website_2
        )
