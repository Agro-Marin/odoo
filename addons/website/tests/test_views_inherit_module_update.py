...
def test_01_cow_views_inherit_on_module_update(env):
    ...
    child_cow_view = child_view._get_views_specific()
...
def test_02_cow_views_inherit_on_module_update(env):
    ...
    view_Dcow = view_D._get_views_specific()

    view_Bcow = view_B._get_views_specific()
    ...
    assert view_B != view_Bcow, (
        "Security check to ensure `_get_views_specific` return what it should."
    )
