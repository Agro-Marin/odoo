...
class TestGoal(common.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.user_test = cls.env["res.users"].with_context(no_reset_password=True).create({
            "name": "Goal Test User",
    ...
    def test_update_goal_python_mode(self):
        ...
        goal.update_goal()
        self.assertEqual(goal.current, 42, "Goal current should be set to the result of compute_code")
    ...
    def test_get_completion_higher_at_100(self):
        ...
        self.assertEqual(goal.completeness, 100.0, "Completeness should be capped at 100.0")
    ...
    def test_get_completion_higher_partial(self):
        ...
        self.assertEqual(goal.completeness, 50.0, "Completeness should be 50.0 for half completion")
    ...
    def test_get_completion_target_zero(self):
        ...
        self.assertEqual(goal.completeness, 100.0, "Completeness should be 100 when target is zero (trivially reached)")
    ...
    def test_goal_write_blocks_definition_change(self):
        ...
        with self.assertRaises(UserError, msg="Changing definition on a non-draft goal should raise UserError"):
