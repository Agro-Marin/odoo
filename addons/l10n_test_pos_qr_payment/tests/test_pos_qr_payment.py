...
class TestUiSEPA(TestPosQrCommon):
    ...
    def setUpClass(cls):
        ...
        cls.main_pos_config.write({"payment_method_ids": [(4, qr_payment.id)]})
    ...
    def test_01_pos_order_with_sepa_qr_payment_fail(self):
        ...
        self.start_tour(
            ...
            "PaymentScreenWithQRPaymentFailure",
            login="pos_user",
        )
...
class TestUiCH(TestPosQrCommon):
    ...
    def test_02_pos_order_with_swiss_qr_payment(self):
        ...
        self.start_tour(
            "/pos/ui/%d" % self.main_pos_config.id,
            "PaymentScreenWithQRPaymentSwiss",
            login="pos_user",
        )
