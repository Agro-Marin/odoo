...
class TestTaxesGlobalDiscountPOS(TestTaxCommonPOS, TestTaxesGlobalDiscount):
    ...
    def test_taxes_l10n_in_pos(self):
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_in_pos_global_discount_round_per_line_price_excluded",
            [
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_in_pos_global_discount_round_globally_price_excluded",
            [
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_in_pos_global_discount_round_per_line_price_included",
            [
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_in_pos_global_discount_round_globally_price_included",
            [
    ...
    def test_taxes_l10n_br_pos(self):
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_br_pos_global_discount_round_per_line_price_excluded",
            [
                round_per_line_excluded_tests[0],
            ],
        )
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_br_pos_global_discount_round_globally_price_excluded",
            [
                round_globally_excluded_tests[0],
            ],
        )
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_br_pos_global_discount_round_per_line_price_included",
            [
                round_per_line_included_tests[0],
            ],
        )
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_br_pos_global_discount_round_globally_price_included",
            [
                round_globally_included_tests[0],
            ],
        )
    ...
    def test_taxes_l10n_be_pos(self):
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_be_pos_global_discount_round_per_line_price_excluded",
            [
                round_per_line_excluded_tests[0],
            ],
        )
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_be_pos_global_discount_round_globally_price_excluded",
            [
                round_globally_excluded_tests[0],
            ],
        )
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_be_pos_global_discount_round_per_line_price_included",
            [
                round_per_line_included_tests[0],
            ],
        )
        ...
        self.assert_pos_orders_and_invoices(
            "test_taxes_l10n_be_pos_global_discount_round_globally_price_included",
            [
                round_globally_included_tests[0],
            ],
        )
    ...
    def test_pos_global_discount_sell_and_refund(self):
        ...
        self.assertEqual(
            pos_order.lines[1].product_id.id,
            self.main_pos_config.discount_product_id.id,
        )
