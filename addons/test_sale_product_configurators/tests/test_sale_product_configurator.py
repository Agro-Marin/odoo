...
class TestProductConfiguratorUi(TestProductConfiguratorCommon):
    ...
    def test_02_product_configurator_advanced(self):
        ...
        product_attributes = self.env["product.attribute"].create(
            [
                {"name": "PA1", "display_type": "radio", "create_variant": "dynamic"},
                {"name": "PA2", "display_type": "radio", "create_variant": "always"},
                {"name": "PA3", "display_type": "radio", "create_variant": "dynamic"},
                {
                    "name": "PA4",
                    "display_type": "select",
        ...
        self.assertEqual(
            len(
                product_template.product_variant_ids.product_template_attribute_value_ids
            ),
            0,
        )

        self.start_tour(
            "/odoo", "sale_product_configurator_advanced_tour", login="salesman"
        )
    ...
    def test_03_product_configurator_edition(self):
        ...
        self.start_tour(
            "/odoo", "sale_product_configurator_edition_tour", login="salesman"
        )
    ...
    def test_05_product_configurator_pricelist(self):
        ...
        self.start_tour(
            "/odoo", "sale_product_configurator_pricelist_tour", login="salesman"
        )
    ...
    def test_06_product_configurator_optional_products(self):
        ...
        office_chair.update(
            {
                "optional_product_ids": [
                    (6, 0, [self.product_product_conf_chair_floor_protect.id])
                ]
            }
        )
        custo_desk.update(
            {
                "optional_product_ids": [
                    (
                        ...
                        0,
                        [
                            office_chair.product_tmpl_id.id,
        ...
        self.start_tour(
            "/odoo",
            "sale_product_configurator_optional_products_tour",
            login="salesman",
        )
    ...
    def test_07_product_configurator_recursive_optional_products(self):
        ...
        self.start_tour(
            "/odoo",
            "sale_product_configurator_recursive_optional_products_tour",
            login="salesman",
        )
    ...
    def test_product_configurator_update_custom_values(self):
        self.start_tour(
            "/odoo",
            "sale_product_configurator_custom_value_update_tour",
            login="salesman",
        )
