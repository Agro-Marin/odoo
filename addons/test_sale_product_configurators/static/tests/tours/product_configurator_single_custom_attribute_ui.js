...
registry
    ...
    .add("sale_product_configurator_single_custom_attribute_tour", {
        url: "/odoo",
        steps: () => [
            ...
            configuratorTourUtils.setCustomAttribute(
                "Customizable Desk (TEST)",
                "product attribute",
                "great single custom value",
            ),
            ...configuratorTourUtils.saveConfigurator(),
            tourUtils.editLineMatching(
                "Customizable Desk (TEST)",
                "single product attribute value: great single custom value",
            ),
            tourUtils.editConfiguration(),
            {
                ...
                run({ queryOne }) {
                    ...
                    if (
                        ...
                        console.error(
                            "The value of custom product attribute should be 'great single custom value'.",
                        );
                    }
                },
            },
