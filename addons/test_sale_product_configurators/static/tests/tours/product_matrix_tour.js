...
let EXPECTED = ["Matrix", "PAV11", "PAV12 + $ 50.00"];
...
registry.category("web_tour.tours").add("sale_matrix_tour", {
    ...
    steps: () => [
        ...
        {
            trigger:
                'td.o_list_monetary > span[name="Untaxed Amount"]:contains("216.00")',
        },
        {
        ...
        {
            trigger:
                'td.o_list_monetary > span[name="Untaxed Amount"]:contains("648.00")',
        },
        {
            trigger: ".o_sale_order",
