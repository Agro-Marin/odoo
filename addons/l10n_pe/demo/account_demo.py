    ...
    def _prepare_demo_data_move(self, company=False):
        def _get_tax_by_code(code, type_tax="sale"):
            taxes = self.env["account.tax"].search(
                [("type_tax_use", "=", type_tax), ("l10n_pe_edi_tax_code", "=", code)],
                limit=1,
            )
        ...
        if company.tax_config_id.account_fiscal_country_id.code == "PE":
                ...
                Command.create(
                    {
                        ...
                        "quantity": 25000.0,
                        "price_unit": 3.0,
                        "tax_ids": _get_tax_by_code("9997"),
                    }
                ),
            ]
            move_data[self.company_xmlid("demo_invoice_2")]["invoice_date"] = (
                last_month_date
            )
            move_data[self.company_xmlid("demo_invoice_2")][
                "l10n_latam_document_number"
            ] = "FFF-0000002"
            ...
            move_data[self.company_xmlid("demo_invoice_3")]["invoice_date"] = (
                last_month_date
            )
            move_data[self.company_xmlid("demo_invoice_3")][
                "l10n_latam_document_type_id"
            ] = ref("l10n_pe.document_type08").id
            move_data[self.company_xmlid("demo_invoice_3")][
                "l10n_latam_document_number"
            ] = "NDI-0000001"
            ...
            move_data[self.company_xmlid("demo_invoice_followup")]["move_type"] = (
                "in_invoice"
            )
            move_data[self.company_xmlid("demo_invoice_followup")]["partner_id"] = ref(
                "base.res_partner_2"
            ).id
            move_data[self.company_xmlid("demo_invoice_followup")]["invoice_date"] = (
                last_month_date
            )
            move_data[self.company_xmlid("demo_invoice_followup")][
                "l10n_latam_document_number"
            ] = "FFF-100001"
            move_data[self.company_xmlid("demo_invoice_followup")][
                "invoice_line_ids"
            ...
            move_data[self.company_xmlid("demo_invoice_5")]["partner_id"] = ref(
                "base.res_partner_2"
            ).id
            move_data[self.company_xmlid("demo_invoice_5")]["invoice_date"] = (
                last_month_date
            )
            move_data[self.company_xmlid("demo_invoice_5")][
                "l10n_latam_document_number"
            ] = "FFF-100002"
                ...
                Command.create(
                    {
                        ...
                        "quantity": 1.0,
                        "price_unit": 500.0,
                        "tax_ids": _get_tax_by_code("1000", "purchase"),
                    }
                ),
            ]
            igv_gyng_tax = self.env["account.tax"].search(
                [
                    ("type_tax_use", "=", "purchase"),
                    ("tax_group_id.name", "=", "IGV GyNG"),
                ],
                limit=1,
            )
            move_data[self.company_xmlid("demo_invoice_equipment_purchase")][
                "partner_id"
            ] = ref("base.res_partner_2").id
            move_data[self.company_xmlid("demo_invoice_equipment_purchase")][
                "invoice_date"
            ] = last_month_date
            move_data[self.company_xmlid("demo_invoice_equipment_purchase")][
                ...
                Command.create(
                    {
                        ...
                        "price_unit": 500.0,
                        "quantity": 1,
                        "tax_ids": [Command.set(igv_gyng_tax.ids)],
                    }
                ),
            ]
                    ...
                    Command.create(
                        {
                            ...
                            "price_unit": 500.0,
                            "quantity": 1,
                            "tax_ids": _get_tax_by_code("9997", "purchase"),
                        }
                    ),
                    Command.create(
                        {
                    ...
                    Command.create(
                        {
                            ...
                            "price_unit": 1500.0,
                            "quantity": 2,
                            "tax_ids": _get_tax_by_code("9996", "purchase"),
                        }
                    ),
                    Command.create(
                        {
                            ...
                            "price_unit": 2000.0,
                            "quantity": 1,
                            "tax_ids": _get_tax_by_code("9998", "purchase"),
                        }
                    ),
                    Command.create(
                        {
                    ...
                    Command.create(
                        {
                            ...
                            "price_unit": 25000.0,
                            "quantity": 3,
                            "tax_ids": _get_tax_by_code("9995", "purchase"),
                        }
                    ),
                ],
            }
            ...
            move_data[self.company_xmlid("demo_move_auto_reconcile_3")][
                "l10n_latam_document_number"
            ] = "FFF-100007"
            move_data[self.company_xmlid("demo_move_auto_reconcile_4")][
                "l10n_latam_document_number"
            ] = "FFF-100008"
        return move_data
