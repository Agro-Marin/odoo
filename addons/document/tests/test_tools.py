...
from .test_document_common import TEXT
from odoo.addons.document.controllers.document import _is_safe_redirect_url
from odoo.addons.document.tools import UserFolder, is_mimetype_textual
