...
class AccountFiscalPosition(models.Model):
    ...
    def _invalidate_company_configs(self):
        ...
        self.env["tax.config"].invalidate_model(
            [
                "fiscal_position_ids",
    ...
    @api.depends("company_id.tax_config_id.domestic_fiscal_position_id")
    def _compute_is_domestic(self):
        for position in self:
            position.is_domestic = (
                position
                == position.company_id.tax_config_id.domestic_fiscal_position_id
            )
