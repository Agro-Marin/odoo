...
class AccountEdiXmlUBL21RS(models.AbstractModel):
        ...
        document_node["cac:InvoicePeriod"] = [
            document_node.get("cac:InvoicePeriod"),
            {
                "cbc:DescriptionCode": {
                    ...
                    else invoice.l10n_rs_tax_date_obligations_code
                },
            },
        ]
    ...
    def _get_party_node(self, vals):
        ...
        if vat_country == "RS" and partner._check_vat_number(vat_country, vat_number):
            party_node["cac:PartyTaxScheme"]["cbc:CompanyID"] = {
                "_text": vat_country + vat_number
            }

        party_node["cac:PartyLegalEntity"]["cbc:CompanyID"] = {
            "_text": partner.l10n_rs_edi_registration_number
        }
