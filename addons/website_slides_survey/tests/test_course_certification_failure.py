...
class TestCourseCertificationFailureFlow(TestSurveyCommon):
    def test_course_certification_failure_flow(self):
        ...
        self.assertEqual(
            1,
            len(slide_partner.user_input_ids),
        ...
        certification_urls = self.slide_certification.with_user(
            self.user_portal
        )._generate_certification_url()
        self.assertEqual(
            certification_urls[self.slide_certification.id],
        ...
        self.assertEqual(
            2,
            second_attempt_in_first_pool.attempts_number,
            "The second attempt of the first pool should be number 2",
        )
        self.assertEqual(
            1,
            first_attempt_in_second_pool.attempts_number,
                ...
                "user_input_line_ids": [
                    (
                        ...
                        0,
                        {
                            ...
                            "suggested_answer_id": question.suggested_answer_ids[
                                1 if good_answers else 0
                            ].id,
                        },
                    )
