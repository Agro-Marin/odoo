...
class TestEGEdiCommon(AccountEdiTestCommon):
    ...
    def setUpClass(cls):
        ...
        cls.currency_aed_id = cls.setup_other_currency(
            "AED", rates=[("2022-03-15", 0.198117095128)]
        )
        ...
        cls.company_data["default_journal_sale"].write(
            {
                ...
                "l10n_eg_activity_type_id": cls.env.ref(
                    "l10n_eg_edi_eta.l10n_eg_activity_type_8121"
                ).id,
            }
        )
