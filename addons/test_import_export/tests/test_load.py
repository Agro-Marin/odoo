...
class test_ids_stuff(ImporterCase):
            ...
            [
                {
                    ...
                    "record": 0,
                    "field": ".id",
                    "message": "Unknown database identifier '42'",
                }
            ],
        )
    ...
    def test_create_with_xid(self):
        ...
        self.assertEqual("__import__.somexmlid", self.xid(self.browse()[0]))
...
class test_boolean_field(ImporterCase):
    ...
    def test_empty(self):
        self.assertEqual(
            self.import_(["value"], []), {"ids": [], "messages": [], "nextrow": False}
        )
...
class test_integer_field(ImporterCase):
            ...
            [
                {
                    ...
                    "record": 0,
                    "field": "value",
                    "message": "'zorglub' does not seem to be an integer for field 'Value'",
                }
            ],
        )
    ...
    def test_load_per_record_savepoint_isolates_failures(self):
        ...
        with (
            patch.object(Model, "_load_records", fake_load),
...
class test_float_field(ImporterCase):
    ...
    def test_nonsense(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "'foobar' does not seem to be a number for field 'Value'",
                    field_name="Value",
                    field_path=["value"],
                )
            ],
    ...
    def test_imported(self):
        result = self.import_(
            ...
            [
                ...
                # ackbar.jpg
                ["If they ask you about fun, you tell them – fun is a filthy parasite"],
            ],
        )
        self.assertEqual(len(result["ids"]), 2)
        self.assertFalse(result["messages"])
...
class test_required_string_field(ImporterCase):
    ...
    def test_empty(self):
        ...
        expected_message = message(
            "Missing required value for the field 'Value' (value)"
        )
    ...
    def test_ignore_excess_messages(self):
        ...
        for m in result["messages"][:-1]:
            ...
            self.assertIn(
                "Missing required value for the field 'Value' (value)", m["message"]
            )
...
class test_text(ImporterCase):
    ...
    def test_imported(self):
        s = (
            "Breiðskífa er notað um útgefna hljómplötu sem inniheldur "
            "stúdíóupptökur frá einum flytjanda. Breiðskífur eru oftast "
            "milli 25-80 mínútur og er lengd þeirra oft miðuð við 33⅓ "
            "snúninga 12 tommu vínylplötur (sem geta verið allt að 30 mín "
            "hvor hlið).\n\nBreiðskífur eru stundum tvöfaldar og eru þær þá"
            " gefnar út á tveimur geisladiskum eða tveimur vínylplötum."
        )
...
class test_selection(ImporterCase):
    ...
    def test_imported_translated(self):
        ...
        selections = self.env["ir.model.fields.selection"].search(
            [("name", "in", list(self.translations_fr))]
        )
        for selection in selections:
            selection.with_context(lang="fr_FR").name = self.translations_fr[
                selection.name
            ]
    ...
    def test_invalid(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "Value 'Baz' not found in selection field 'Value'",
                    moreinfo=["Foo", "Bar", "Qux", "4"],
                    field_name="Value",
                    field_path=["value"],
                )
            ],
        ...
        self.assertEqual(
            ...
            [
                message(
                    "Value '42' not found in selection field 'Value'",
                    moreinfo=["Foo", "Bar", "Qux", "4"],
                    field_name="Value",
                    field_path=["value"],
                )
...
class test_m2o(ImporterCase):
    ...
    def test_by_names(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    'Found multiple matches for value "export.integer:42" in field "Value" (2 matches)',
                    type_="warning",
                )
            ],
        )
    ...
    def test_fail_by_implicit_id(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    f"No matching record found for name '{id_}' in field 'Value'",
                    from_=index,
                    to_=index,
                    record=index,
                ...
                for index, id_ in enumerate([record1.id, record2.id, record1.id])
            ],
        )
        self.assertIs(result["ids"], False)
    ...
    def test_fail_noids(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "No matching record found for name 'nameisnoexist:3' in field 'Value'",
                    moreinfo=moreaction(res_model="export.integer"),
                    field_name="Value",
                    field_path=["value"],
                    field_type="name",
                    value="nameisnoexist:3",
                )
            ],
        )
        self.assertIs(result["ids"], False)
        ...
        self.assertEqual(
            ...
            [
                message(
                    "No matching record found for external id 'noxidhere' in field 'Value'",
                    moreinfo=moreaction(
    ...
    def test_fail_id(self):
        ...
        self.assertEqual(
            ...
            "Invalid database id 'lorem' for the field 'Value'",
        )
    ...
    def test_name_create_enabled_m2o(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "No matching record found for name '101' in field 'Value'",
                    moreinfo=moreaction(res_model="export.integer"),
                    field_name="Value",
                    field_path=["value"],
                    field_type="name",
...
class test_m2m(ImporterCase):
    ...
    def test_ids(self):
        id1 = (
            self.env["export.many2many.other"].create({"value": 3, "str": "record0"}).id
        )
        id2 = (
            self.env["export.many2many.other"]
            .create({"value": 44, "str": "record1"})
            .id
        )
        id3 = (
            self.env["export.many2many.other"]
            .create({"value": 84, "str": "record2"})
            .id
        )
        id4 = (
            self.env["export.many2many.other"].create({"value": 9, "str": "record3"}).id
        )
        id5 = (
            self.env["export.many2many.other"]
            .create({"value": 99, "str": "record4"})
            .id
        )
    ...
    def test_noxids(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "No matching record found for external id 'noxidforthat' in field 'Value'",
                    moreinfo=moreaction(
                        res_model="ir.model.data",
    ...
    def test_nonames(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "No matching record found for name 'wherethem2mhavenonames' in field 'Value'",
                    moreinfo=moreaction(res_model="export.many2many.other"),
                    field_name="Value",
                    field_path=["value"],
                    field_type="name",
                    value="wherethem2mhavenonames",
                )
            ],
        )
        self.assertIs(result["ids"], False)
...
class test_o2m(ImporterCase):
    ...
    def test_display_name(self):
        s = "Java is a DSL for taking large XML files and converting them to stack traces"
        result = self.import_(["const", "value"], [["5", s]])
        self.assertEqual(
            result["messages"],
            [
                message(
                    "No matching record found for name '%s' in field 'Value'" % s[:50],
    ...
    def test_multi_subfields(self):
        ...
        self.assertEqual(
            values(b.value.sorted(), "str"), ["this", "is", "the", "rhythm"]
        )
    ...
    def test_subfields_fail_by_implicit_id(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "No matching record found for name 'noxidforthat' in field 'Value/Parent'",
                    moreinfo=moreaction(res_model="export.one2many"),
                    field_name="Value",
                    field_path=["value", "parent_id"],
                    field_type="name",
                    value="noxidforthat",
                )
            ],
    ...
    def test_name_create_enabled_m2o_in_o2m(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "No matching record found for name '101' in field 'Value/M2O'",
                    moreinfo=moreaction(res_model="export.integer"),
                    field_name="Value",
                    field_path=["value", "m2o"],
                    field_type="name",
                    value=101,
                )
            ],
    ...
    def test_escape_m2o_in_o2m(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "No matching record found for name '21%' in field 'Value/M2O'",
                    moreinfo=moreaction(res_model="export.integer"),
                    field_name="Value",
                    field_path=["value", "m2o"],
                    field_type="name",
...
class test_o2m_multiple(ImporterCase):
    ...
    def test_multi_mixed(self):
        result = self.import_(
            ["const", "child1/value", "child2/value"],
            [
                ["5", "11", "21"],
                ["", "12", "22"],
                ["", "13", "23"],
...
class test_realworld(SavepointCaseWithUserDemo):
    ...
    def test_bigfile(self):
        data = json.loads(
            file_open("test_import_export/data/contacts_big.json", "rt").read()
        )
        result = self.env["res.partner"].load(
            ["name", "phone_ids/number", "email", "image_1920"], data
        )
        self.assertFalse(result["messages"])
    ...
    def test_backlink(self):
        ...
        data = json.loads(
            file_open("test_import_export/data/contacts.json", "rt").read()
        )
    ...
    def test_recursive_o2m(self):
        ...
        self.assertEqual(
            [child.str for child in b[0].child.sorted()[1].child1], ["bar", "baz"]
        )
    ...
    def test_o2m_subfields_fail_by_implicit_id(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "No matching record found for name '5' in field 'Child/Child1/Parent'",
                    field="child",
                    moreinfo=moreaction(res_model="export.one2many.multiple"),
                    field_name="Child",
                    field_path=["child", "child1", "parent_id"],
                    field_type="name",
                    value="5",
                )
            ],
    ...
    def test_no_install_mode(self):
        ...
        self.assertEqual(len(result["messages"]), 1)
        self.assertEqual(
            result["messages"][0]["message"], "Name must start with an uppercase letter"
        )
        self.assertIs(result["ids"], False)
...
class test_date(ImporterCase):
    ...
    def test_invalid(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "'not really a date' does not seem to be a valid date for field 'Value'",
                    moreinfo="Use the format '2012-12-31'",
                    field_name="Value",
                    field_path=["value"],
                )
            ],
...
class test_datetime(ImporterCase):
    ...
    def test_invalid(self):
        ...
        self.assertEqual(
            ...
            [
                message(
                    "'not really a datetime' does not seem to be a valid datetime for field 'Value'",
                    moreinfo="Use the format '2012-12-31 23:59:59'",
                    field_name="Value",
                    field_path=["value"],
                )
            ],
    ...
    def test_checktz1(self):
        ...
        self.assertEqual(
            [
                fields.Datetime.to_string(value["value"])
                for value in self.read(domain=[("id", "in", result["ids"])])
            ],
            ["2012-02-02 21:11:11"],
        )
...
class test_unique(ImporterCase):
    ...
    def test_unique_pair(self):
        ...
        self.assertIn(
            "The value for 'value2, value3' (Value2 and Value3) already exists.",
            message["message"],
        )

    @mute_logger("odoo.db")
    def test_unique_update_record(self):
        existing_records = self.env[self.model_name].create(
            [{"value": 1}, {"value": 2}]
        )
        result = self.import_(
            [".id", "value"],
        ...
        self.assertIn(
            "The value for 'value' (Value) already exists.", message["message"]
        )
...
class CheckSavepoint(ImporterCase):
    ...
    def test_clean_batch_import_uses_constant_savepoints(self):
        ...
        with patch.object(
            Cursor, "savepoint", autospec=True, side_effect=Cursor.savepoint
        ) as sp_mock:
    ...
    def test_row_by_row_recovery_isolates_each_record(self):
        ...
        with (
            ...
            patch.object(
                Cursor, "flush", autospec=True, side_effect=Cursor.flush
            ) as sp_flush,
        ):
            result = self.import_(["value"], data)
