...
class TestPropertiesExportImport(HttpCase):
    ...
    def test_export_get_fields_inherits(self):
        ...
        res = self.url_open(
            ...
            data=json.dumps(
                {
                    "params": {
                        "model": "import.properties.inherits",
                        "import_compat": True,
                        "domain": [],
                    }
                }
    ...
    def test_export_properties(self):
        ...
        self.assertEqual(
            self.properties_records.with_context(import_compat=False)._export_rows(
                all_properties
            ),
            [
    ...
    def test_properties_type_field_accessible(self):
        ...
        record = self.env["export.aggregator.admin"].create(
    ...
    def test_export_complex_path_properties(self):
            ...
            [
                {
                    ...
                    "another_properties_id": self.properties_records[
                        1
                    ].id,  # Same definition
                },
                {
        ...
        self.assertEqual(
            path_records.with_context(import_compat=False).export_data(export_fields)[
                "datas"
            ],
            [
    ...
    def test_export_properties_field(self):
        ...
        export_data = (
            self.properties_records[0].export_data(["properties"]).get("datas", [])
        )
        self.assertIsInstance(export_data[0][0], dict)
        self.assertEqual(
            export_data[0][0],
            {"char_prop": "Not the default", "selection_prop": "selection_2"},
        )
    ...
    def test_import_properties(self):
        ...
        values_list = [
            ...
            [
                ...
                "True",
                "aa",
                ",".join(self.partners[:2].mapped("display_name")),
            ],
            [
                str(def_record_2.id),
                "",
        ...
        self.assertEqual(
            records_created.record_definition_id, def_record_1 + def_record_2
        )

        self.assertEqual(
            records_created.mapped("properties"),
            [
                {
                    "char_prop": "One Text",
                    "selection_prop": "selection_2",
                    "m2o_prop": self.partners[0].id,
                },
                {
                    "char_prop": "One Text",
                    "selection_prop": "selection_3",
                    "m2o_prop": self.partners[1].id,
                },
                {
                    "char_prop": "One Text",
                    "selection_prop": False,
                    "m2o_prop": self.partners[1].id,
                },
                {
                    "bool_prop": True,
                    "tags_prop": ["aa"],
                    "m2m_prop": self.partners[:2].ids,
                },
        ...
        values_list = [
            ...
            [
                external_ids[0],
                str(def_record_1.id),
                "SSBIYXRlIHRoaXMgZmVhdHVyZQ==",
                str(self.partners[2].id),
                "selection_2",
                "",
                "",
                "",
            ...
            [
                external_ids[1],
                str(def_record_2.id),  # record that changed its parent
                "",
                "",
                "",
                "FaLse",
                "AA",
                f"{self.partners[1].id}",
            ],
            [
                external_ids[4],
                str(def_record_2.id),
            ...
            [
                ...
                "1",
                "BB",
                f"{self.partners[1].id},{self.partners[2].id}",
            ],
        ]
        ...
        self.assertEqual(
            ...
            [
                {
                    "char_prop": "SSBIYXRlIHRoaXMgZmVhdHVyZQ==",
                    "selection_prop": "selection_2",
                ...
                },
                {
                    "bool_prop": False,
                    "tags_prop": ["aa"],
                    "m2m_prop": self.partners[1].ids,
                },
                {
                    "char_prop": "One Text",
                    "selection_prop": "selection_1",
                    "m2o_prop": self.partners[1].id,
                },
                {
                    "bool_prop": True,
    ...
    def test_import_properties_no_acces_acl(self):
        ...
        values_list = [
            [
                "Record Definition Id",
                f"TextType ({self.definition_records[0].display_name})",
            ],
            [
                str(self.definition_records[0].id),
                "One Text",
            ],
        ]
    ...
    def test_import_properties_no_acces_groups(self):
        ...
        self.patch(
            self.ModelDefinition._fields["properties_definition"],
            "groups",
            "base.NO_ACCESS",
        )
