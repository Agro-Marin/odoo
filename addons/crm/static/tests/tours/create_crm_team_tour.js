...
registry.category("web_tour.tours").add("create_crm_team_tour", {
    ...
    steps: () => [
        ...
        {
            trigger:
                'div.modal-dialog tr:contains("Test Salesman") input.form-check-input',
            run: "click",
        },
        {
            trigger:
                'div.modal-dialog tr:contains("Test Sales Manager") input.form-check-input',
            run: "click",
        },
        {
            trigger:
                'div.modal-dialog tr:contains("Test Sales Manager") input.form-check-input:checked',
        },
        {
