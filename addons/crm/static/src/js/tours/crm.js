...
registry.category("web_tour.tours").add("crm_tour", {
    ...
    steps: () => [
        ...
        {
            trigger:
                ".o_kanban_quick_create .o_field_widget[name='commercial_partner_id'] input",
            content: markup(
                _t(
                    "<b>Write a few letters</b> to look for a company, or create a new one.",
                ),
            ),
            tooltipPosition: "top",
        ...
        {
            trigger:
                ".o_kanban_quick_create .o_field_widget[name='name'] input:value('Brandon Freeman')",
        },
        {
        ...
        {
            trigger:
                ".o_opportunity_kanban:not(:has(.o_view_sample_data)) .o_kanban_group .o_kanban_record:last-of-type",
            content: markup(
                _t(
        ...
        },
        {
            ...
            content: markup(
                _t(
                    "Looks like nothing is planned. :(<br><br><i>Tip: Schedule activities to keep track of everything you have to do!</i>",
                ),
            ),
            tooltipPosition: "bottom",
            run: "click",
        ...
        {
            trigger:
                ".o-mail-ActivityListPopover button:contains(Schedule an activity)",
        ...
        },
        {
            ...
            content: _t(
                "Click on the breadcrumb to go back to your Pipeline. Odoo will save all modifications as you navigate.",
            ),
            tooltipPosition: "bottom",
