...
class TestCrmLeadRainbowmanMessages(TestCrmCommon):
    ...
    def test_leads_rainbowman(self):
        ...
        with self.mock_datetime_and_now(jan1_10am):
            ...
            msg_firstdeal = self._set_won_get_rainbowman_message(
                next(iter_leads_norevenue), self.user_sales_manager
            )
            self.assertEqual(
                msg_firstdeal,
            ...
            msg_25messages = self._set_won_get_rainbowman_message(
                lead_25messages, self.user_sales_manager
            )
            self.assertEqual(
                msg_25messages,
        ...
        with self.mock_datetime_and_now(jan1_12pm):
            ...
            msg_other_first_with_revenue = self._set_won_get_rainbowman_message(
                lead_other_first_with_revenue, self.user_sales_salesman
            )
            self.assertEqual(
            ...
            msg_first_country = self._set_won_get_rainbowman_message(
                lead_first_country, self.user_sales_manager
            )
            self.assertEqual(
                msg_first_country,
            ...
            msg_second_country = self._set_won_get_rainbowman_message(
                lead_second_country, self.user_sales_salesman
            )
            self.assertFalse(
                msg_second_country,
            ...
            msg_first_source = self._set_won_get_rainbowman_message(
                lead_first_source, self.user_sales_manager
            )
            self.assertEqual(
                msg_first_source,
            ...
            msg_second_source = self._set_won_get_rainbowman_message(
                lead_second_source, self.user_sales_salesman
            )
            self.assertFalse(
                msg_second_source,
            ...
            msg_combo5 = self._set_won_get_rainbowman_message(
                lead_combo5, self.user_sales_manager
            )
            self.assertEqual(
                msg_combo5,
        ...
        with self.mock_datetime_and_now(jan2):
            ...
            msg_fastclose_10 = self._set_won_get_rainbowman_message(
                lead_fastclose_10, self.user_sales_manager
            )
            self.assertEqual(
                msg_fastclose_10,
            ...
            msg_fastclose_15 = self._set_won_get_rainbowman_message(
                lead_fastclose_15, self.user_sales_manager
            )
            self.assertFalse(
                msg_fastclose_15,
            ...
            msg_fastclose_0 = self._set_won_get_rainbowman_message(
                lead_fastclose_0, self.user_sales_manager
            )
            self.assertEqual(
                msg_fastclose_0,
                "Wow, that was fast. That deal didn’t stand a chance!",
            ...
            self.assertFalse(
                self._set_won_get_rainbowman_message(
                    next(iter_leads_norevenue), self.user_sales_salesman
                ),
        ...
        with self.mock_datetime_and_now(jan3_12pm):
            ...
            msg_3daystreak = self._set_won_get_rainbowman_message(
                lead_3daystreak, self.user_sales_manager
            )
            self.assertEqual(
                msg_3daystreak,
        ...
        with self.mock_datetime_and_now(jan3_1pm):
            ...
            self.flush_tracking()
            all_leads.invalidate_recordset(["duration_tracking"])
            msg_first_to_last = self._set_won_get_rainbowman_message(
                lead_first_to_last, self.user_sales_manager
            )
            self.assertEqual(
                msg_first_to_last,
        ...
        with self.mock_datetime_and_now(jan4):
            ...
            for user, expected_revenue, expected_message in last_30_days_cases:
                with self.subTest(user=user, revenue=expected_revenue):
                    ...
                    msg_revenue = self._set_won_get_rainbowman_message(
                        lead_revenue, user
                    )
        ...
        with self.mock_datetime_and_now(jan12):
            last_7_days_cases = [
                (
                    self.user_sales_manager,
                    650,
                    "Yeah! Best deal out of the last 7 days for the team.",
                ),
                ...
                (
                    self.user_sales_salesman,
                    700,
                    "You just beat your personal record for the past 7 days.",
                ),
        ...
        with self.mock_datetime_and_now(march1):
            ...
            msg_later_record = self._set_won_get_rainbowman_message(
                lead_later_record, self.user_sales_manager
            )
            self.assertEqual(
                msg_later_record,
                "Boom! Team record for the past 30 days.",
    ...
    def test_leads_rainbowman_timezones(self):
        ...
        jan9_10_45am = datetime(2025, 1, 9, 10, 45, 0)
        jan9_11_30am = datetime(2025, 1, 9, 11, 30, 0)
        jan9_4pm = datetime(2025, 1, 9, 16, 0)
        jan9_6_45pm = datetime(2025, 1, 9, 18, 45)
        jan9_11pm = datetime(2025, 1, 9, 23, 0)
        jan10_midnight = datetime(2025, 1, 10, 0, 0)
        jan10_3am = datetime(2025, 1, 10, 3, 0)
        jan10_8am = datetime(2025, 1, 10, 8, 0)
        jan10_11am = datetime(2025, 1, 10, 11, 0)
        ...
        cases = [
            (jan9_10_45am, dict.fromkeys(sales_users, first_deal)),
            (jan9_11_30am, {}),
            (jan9_4pm, {}),
            (jan9_6_45pm, {}),
            ...
            with self.mock_datetime_and_now(deal_closing_time):
                for sales_user in sales_users:
                    with self.subTest(username=sales_user.name, time=deal_closing_time):
                        msg = self._set_won_get_rainbowman_message(
                            next(iter_leads), sales_user
                        )
    ...
    def test_leads_rainbowman_no_team(self):
        ...
        with self.mock_datetime_and_now(past_1pm):
            ...
            self._set_won_get_rainbowman_message(
                lead_prime_casey, self.sales_manager_casey, reset_team=True
            )
            self._set_won_get_rainbowman_message(
                lead_prime_benoit, self.user_sales_salesman
            )
        ...
        with self.mock_datetime_and_now(now):
            ...
            msg_lead_noteam = self._set_won_get_rainbowman_message(
                lead_noteam, self.sales_manager_casey, reset_team=True
            )
            self.assertEqual(
                msg_lead_noteam,
            ...
            self._set_won_get_rainbowman_message(
                next(iter_leads), self.sales_manager_casey
            )

            lead_noteam_samesource = next(iter_leads)
            lead_noteam_samesource.source_id = source_xitter_post
            msg_lead_noteam_samesource = self._set_won_get_rainbowman_message(
                lead_noteam_samesource, self.sales_manager_casey, reset_team=True
            )
            self.assertFalse(
            ...
            msg_lead_inteam_samesource = self._set_won_get_rainbowman_message(
                lead_inteam_samesource, self.user_sales_salesman
            )
            self.assertEqual(
