...
class TestCRMLeadSmartCalendar(TestCrmCommon):
    ...
    def test_meeting_view_parameters_1(self):
        lead_smart_calendar_1 = self.env["crm.lead"].create(
        ...
        lead_smart_calendar_2 = self.env["crm.lead"].create(
