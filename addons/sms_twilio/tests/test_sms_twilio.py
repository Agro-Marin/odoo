...
class TestSmsTwilio(MockSmsTwilio):
    ...
    def test_assert_initial_values(self):
        self.assertEqual(
            self.valid_partner._phone_get_number().number,
            self.twilio_valid_phone_number,
        )
        self.assertEqual(
            self.invalid_partner._phone_get_number().number,
            self.twilio_invalid_phone_number,
        )
    ...
    def test_send_sms_composer_partner(self):
        for (
            ...
            with self.subTest(
                partner=partner,
                number=partner._phone_get_number().number,
                        ...
                        [
                            {
                                "number": partner._phone_get_number().number,
                                "partner": partner,
                                "failure_type": exp_failure_type,
                                "failure_reason": exp_failure_reason,
    ...
    def test_send_with_multi_company(self):
        ...
        self.env.user.sudo().company_ids |= (
            company_twilio_2 + company_iap + company_iap_2
        )
            ...
            [
                {
                    ...
                    "phone_ids": [
                        Command.create(
                            {"number": f"+1220215411{i}", "type": "landline"}
                        )
                    ],
            ...
            [
                {
                    ...
                    "phone_ids": [
                        Command.create(
                            {"number": f"+1220215422{i}", "type": "landline"}
                        )
                    ],
            ...
            [
                {
                    ...
                    "phone_ids": [
                        Command.create(
                            {"number": f"+1220215433{i}", "type": "landline"}
                        )
                    ],
            ...
            [
                {
                    ...
                    "phone_ids": [
                        Command.create(
                            {"number": f"+1220215444{i}", "type": "landline"}
                        )
                    ],
