        ...
        with (
            ...
            invoice = self.create_invoice(
                ...
                invoice_line_ids=[
                    {
                        "price_unit": 100.0,
                        "tax_ids": [(6, 0, self._get_tax_by_xml_id("s_iva10b").ids)],
                    },
                    {
                        "price_unit": 200.0,
                        "tax_ids": [(6, 0, self._get_tax_by_xml_id("s_iva21s").ids)],
                    },
                ],
            )
            invoice.action_post()
        ...
        with (
            ...
            invoice = self.create_invoice(
                ...
                invoice_line_ids=[
                    ...
                    {
                        "price_unit": 200.0,
                        "tax_ids": [(6, 0, self._get_tax_by_xml_id("s_iva0_ns").ids)],
                    },
                ],
            )
            invoice.action_post()
                ...
                invoice_line_ids=[
                    {
                        ...
                        "tax_ids": [
                            Command.set(
                                (
                                    self._get_tax_by_xml_id("s_iva10b")
                                    + self._get_tax_by_xml_id("s_req014")
                                ).ids
                            )
                        ],
                    },
                    ...
                    },
                    {
                        ...
                        "tax_ids": [
                            Command.set(
                                (
                                    self._get_tax_by_xml_id("s_iva21s")
                                    + self._get_tax_by_xml_id("s_req52")
                                ).ids
                            )
                        ],
                    },
        ...
        with (
            ...
            invoice = self.create_invoice(
                ...
                invoice_line_ids=[
                    {
                        "price_unit": 100.0,
                        "tax_ids": [(6, 0, self._get_tax_by_xml_id("s_iva0_sp_i").ids)],
                    },
                    {
                        "price_unit": 200.0,
                        "tax_ids": [(6, 0, self._get_tax_by_xml_id("s_iva0_g_i").ids)],
                    },
                ],
            )
            invoice.action_post()
                ...
                json_file,
                {
                    ...
                    "FacturaExpedida": {
                        ...
                        "TipoDesglose": {
                            "DesgloseTipoOperacion": {
                                "PrestacionServicios": {
                                    "NoSujeta": {"ImporteTAIReglasLocalizacion": 100.0},
                                },
                                "Entrega": {
                                    "Sujeta": {
                                        "Exenta": {
        ...
        with (
            ...
            invoice = self.create_invoice(
                ...
                invoice_line_ids=[
                    {
                        "price_unit": 100.0,
                        "tax_ids": [(6, 0, self._get_tax_by_xml_id("s_iva_e").ids)],
                    },
                    {
                        "price_unit": 200.0,
                        "tax_ids": [(6, 0, self._get_tax_by_xml_id("s_iva0_g_e").ids)],
                    },
                ],
            )
            invoice.action_post()
                ...
                invoice_line_ids=[
                    {
                        ...
                        "tax_ids": [
                            (
                                ...
                                0,
                                (
                                    self._get_tax_by_xml_id("p_iva10_bc")
                                    + self._get_tax_by_xml_id("p_irpf19")
                                ).ids,
                            )
                        ],
                    },
                    {
                        ...
                        "tax_ids": [
                            (
                                ...
                                0,
                                (
                                    self._get_tax_by_xml_id("p_iva21_sc")
                                    + self._get_tax_by_xml_id("p_irpf19")
                                ).ids,
                            )
                        ],
        ...
        with (
            ...
            invoice = self.create_invoice(
                ...
                invoice_line_ids=[
                    {
                        "price_unit": 100.0,
                        "tax_ids": [(6, 0, self._get_tax_by_xml_id("p_iva10_bc").ids)],
                    }
                ],
            )
            invoice.action_post()
                ...
                invoice_line_ids=[
                    {
                        ...
                        "tax_ids": [
                            (
                                ...
                                (
                                    self._get_tax_by_xml_id("p_iva10_bc")
                                    + self._get_tax_by_xml_id("p_req014")
                                ).ids,
                            )
                        ],
                    },
                    {
                        ...
                        "tax_ids": [
                            (
                                ...
                                (
                                    self._get_tax_by_xml_id("p_iva21_sc")
                                    + self._get_tax_by_xml_id("p_req52")
                                ).ids,
                            )
                        ],
                    },
                ...
                invoice_line_ids=[
                    {
                        "price_unit": 100.0,
                        "tax_ids": [
                            (6, 0, self._get_tax_by_xml_id("p_iva21_sp_ex").ids)
                        ],
                    }
                ],
            )
        ...
        with (
            ...
            invoice = self.create_invoice(
                ...
                invoice_line_ids=[
                    {
                        "price_unit": 100.0,
                        "tax_ids": [(6, 0, self._get_tax_by_xml_id("p_iva0_ns").ids)],
                    },
                    {
                        "price_unit": 200.0,
                        "tax_ids": [(6, 0, self._get_tax_by_xml_id("p_iva10_bc").ids)],
                ...
                invoice_line_ids=[
                    {
                        ...
                        "tax_ids": [
                            (
                                ...
                                (
                                    self._get_tax_by_xml_id("s_iva10b")
                                    + self._get_tax_by_xml_id("s_irpf1")
                                ).ids,
                            )
                        ],
                    },
                ...
                invoice_line_ids=[
                    {
                        ...
                        "tax_ids": [
                            (
                                ...
                                (
                                    self._get_tax_by_xml_id("p_iva10_bc")
                                    + self._get_tax_by_xml_id("p_irpf1")
                                ).ids,
                            )
                        ],
                    },
        ...
        with (
            ...
            invoice = self.create_invoice(
                ...
                invoice_line_ids=[
                    {
                        "tax_ids": [
                            (6, 0, (self._get_tax_by_xml_id("p_iva21_ibc_group").ids))
                        ],
                    },
                ],
            )
                ...
                invoice_line_ids=[
                    {
                        "price_unit": 100.0,
                        "tax_ids": [
                            (6, 0, self._get_tax_by_xml_id("p_iva21_sp_in").ids)
                        ],
                    },
                    {
                        "price_unit": 200.0,
                        "tax_ids": [
                            (6, 0, self._get_tax_by_xml_id("p_iva21_ic_bc").ids)
                        ],
                    },
                ],
            )
            ...
            self.assertEqual(
                json_file,
                {
                    "IDFactura": {
                        ...
                        "NumSerieFacturaEmisor": "sup0001",
                        "IDEmisorFactura": {
                            "IDOtro": {"IDType": "02", "ID": "BE0477472701"},
                            "NombreRazon": "partner_a",
                        },
                    },
                    "FacturaRecibida": {
