...
class SaleOrderLine(models.Model):
    ...
    # Transfer block — qty_transferred_method from mixin, override string only
    qty_transferred_method = fields.Selection(string="Delivered Qty Method")
    ...
    def _tax_ids_include_product(self, line):
        """Exclude combo products from tax computation."""
    ...
    def _prepare_base_line_for_taxes_computation(self, **kwargs):
        """Extend mixin to add global_discount special type."""
        self.ensure_one()
        if self._is_global_discount():
            kwargs.setdefault("special_type", "global_discount")
    ...
    def _get_validate_write_vals_methods(self):
        """Extend mixin validators with sale-specific product/uom check."""
        methods = super()._get_validate_write_vals_methods()
        methods.append("_validate_write_product_and_uom")
        return methods
