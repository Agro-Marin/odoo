...
class SaleOrderLine(models.Model):
    ...
    def _compute_qty_transferred_method(self):
        ...
        Handles delivery quantity computation for:
        - Consumable products (type='consu')
        - Service products with manual service type (service_type='manual')
    ...
    def _check_line_unlink(self):
        ...
        * Confirmed lines without invoices can be deleted (including uninvoiced down payments).
        ...
        return self.filtered(
            lambda line: line.state == "sale" and not line.display_type,
        )
