...
class SaleOrder(models.Model):
    ...
    def _compute_invoice_state(self):
        ...
        - no: If the SO is not in status 'sale', or all lines are in 'no' state.
        ...
        for order in confirmed_orders:
            ...
            # - Explicit "partially" state from line-level computation
            # - Mixed done/no: some lines fully invoiced, others not invoiceable
            if "partially" in states or states == {"done", "no"}:
