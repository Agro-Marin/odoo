...
class TestSalePrices(SaleCommon):
    ...
    def setUpClass(cls):
        ...
        cls.env.company.tax_config_id.account_fiscal_country_id = belgium
    ...
    def test_multi_currency_discount(self):
        ...
        product_2_ctxt.standard_price = 10.0
        ...
        branch_company = self.env["res.company"].create(
            {
                ...
                "account_fiscal_country_id": self.env.company.tax_config_id.account_fiscal_country_id.id,
            }
        )
    ...
    def test_product_quantity_rounding(self):
        ...
        order.action_confirm()
        line = order.line_ids
        quantity_precision = self.env["decimal.precision"].get_precision("Product Unit")
        self.assertEqual(
