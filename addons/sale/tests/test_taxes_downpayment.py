...
class TestTaxesDownPaymentSale(TestTaxCommonSale, TestTaxesDownPayment):
            ...
            [
                {
                    ...
                    - expected_values["total_amount_currency"]
                },
            ],
        )
    ...
    def test_down_payment_invoice_multiple_taxes_and_accounts(self):
        ...
        down_payment_label = (
            f"Down Payment: {so.create_date.strftime('%m/%d/%Y')} (Draft)"
        )
        self.assertRecordValues(
            so.line_ids,
            [
        ...
        self.assertRecordValues(
            ...
            [
                ...
                {
                    "account_id": revenue_account_2.id,
                    "tax_ids": tax_15.ids,
                    "balance": -3000.0,
                },
                {
            ...
            [
                {
                    ...
                    - dp_invoice_1.amount_untaxed
                    - dp_invoice_2.amount_untaxed,
                    "amount_tax": so.amount_tax
                    - dp_invoice_1.amount_tax
                    - dp_invoice_2.amount_tax,
                    "amount_total": so.amount_total
                    - dp_invoice_1.amount_total
                    - dp_invoice_2.amount_total,
                }
            ],
        )
        self.assertRecordValues(
    ...
    def test_down_payment_invoice_then_refunded_then_invoiced_again(self):
        ...
        self.assertRecordValues(
            ...
            [
                ...
                {"name": "Down Payments", "tax_ids": [], "price_subtotal": 0.0},
                {
                    "name": down_payment_dp_invoice_1,
                    "tax_ids": tax_15.ids,
                    "price_subtotal": 0.0,
                },
            ],
        ...
        self.assertRecordValues(
            ...
            [
                ...
                {
                    "name": down_payment_dp_invoice_2,
                    "tax_ids": tax_15.ids,
                    "price_subtotal": 0.0,
                },
            ],
    ...
    def test_down_payment_analytic_distribution_aggregation(self):
        ...
        an_acc_1 = str(
            ...
            .create({"name": "Account 01", "plan_id": analytic_plan.id})
            .id
        )
        an_acc_2 = str(
            self.env["account.analytic.account"]
            .create({"name": "Account 02", "plan_id": analytic_plan.id})
            .id
        )
        tax_10 = self.percent_tax(10.0)
        tax_15 = self.percent_tax(15.0)
