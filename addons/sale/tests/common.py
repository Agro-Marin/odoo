        ...
        company_data.update(
            {
                ...
                "product_service_order": cls.env["product.product"]
                .with_company(company)
                .create(
                    {
                ...
                "product_order_cost": cls.env["product.product"]
                .with_company(company)
                .create(
                    {
                ...
                "product_delivery_cost": cls.env["product.product"]
                .with_company(company)
                .create(
                    {
                ...
                "product_order_sales_price": cls.env["product.product"]
                .with_company(company)
                .create(
                    {
                ...
                "product_delivery_sales_price": cls.env["product.product"]
                .with_company(company)
                .create(
                    {
                ...
                "product_order_no": cls.env["product.product"]
                .with_company(company)
                .create(
                    {
                ...
                "product_delivery_no": cls.env["product.product"]
                .with_company(company)
                .create(
                    {
                    ...
                    Command.create(
                        {
                            "name": str(i),
                            "product_id": (
                                base_line["product_id"] or self.product_a
                            ).id,
