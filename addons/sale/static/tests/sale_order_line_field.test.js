...
test("test combo move up/down", async () => {
    ...
    await contains(
        ".o_data_row:contains(Test Combo1) .o_list_section_options button",
    ).click();
    expect(".o-dropdown-item:contains(Move Up)").toHaveCount(1, {
        message:
            "Move up option should be there for Test combo1 line having SO lines before and after",
    });
    expect(".o-dropdown-item:contains(Move Down)").toHaveCount(1, {
        message:
            "Move down option should be there for Test combo1 line having SO lines before and after",
    });
    ...
    expect(".o-dropdown-item:contains(Move Up)").toHaveCount(0, {
        message:
            "Move up option should be invisible for Test combo1 since there aren't any non combo SO lines before",
    });

    await contains(
        ".o_data_row:contains(Test Combo2) .o_list_section_options button",
    ).click();
    expect(".o-dropdown-item:contains(Move Up)").toHaveCount(1, {
        message:
            "Move up option should be there for Test combo2 line having SO lines before and after",
    });
    expect(".o-dropdown-item:contains(Move Down)").toHaveCount(1, {
        message:
            "Move down option should be there for Test combo2 line having SO lines before and after",
    });
    ...
    expect(".o-dropdown-item:contains(Move Down)").toHaveCount(0, {
        message:
            "Move down option should be invisible for Test combo2 since there aren't any non combo SO lines after",
    });
    ...
    expect(queryAllTexts(".o_data_row")).toEqual(
        ...
        {
            message:
                "Test combo1 line should be moved up two lines and Test combo2 line should be moved down one line",
        },
    );
    ...
    expect(queryAllTexts(".o_data_row")).toEqual(
        ...
        {
            message:
                "Test combo1 and Test combo2 should be swapped when moving Test combo1 down",
        },
    );
    ...
    expect(queryAllTexts(".o_data_row")).toEqual(
        ...
        {
            message:
                "Test combo1 and Test combo2 should be swapped when moving Test combo2 up",
        },
    );
});
