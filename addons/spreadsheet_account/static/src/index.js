...
cellMenuRegistry.add("move_lines_see_records", {
    ...
    async execute(env, newWindow) {
        ...
        let codes,
            partner_ids,
            account_tag_ids = "";
        let date_range, offset, companyId, includeUnposted;
        ...
        if (func.functionName === "ODOO.PARTNER.BALANCE") {
            [partner_ids, codes, date_range, offset, companyId, includeUnposted] =
                parsed_args;
        } else if (func.functionName === "ODOO.BALANCE.TAG") {
            [account_tag_ids, date_range, offset, companyId, includeUnposted] =
                parsed_args;
        } else {
