...
function closePreferencesDialog({ content, totp_state }) {
    ...
    switch (totp_state) {
        ...
        case false:
            ...
            break;
        case undefined:
            trigger = 'div:contains("Two-factor Authentication") + button';
            break;
        default:
            throw new Error(`Invalid totp state ${totp_state}`);
    }
...
registry.category("web_tour.tours").add("totp_tour_setup", {
    ...
    steps: () => [
        ...
        {
            content:
                "Check that we have to enter enhanced security mode and input password",
        ...
        {
            trigger:
                ".modal button.btn-primary:contains(Enable Two-Factor Authentication)",
            run: "click",
        },
        {
            trigger:
                ".o_notification_content:contains(2-Factor authentication is now enabled)",
        },
        ...openRoot(),
        ...openUserPreferencesAtSecurityTab(),
...
registry.category("web_tour.tours").add("totp_login_enabled", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger:
                "p.alert.alert-danger:contains(Verification failed, please double-check the 6-digit code)",
        },
        {
        ...
        },
        {
            ...
            trigger:
                "p.alert.alert-danger:contains(Verification failed, please use the latest 6-digit code)",
        },
        {
            content: "input code",
            trigger: "input[name=totp_token]",
...
registry.category("web_tour.tours").add("totp_login_device", {
    ...
    steps: () => [
        ...
        {
            trigger:
                ".o_notification_content:contains(Two-factor authentication disabled)",
        },
        ...openRoot(),
        ...openUserPreferencesAtSecurityTab(),
        ...closePreferencesDialog({
...
registry.category("web_tour.tours").add("totp_admin_disables", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger:
                'tr:has(td.o_data_cell:contains("test_user")) ' +
        ...
        },
        {
            ...
            content:
                "Check that we have to enter enhanced security mode & input password",
            trigger: ".modal [name=password] input",
            run: "edit admin",
        },
        {
