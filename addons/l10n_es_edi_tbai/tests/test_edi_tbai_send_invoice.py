...
class TestSendAndPrintEdiGipuzkoa(TestEsEdiTbaiCommonGipuzkoa):
    ...
    def test_post_invoice_tbai_failure(self):
        ...
        self.assertNotEqual(
            invoice.l10n_es_tbai_post_document_id.id, failed_document_id
        )
    ...
    def test_cancel_invoice_tbai_failure(self):
        ...
        self.assertNotEqual(
            invoice.l10n_es_tbai_cancel_document_id.id, failed_document_id
        )
    ...
    def test_cancel_invoice_request_error(self):
        ...
        self.assertEqual(
            invoice.l10n_es_tbai_cancel_document_id.id, pending_document_id
        )
