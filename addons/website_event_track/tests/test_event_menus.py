...
class TestEventWebsiteTrack(OnlineEventCase):
    def _get_menus(self):
        return super()._get_menus() | {"Talks", "Agenda", "Propose a talk"}
    ...
    def test_create_menu(self):
        ...
        self._assert_website_menus(
            event,
            ["Home", "Rooms", "Practical"],
            menus_out=["Talks", "Agenda", "Propose a talk"],
        )
    ...
    def test_menu_management_frontend(self):
        ...
        self._assert_website_menus(
            event,
            ["Talks", "Agenda", "Propose a talk", "Rooms", "Practical"],
            menus_out=["Home"],
        )

        sub_menus = menus.child_id.filtered(
            lambda menu: menu.name in ["Agenda", "Propose a talk"]
        )
        sub_menus.unlink()
        self.assertTrue(event.website_track)
        ...
        self._assert_website_menus(
            event,
            ["Practical", "Rooms"],
            menus_out=["Home", "Talks", "Agenda", "Propose a talk"],
        )
        ...
        self._assert_website_menus(
            event,
            ["Practical", "Rooms", "Talks", "Agenda", "Propose a talk"],
            menus_out=["Home"],
        )
        ...
        self._assert_website_menus(
            event,
            ["Practical", "Rooms", "Talks", "Agenda"],
            menus_out=["Home", "Propose a talk"],
        )
