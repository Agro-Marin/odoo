...
class TestTrackData(TestEventOnlineCommon):
    ...
    def test_track_duration(self):
        ...
        for track, (exp_date, exp_date_end, exp_duration) in zip(
            tracks,
            [
...
class TestTrackSuggestions(TestEventOnlineCommon):
    def test_track_suggestion(self):
        ...
        [track_1, track_2, track_3, track_4, track_5, track_6] = self.env[
            "event.track"
        ].create(
            [
                {
        ...
        with (
            patch.object(
                ...
                lambda *args, **kwargs: emp_visitor,
            ),
