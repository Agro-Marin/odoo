...
class TestFrenchWorkEntries(TransactionCase):
    ...
    def test_fill_gaps(self):
        ...
        self.assertEqual(
            len(work_entry_create_vals), 4, "Should have generated 4 work entries."
        )
        ...
        with self.assertQueryCount(45):
            ...
            _logger.info(
                "Get Contract Work Entries: --- %s seconds ---",
                time.time() - start_time,
            )
        self.assertEqual(
            len(work_entry_create_vals), 10, "Should have generated 10 work entries."
        )
        ...
        self.assertEqual(
            len(work_entry_create_vals), 8, "Should have generated 8 work entries."
        )
