...
class TestHrCalendarCommon(common.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.calendar_35h, cls.calendar_28h, cls.calendar_35h_night = cls.env[
            "resource.calendar"
        ].create(
            [
                {
        ...
        cls.partnerA, cls.partnerB, cls.partnerC, cls.partnerD = cls.env[
            "res.partner"
        ].create(
            [
                {
