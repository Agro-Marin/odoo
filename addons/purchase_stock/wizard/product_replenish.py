...
class ProductReplenish(models.TransientModel):
            ...
            orderpoint = self.env["stock.warehouse.orderpoint"].search(
                [
                    (
                        "product_id",
                        "in",
                        [product_tmpl_id.product_variant_id.id, product_id.id],
                    ),
    ...
    def _onchange_supplier_id(self):
        if (
            ...
            and self.product_tmpl_id.seller_ids
        ):
            ...
            return [
                {
                    ...
                    "url": f"/odoo/action-purchase.action_purchase_order_3/{order_line.order_id.id}",
                },
            ]
