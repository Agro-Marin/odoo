...
class PurchaseOrder(models.Model):
    ...
    def write(self, vals):
        if vals.get("line_ids") and self.state == "purchase":
            for order in self:
                pre_order_line_qty = {
    ...
    def action_add_from_catalog(self):
        ...
        kanban_view_id = self.env.ref(
            "purchase_stock.product_view_kanban_catalog_purchase_only"
        ).id
        action["views"] = [
            (
    ...
    def action_purchase_order_suggest(self):
        ...
        for product in products:
            ...
            existing_po_lines = self.line_ids.filtered(
        ...
        for order_line in order_lines:
            ...
            if order_line.move_dest_ids:
                ...
                moves_to_mts = move_dest_ids.filtered(
                    lambda move: move.rule_id.route_id
    ...
    def _get_product_catalog_order_line_info(
        ...
        if kwargs.get("suggest_based_on"):
            ...
            return super(
                PurchaseOrder, self.with_context(suggest_ctx)
    ...
    def _log_decrease_ordered_quantity(self, purchase_order_lines_quantities):
        ...
        documents = self.env["stock.picking"]._log_activity_get_documents(
            purchase_order_lines_quantities, "move_ids", "DOWN", _keys_in_groupby
        )
        filtered_documents = {}
