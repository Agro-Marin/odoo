...
class PurchaseOrderLine(models.Model):
    ...
    def _compute_qty_transferred(self):
        super(PurchaseOrderLine, self)._compute_qty_transferred()
    ...
    def _hook_on_created_confirmed_lines(self):
        ...
        self._create_or_update_picking()  # Then create/update pickings
    ...
    def _prepare_aml_vals(self, move=False):
        res = super()._prepare_aml_vals(move=move)
    ...
    def _update_qty_transferred_method(self):
        ...
        self.search(["!", ("state", "=", "purchase")])._compute_qty_transferred_method()
