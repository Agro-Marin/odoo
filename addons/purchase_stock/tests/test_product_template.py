...
class TestProductTemplate(TransactionCase):
    ...
    def test_product_purchase_method_with_purchase_as_default_purchase_method(self):
        self.env["ir.default"].set(
            "product.template", "bill_policy", "ordered", company_id=True
        )
