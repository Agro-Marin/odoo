...
class TestL10nArWebsiteSale(TestAr):
        ...
        cls.product_1 = cls.env["product.template"].create(
            {
                ...
                "is_published": True,
                "list_price": 1000,
                "taxes_id": cls.env["account.chart.template"].ref(
    ...
    def test_default_website_sale_legal_values(self):
        ...
        self.assertEqual(
            self.ar_website.show_line_subtotals_tax_selection, "tax_included"
        )
    ...
    def test_product_variant_prices_with_attributes(self):
        ...
        self.product_1.taxes_id = self.env["account.chart.template"].ref(
            "ri_tax_vat_21_ventas"
        )
