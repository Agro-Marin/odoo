...
class TestTdsTcsAlert(L10nInTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.sale_account.write(
            {
                "l10n_in_tds_tcs_section_id": cls.env.ref(
                    "l10n_in.tcs_section_206c1g_r"
                ).id
            }
        )
        ...
        cls.tax_194c.write(
            {"l10n_in_section_id": cls.env.ref("l10n_in.tds_section_194c").id}
        )
        cls.tax_194j = ChartTemplate.ref("tds_10_us_194j")
        cls.tax_194j.write(
            {"l10n_in_section_id": cls.env.ref("l10n_in.tds_section_194j").id}
        )
        cls.tax_194ib = ChartTemplate.ref("tds_20_us_194ib")
        cls.tax_194ib.write(
            {"l10n_in_section_id": cls.env.ref("l10n_in.tds_section_194ib").id}
        )
        cls.tax_206c1g_r = ChartTemplate.ref("tcs_5_us_206c_1g_som")
        cls.tax_206c1g_r.write(
            {"l10n_in_section_id": cls.env.ref("l10n_in.tcs_section_206c1g_r").id}
        )
    ...
    def test_tcs_tds_warning_on_exceeded_per_transaction_limit(self):
        ...
        self.assertEqual(
            move.l10n_in_warning["tds_tcs_threshold_alert"]["message"],
            "It's advisable to deduct TDS u/s 194C on this transaction.",
        )
        ...
        self.assertEqual(
            move_1.l10n_in_warning["tds_tcs_threshold_alert"]["message"],
            "It's advisable to deduct TDS u/s 194C on this transaction.",
        )
        ...
        self.assertEqual(
            move_3.l10n_in_warning["tds_tcs_threshold_alert"]["message"],
            "It's advisable to deduct TDS u/s 194C on this transaction.",
        )
    ...
    def test_tcs_tds_warning_on_monthly_aggregate_limit(self):
        ...
        self.assertEqual(
            move_2.l10n_in_warning["tds_tcs_threshold_alert"]["message"],
            "It's advisable to deduct TDS u/s 194IB on this transaction.",
        )
        ...
        self.assertEqual(
            move_4.l10n_in_warning["tds_tcs_threshold_alert"]["message"],
            "It's advisable to deduct TDS u/s 194IB on this transaction.",
        )
    ...
    def test_tcs_tds_warning_partner_wiht_pan(self):
        ...
        self.assertEqual(
            move_3.l10n_in_warning["tds_tcs_threshold_alert"]["message"],
            "It's advisable to deduct TDS u/s 194J on this transaction.",
        )
    ...
    def test_tcs_tds_warning_on_exceeded_aggregate_limit(self):
        ...
        self.assertEqual(
            move_5.l10n_in_warning["tds_tcs_threshold_alert"]["message"],
            "It's advisable to deduct TDS u/s 194C on this transaction.",
        )
    ...
    def test_tcs_tds_warning_for_multiple_accounts_in_lines(self):
        ...
        self.tds_wizard_entry(
            move=move_1,
            lines=[
                (self.tax_194ib, 100000),
                (self.tax_194j, 100000),
                (self.tax_194c, 100000),
            ],
        )
        move_1.action_draft()
        move_1.action_post()
