...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _prepare_demo_data(self, company=False):
        demo_data = {}
        if company.tax_config_id.account_fiscal_country_id.code == "IN":
            if company.state_id:
                company.write(
                    {
    ...
    def _prepare_demo_data_partner(self):
        ...
        if (
            company.tax_config_id.account_fiscal_country_id.code != "IN"
                        ...
                        Command.create(
                            {
                                ...
                                "price_unit": 40000.0,
                                "tax_ids": [
                                    Command.set([_get_tax_by_id("sgst_sale_28")])
                                ],
                            }
                        ),
                        Command.create(
                            {
                                ...
                                "tax_ids": [
                                    Command.set(
                                        [
                                            _get_tax_by_id("sgst_sale_28"),
                                            _get_tax_by_id("cess_5_plus_1591_sale"),
                                        ]
                                    )
                                ],
                            }
                        ...
                        Command.create(
                            {
                                ...
                                "price_unit": 300.0,
                                "tax_ids": [
                                    Command.set([_get_tax_by_id("sgst_sale_18")])
                                ],
                            }
                        ),
                    ],
                        ...
                        Command.create(
                            {
                                ...
                                "price_unit": 4000.0,
                                "tax_ids": [
                                    Command.set([_get_tax_by_id("igst_sale_5")])
                                ],
                            }
                        ),
                        Command.create(
                        ...
                        Command.create(
                            {
                                ...
                                "price_unit": 1000.0,
                                "tax_ids": [
                                    Command.set([_get_tax_by_id("igst_purchase_18")])
                                ],
                            }
                        ),
                        Command.create(
                        ...
                        Command.create(
                            {
                                ...
                                "price_unit": 1000.0,
                                "tax_ids": [
                                    Command.set([_get_tax_by_id("sgst_purchase_18")])
                                ],
                            }
                        ),
                        Command.create(
                        ...
                        Command.create(
                            {
                                ...
                                "price_unit": 1500.0,
                                "tax_ids": [
                                    Command.set([_get_tax_by_id("igst_sale_18")])
                                ],
                            }
                        ),
                        Command.create(
                        ...
                        Command.create(
                            {
                                ...
                                "tax_ids": [
                                    Command.set(
                                        [_get_tax_by_id("igst_sale_18_sez_exp")]
                                    )
                                ],
                            }
                        ),
                        ...
                        Command.create(
                            {
                                ...
                                "price_unit": 25000.0,
                                "tax_ids": [
                                    Command.set([_get_tax_by_id("exempt_sale")])
                                ],
                            }
                        ),
                        Command.create(
                            {
                                ...
                                "price_unit": 400.0,
                                "tax_ids": [
                                    Command.set([_get_tax_by_id("nil_rated_sale")])
                                ],
                            }
                        ),
                    ],
