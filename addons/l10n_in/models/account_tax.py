...
class AccountTax(models.Model):
    ...
    def _prepare_base_line_for_taxes_computation(self, record, **kwargs):
        ...
        results["l10n_in_hsn_code"] = self._get_base_line_field_value_from_record(
            record, "l10n_in_hsn_code", kwargs, False
        )
        return results
    ...
    def _l10n_in_get_hsn_summary_table(self, base_lines, display_uom):
        ...
        return {
            ...
            "items": [key | values for key, values in items_map.items()],
        }
