...
class TestGamificationBadge(TestHrCommon):
    ...
    def setUpClass(cls):
        ...
        cls.demo_user, cls.demo2_user, cls.demo3_user, cls.demo4_manager = (
            cls.env["res.users"]
    ...
    def test_update_badge(self):
        ...
        badge_user.with_user(self.demo4_manager).write(
            {"comment": user_comment + "manager"}
        )
