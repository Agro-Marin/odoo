...
class TestAngloSaxonValuationPurchaseMRP(TestStockValuationCommon):
    ...
    def test_avco_purchase_nested_kit_explode_cost_share(self):
        ...
        for actual, expected in zip(cost_share_values, expected_cost_share, strict=True):
        ...
        move_form.purchase_vendor_bill_id = self.env['purchase.bill.match'].browse(-purchase_orders[0].id)
