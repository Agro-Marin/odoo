...
class TestResMixin(TestResourceCommon):
    def test_adjust_calendar(self):
        ...
        result = self.john._adjust_to_calendar(
            self.datetime_tz(
                2020, 4, 4, 9, 0, 0, tzinfo=self.john.tz
            ),  # both a day without attendance
        ...
        result = self.john._adjust_to_calendar(
            self.datetime_tz(2020, 4, 3, 8, 0, 0, tzinfo=self.john.tz),
            self.datetime_tz(
                2020, 4, 4, 14, 0, 0, tzinfo=self.john.tz
        ...
        result = self.john._adjust_to_calendar(
            self.datetime_tz(
                2020, 4, 2, 8, 0, 0, tzinfo=self.john.tz
            ),  # day without attendance
            self.datetime_tz(2020, 4, 3, 14, 0, 0, tzinfo=self.john.tz),
        )
        self.assertEqual(
        ...
        result = self.john._adjust_to_calendar(
            self.datetime_tz(
                2020, 3, 31, 0, 0, 0, tzinfo=self.john.tz
            ),  # search between Tuesday and Thursday
        ...
        result = self.john._adjust_to_calendar(
            self.datetime_tz(
                2020, 3, 31, 0, 0, 0, tzinfo=self.john.tz
            ),  # search between Tuesday and Friday
    ...
    def test_adjust_calendar_timezone_after(self):
        ...
        result = self.john._adjust_to_calendar(
            datetime(
                2020, 4, 2, 23, 0, 0
            ),  # The previous day in UTC, but the 3rd in Europe/Brussels
        ...
        leave = self.env["resource.calendar.leaves"].create(
            {
                ...
                "date_from": self.datetime_str(
                    2018, 4, 2, 10, 0, 0, tzinfo=self.jean.tz
                ),
        ...
        self.env["resource.calendar.leaves"].create(
            {
                ...
                "resource_id": self.jean.resource_id.id,
                "date_from": self.datetime_str(
                    2018, 4, 10, 8, 0, 0, tzinfo=self.jean.tz
                ),
                "date_to": self.datetime_str(
                    2018, 4, 10, 16, 0, 0, tzinfo=self.jean.tz
                ),
            }
        )
        ...
        self.env["resource.calendar.leaves"].create(
            {
                ...
                "resource_id": self.jean.resource_id.id,
                "date_from": self.datetime_str(
                    2018, 4, 12, 8, 0, 0, tzinfo=self.john.tz
                ),
                "date_to": self.datetime_str(
                    2018, 4, 12, 16, 0, 0, tzinfo=self.john.tz
                ),
            }
        )
        ...
        self.env["resource.calendar.leaves"].create(
            {
                ...
                "date_from": self.datetime_str(
                    2018, 4, 10, 0, 0, 0, tzinfo=self.jean.tz
                ),
                "date_to": self.datetime_str(
                    2018, 4, 10, 20, 0, 0, tzinfo=self.jean.tz
                ),
            }
        )
        ...
        self.env["resource.calendar.leaves"].create(
            {
                ...
                "resource_id": self.john.resource_id.id,
                "date_from": self.datetime_str(
                    2018, 4, 13, 7, 0, 0, tzinfo=self.john.tz
                ),
                "date_to": self.datetime_str(
                    2018, 4, 13, 18, 0, 0, tzinfo=self.john.tz
                ),
            }
        )
        ...
        jean_leave = self.env["resource.calendar.leaves"].create(
            {
                ...
                "date_to": self.datetime_str(
                    2018, 4, 10, 23, 59, 59, tzinfo=self.jean.tz
                ),
            }
        )
