    ...
    steps: () =>
        [
            ...
            },
            {
                ...
                content: markup(
                    _t(
                        "This is the <b>name</b> your guests will see when registering.",
                    ),
                ),
            ...
            },
            {
                ...
                run: function () {
                    const el1 = this.anchor.querySelector(
                        'input[data-field="date_begin"]',
                    );
                    el1.value = "09/30/2020 08:00:00";
                    el1.dispatchEvent(new Event("change"));
                    const el2 = this.anchor.querySelector(
                        'input[data-field="date_end"]',
                    );
            ...
            },
            {
                ...
                content: markup(
                    _t(
                        "Open date range picker.<br/>Pick a Start and End date for your event.",
                    ),
                ),
                run: "click",
            },
            ...
            },
            {
                ...
                content: markup(
                    _t(
                        "Use the <b>breadcrumbs</b> to go back to your kanban overview.",
                    ),
                ),
                tooltipPosition: "bottom",
                run: "click",
