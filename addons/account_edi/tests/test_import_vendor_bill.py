...
class TestImportVendorBill(AccountTestInvoicingCommon):
    def test_retrieve_partner(self):
        ...
        def retrieve_partner(vat, import_vat):
            ...
            return self.env["res.partner"]._get_matching_partner(vat=import_vat)

        self.assertEqual(
            self.partner_a, retrieve_partner("BE0477472701", "BE0477472701")
        )
        ...
        self.assertEqual(
            self.env["res.partner"], retrieve_partner("DE0477472701", "BE0477472701")
        )
        self.assertEqual(
            self.partner_a,
