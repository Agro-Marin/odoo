...
registry.category("web_tour.tours").add("event_buy_last_ticket", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger:
                ".modal .modal-footer button.btn-primary.a-submit:contains(Register)",
            run: "click",
        },
        {
            content: "Check the modal Attendees is opened",
            trigger:
                ".modal:contains(Attendees):contains(Ticket #1):contains(Ticket #2)",
        },
        {
        ...
        },
        {
            ...
            trigger:
                ".modal:contains(Attendees) button[type=submit]:contains(Go to Payment)",
            run: "click",
            expectUnloadPage: true,
        },
