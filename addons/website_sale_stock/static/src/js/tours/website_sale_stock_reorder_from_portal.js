...
registry.category("web_tour.tours").add("website_sale_stock_reorder_from_portal", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger:
                "div.alert-warning:contains('unavailable_product has not been added to your cart since it is not available.')",
        },
        {
            content: "Check that there is one product that does not have enough stock",
            trigger:
                "div.o_cart_product i.fa.fa-warning[title='You ask for 2 products but only 1 is available.']",
        },
    ],
});
