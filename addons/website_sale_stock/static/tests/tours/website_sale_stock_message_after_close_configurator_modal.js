            ...
            steps: () => [
                {
                    ...
                    trigger:
                        '.oe_product_cart a:contains("Product With Optional (TEST)")',
                    run: "click",
                ...
                {
                    content:
                        "Check that the stock quantity is displayed and correct after adding to cart",
            ...
            steps: () => [
                {
                    ...
                    trigger:
                        '.oe_product_cart a:contains("Product Without Optional (TEST)")',
                    run: "click",
                    expectUnloadPage: true,
                },
                {
