...
class TestL10nSGEmvQrCode(AccountTestInvoicingCommon):
    ...
    def test_emv_qr_code_generation(self):
        ...
        with self.assertRaises(
            UserError, msg="The chosen QR-code type is not eligible for this invoice."
        ):
            self.emv_qr_invoice._generate_qr_code()
    ...
    def test_emv_qr_vals(self):
        ...
        self.assertEqual(
            emv_qr_vals,
            "00020101021226400009SG.PAYNOW010120213200002150HWCF0301052040000530370254031005802SG5914company_1_data6009Singapore62170113INV/TEST/0001630416C8",
        )
