...
class TestTokenSyncResolution(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        private_key = (
            cls.env["certificate.key"].sudo()._generate_rsa_private_key(cls.env.company)
        )
    ...
    def test_peppol_out_of_sync_detection(self):
        ...
        with (
            ...
            settings.account_peppol_contact_email = (
                "a@a.com"  # triggers the inverse to update the mail
            )
