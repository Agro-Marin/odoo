...
class TestSaleMargin(SaleCommon):
    ...
    def test_negative_margin(self):
        ...
        self.assertEqual(order.line_ids[0].margin, -20.00, "Sales order profit should be -20.00")
        self.assertEqual(order.line_ids[0].margin_percent, -1, "Sales order margin percentage should be -100%")
        self.assertEqual(order.line_ids[1].margin, -100.00, "Sales order profit should be -100.00")
        self.assertEqual(order.line_ids[1].margin_percent, 1.00, "Sales order margin should be 100% when the cost is zero and price defined")
        # Verify that margin field gets bind with the value.
    ...
    def test_margin_no_cost(self):
        ...
        # Verify that margin field of Sale Order Lines gets bind with the value.
        self.assertEqual(order.line_ids[0].margin, 70.00, "Sales order profit should be 70.00")
        self.assertEqual(order.line_ids[0].margin_percent, 1.0, "Sales order margin percentage should be 100.00")
        # Verify that margin field gets bind with the value.
    ...
    def test_margin_considering_product_qty(self):
        ...
        order.action_confirm()
        # Verify that margin field of Sale Order Lines gets bind with the value.
        self.assertEqual(order.line_ids[0].margin, 150.00, "Sales order profit should be 150.00")
        self.assertEqual(order.line_ids[0].margin_percent, 0.5, "Sales order margin should be 100%")
        self.assertEqual(order.line_ids[1].margin, -50.00, "Sales order profit should be -50.00")
        self.assertEqual(order.line_ids[1].margin_percent, 1.0, "Sales order margin should be 100%")
        # Verify that margin field gets bind with the value.
    ...
    def test_sale_margin_order_copy(self):
        ...
        self.assertAlmostEqual(.5, order.line_ids.margin_percent)
        ...
        self.assertAlmostEqual(.25, following_sale.line_ids.margin_percent)
