...
class TestResPartner(TestCrmCommon):
    ...
    def test_application_stat_info(self):
        ...
        self.assertEqual(
            contact_company_1.opportunity_count,
            4,
            "Should contain own + children leads",
        )
        self.assertEqual(
            contact_1.opportunity_count, 3, "Should contain own + child leads"
        )
        self.assertEqual(contact_1_1.opportunity_count, 2, "Should contain own, aka 2")
        self.assertEqual(
            contact_1_2.opportunity_count, 0, "Should contain own, aka none"
        )
