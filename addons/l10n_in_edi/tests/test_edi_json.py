...
class TestEdiJson(L10nInTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        gst_with_cess = cls.env.ref(
            "account.%s_sgst_sale_12" % (cls.company_data["company"].id)
        ) + cls.env.ref(
        ...
        cls.invoice = cls.init_invoice(
            "out_invoice", post=False, products=cls.product_a + cls.product_with_cess
        )
        cls.invoice.write(
            {
                "invoice_line_ids": [
                    (1, l_id, {"discount": 10})
                    for l_id in cls.invoice.invoice_line_ids.ids
                ]
            }
        )
        ...
        cls.invoice_full_discount = cls.init_invoice(
            "out_invoice", post=False, products=cls.product_a
        )
        cls.invoice_full_discount.write(
            {
                "invoice_line_ids": [
                    (1, l_id, {"discount": 100})
                    for l_id in cls.invoice_full_discount.invoice_line_ids.ids
                ]
            }
        )
        cls.invoice_full_discount.action_post()
        cls.invoice_zero_qty = cls.init_invoice(
            "out_invoice", post=False, products=cls.product_a
        )
        cls.invoice_zero_qty.write(
            {
                "invoice_line_ids": [
                    (1, l_id, {"quantity": 0})
                    for l_id in cls.invoice_zero_qty.invoice_line_ids.ids
                ]
            }
        )
        cls.invoice_zero_qty.action_post()
        cls.invoice_negative_unit_price = cls.init_invoice(
            "out_invoice",
            post=False,
            products=cls.product_a + cls.product_a_discount + cls.product_with_cess,
        )
        cls.invoice_negative_unit_price.write(
            {
                "invoice_line_ids": [
                    (
                        1,
                        cls.invoice_negative_unit_price.invoice_line_ids[0].id,
                        {"price_unit": 1000},
                    ),
                    (
                        1,
                        cls.invoice_negative_unit_price.invoice_line_ids[1].id,
                        {"price_unit": -400},
                    ),
                ]
            }
        ...
        cls.invoice_negative_qty = cls.init_invoice(
            "out_invoice",
            post=False,
            products=cls.product_a + cls.product_a_discount + cls.product_with_cess,
        )
        cls.invoice_negative_qty.write(
            {
                "invoice_line_ids": [
                    (
                        1,
                        cls.invoice_negative_qty.invoice_line_ids[0].id,
                        {"price_unit": 1000},
                    ),
                    (
                        1,
                        cls.invoice_negative_qty.invoice_line_ids[1].id,
                        {"price_unit": 400, "quantity": -1},
                    ),
                ]
            }
        )
        cls.invoice_negative_qty.action_post()
        cls.invoice_negative_unit_price_and_qty = cls.init_invoice(
            "out_invoice",
            post=False,
            products=cls.product_a + cls.product_a_discount + cls.product_with_cess,
        )
        cls.invoice_negative_unit_price_and_qty.write(
            {
                "invoice_line_ids": [
                    (
                        1,
                        cls.invoice_negative_unit_price_and_qty.invoice_line_ids[0].id,
                        {"price_unit": -1000, "quantity": -1},
                    ),
                    (
                        1,
                        cls.invoice_negative_unit_price_and_qty.invoice_line_ids[1].id,
                        {"price_unit": -400},
                    ),
                ]
            }
        ...
        cls.invoice_negative_with_discount = cls.init_invoice(
            "out_invoice", post=False, products=cls.product_a + cls.product_a_discount
        )
        cls.invoice_negative_with_discount.write(
            {
                "invoice_line_ids": [
                    (
                        1,
                        cls.invoice_negative_with_discount.invoice_line_ids[0].id,
                        {"price_unit": 2000, "discount": 50},
                    ),
                    (
                        1,
                        cls.invoice_negative_with_discount.invoice_line_ids[1].id,
                        {"price_unit": -400},
                    ),
                ]
            }
        ...
        cls.invoice_negative_more_than_max_line = cls.init_invoice(
            "out_invoice",
            post=False,
            products=cls.product_a + cls.product_b + cls.product_a_discount,
        )
        cls.invoice_negative_more_than_max_line.write(
            {
                "invoice_line_ids": [
                    (
                        1,
                        cls.invoice_negative_more_than_max_line.invoice_line_ids[0].id,
                        {"price_unit": 2000, "discount": 50},
                    ),
                    (
                        1,
                        cls.invoice_negative_more_than_max_line.invoice_line_ids[1].id,
                        {"price_unit": 1000},
                    ),
                    (
                        1,
                        cls.invoice_negative_more_than_max_line.invoice_line_ids[2].id,
                        {"price_unit": -1100},
                    ),
                ]
            }
        ...
        cls.invoice_cash_rounding = cls.init_invoice(
            "out_invoice", post=False, products=cls.product_a + cls.product_with_cess
        )
        cls.invoice_cash_rounding.write(
            {
                "invoice_line_ids": [
                    (1, l_id, {"discount": 10})
                    for l_id in cls.invoice_cash_rounding.invoice_line_ids.ids
                ],
        ...
        igst_18 = (
            cls.env["account.chart.template"]
        ...
        cls.invoice_with_intra_igst.write(
            {
                "invoice_line_ids": [
                    Command.update(
                        line_id,
                        {"tax_ids": [Command.clear(), Command.set(igst_18.ids)]},
                    )
        ...
        cls.invoice_global_discount = cls.init_invoice(
            "out_invoice", post=False, products=cls.product_a
        )
    ...
    def test_edi_json(self):
        ...
        with self.subTest(scenario="Taxable Invoice"):
            ...
            self.assertDictEqual(
                json_value, expected, "Indian EDI send json value is not matched"
            )
        ...
        with self.subTest(scenario="Full Discount Invoice"):
            ...
            self.assertDictEqual(
                json_value,
                expected,
                "Indian EDI with 100% discount sent json value is not matched",
            )
        ...
        with self.subTest(scenario="Zero Quantity Invoice"):
            ...
            self.assertDictEqual(
                json_value,
                expected,
                "Indian EDI with 0(zero) quantity sent json value is not matched",
            )

        # =================================== Negative unit price test =============================================
        json_value = (
            self.invoice_negative_unit_price._l10n_in_edi_generate_invoice_json()
        )
        with self.subTest(scenario="Negative Unit Price Invoice"):
            ...
            self.assertDictEqual(
                json_value,
                expected,
                "Indian EDI with negative unit price sent json value is not matched",
            )
        ...
        with self.subTest(scenario="Negative quantity Invoice"):
            ...
            self.assertDictEqual(
                json_value,
                expected,
                "Indian EDI with negative quantity sent json value is not matched",
            )

        with self.subTest(scenario="Negative unit price and quantity Invoice"):
            expected.update(
                {"DocDtls": {"Typ": "INV", "No": "INV/18-19/0006", "Dt": "01/01/2019"}}
            )
            json_value = self.invoice_negative_unit_price_and_qty._l10n_in_edi_generate_invoice_json()
            self.assertDictEqual(
                json_value,
                expected,
                "Indian EDI with negative unit price and quantity sent json value is not matched",
            )
        ...
        with self.subTest(scenario="Negative unit price with discount Invoice"):
            ...
            json_value = (
                self.invoice_negative_with_discount._l10n_in_edi_generate_invoice_json()
            )
            self.assertDictEqual(
                json_value,
                expected,
        ...
        with self.subTest(scenario="Negative value more than max line"):
            ...
            self.assertDictEqual(
                json_value,
                expected,
                "Indian EDI with negative value more than max line sent json value is not matched",
            )
        ...
        with self.subTest(scenario="Cash Rounding Invoice"):
            ...
            self.assertDictEqual(
                json_value,
                expected_copy_rounding,
                "Indian EDI with cash rounding sent json value is not matched",
            )

        with self.subTest(scenario="SEZ Intra IGST Invoice"):
            json_value = (
                self.invoice_with_intra_igst._l10n_in_edi_generate_invoice_json()
            )
        ...
        with self.subTest(scenario="RCM Tax Invoice"):
            ...
            self.assertEqual(
                json_value["TranDtls"],
                {"TaxSch": "GST", "SupTyp": "B2B", "RegRev": "Y", "IgstOnIntra": "N"},
        ...
        with self.subTest(scenario="SEZ Tax Invoice"):
            json_value = (
                self.invoice_with_sez_without_lut._l10n_in_edi_generate_invoice_json()
            )
            self.assertEqual(
                json_value["TranDtls"],
                {"TaxSch": "GST", "SupTyp": "SEZWP", "RegRev": "N", "IgstOnIntra": "N"},
        ...
        with self.subTest(scenario="Export LUT Tax Invoice"):
            self.assertEqual(
                self.invoice_with_export_lut._l10n_in_edi_generate_invoice_json(),
                {
                    ...
                    "DocDtls": {"Typ": "INV", "No": False, "Dt": "01/01/2019"},
                    "SellerDtls": {
                        "Addr1": "Khodiyar Chowk",
                        "Loc": "Amreli",
                        "Pin": 365220,
                    ...
                    "ExpDtls": {"RefClm": "N", "ForCur": "INR", "CntCode": "US"},
                },
            )
        ...
        with self.subTest(scenario="Export Tax Invoice"):
            self.assertEqual(
                self.invoice_with_export_without_lut._l10n_in_edi_generate_invoice_json(),
                {
                    ...
                    "ExpDtls": {"RefClm": "Y", "ForCur": "INR", "CntCode": "US"},
                },
            )
