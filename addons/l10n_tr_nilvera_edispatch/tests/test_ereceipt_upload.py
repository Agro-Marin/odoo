...
class TestTRNilveraEreceiptUpload(TestStockCommon):
    ...
    def setUpClass(cls):
        ...
        cls.receipt_partner = cls.PartnerObj.with_context(
    ...
    def test_ereceipt_xml_without_errors_upload(self):
        with file_open(
            "l10n_tr_nilvera_edispatch/tests/test_files/test_ereceipt.xml", "rb"
        ) as f:
        ...
        picking, files_with_errors = self.env[
            "stock.picking"
        ]._l10n_tr_create_receipts_from_attachment(ereceipt_xml)
