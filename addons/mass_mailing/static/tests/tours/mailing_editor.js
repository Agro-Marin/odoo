...
registry.category("web_tour.tours").add("mailing_editor", {
    ...
    steps: () => [
        ...
        {
            trigger:
                'div[name="contact_list_ids"] .o_input_dropdown input[type="text"]',
            run: "edit Test",
        },
        {
        ...
        },
        {
            ...
            trigger:
                '[name="body_arch"] .o_mailing_template_preview_wrapper [data-name="empty"]',
            run: "click",
        },
        {
            content: "wait for the editor to be rendered",
            trigger:
                '[name="body_arch"] :iframe .o_editable[data-editor-message="DRAG BUILDING BLOCKS HERE"]',
        },
        {
            trigger: '.o_snippet[name="Text"] button',
            content:
                'Click the "Text" snippet category to drop a snippet in the editor',
            run: "click",
        },
        {
        ...
        {
            content:
                'verify that the save failed (since the field "subject" was not set and it is required)',
            trigger: "label.o_field_invalid",
        },
        {
            content:
                "verify that the edited mailing body was not lost during the failed save",
            trigger: '[name="body_arch"] :iframe .o_editable h1',
        },
        {
