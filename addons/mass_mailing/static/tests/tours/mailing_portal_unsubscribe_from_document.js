    ...
    steps: () => [
        {
            ...
            trigger:
                "div#o_mailing_subscription_info span:contains('You are no longer part of our services and will not be contacted again.')",
            run: "click",
        },
        {
            content: "No warning should be displayed",
            trigger:
                "div#o_mailing_subscription_form_blocklisted:not(:has(p:contains('You will not receive any news from those mailing lists you are a member of')))",
            run: "click",
        },
        {
            content: "Warning will not receive anything anymore",
            trigger:
                "div#o_mailing_subscription_form_blocklisted p:contains('You will not hear from us anymore.')",
            run: "click",
        },
        {
...
registry
    ...
    .add("mailing_portal_unsubscribe_from_document_with_lists", {
        steps: () => [
            {
                content: "Confirmation unsubscribe is done",
                trigger:
            ...
            },
            {
                ...
                trigger:
                    "div#o_mailing_subscription_form_blocklisted li strong:contains('List1')",
                run: "click",
            },
            {
                content: "Feedback textarea not displayed (see data)",
