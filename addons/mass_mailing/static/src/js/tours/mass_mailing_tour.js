...
registry.category("web_tour.tours").add("mass_mailing_tour", {
    ...
    steps: () => [
        ...
        },
        {
            isActive: ["enterprise"],
            trigger:
                'div[name="body_arch"] .o_mailing_template_preview_wrapper [data-name="newsletter"]',
        ...
        },
        {
            isActive: ["community"],
            trigger:
                'div[name="body_arch"] .o_mailing_template_preview_wrapper [data-name="default"]',
            content: markup(_t("Choose this <b>theme</b>.")),
        ...
        },
        {
            isActive: ["enterprise"],
            trigger:
                'div[name="body_arch"] :iframe div.theme_selection_done div.s_text_block',
        ...
        },
        {
            ...
            content: _t(
                "Don't worry, the mailing contact we created is an internal user.",
            ),
            tooltipPosition: "bottom",
            run: "click",
        },
        {
            ...
            content: markup(
                _t(
                    "By using the <b>Breadcrumb</b>, you can navigate back to the overview.",
                ),
            ),
            tooltipPosition: "bottom",
            run: "click",
