...
class TestMailingABTesting(TestMailingABTestingCommon):
    ...
    def test_mailing_ab_testing_auto_flow(self):
        ...
        unique_recipients_used = {mail.res_id for mail in total_trace_ids.mail_mail_id}
    ...
    def test_mailing_ab_testing_campaign(self):
        ...
        self.assertTrue(
            ab_mailing.campaign_id, "A campaign id is present for the A/B test mailing"
        )
        self.assertEqual(
            ab_mailing.ab_testing_winner_selection,
            "manual",
            "The selection winner has been propagated correctly",
        )
        self.assertEqual(
            ab_mailing.ab_testing_schedule_datetime,
            schedule_datetime,
        ...
        self.assertEqual(
            ab_mailing.campaign_id,
            created_mailing_campaign,
        ...
        ab_mailing.write(
            {"ab_testing_enabled": True, "campaign_id": created_mailing_campaign}
        )
        self.assertEqual(
            ab_mailing.campaign_id,
            created_mailing_campaign,
        ...
        self.assertTrue(
            ab_mailing.ab_testing_winner_selection,
            "The selection winner has been set to default value",
        )
        self.assertTrue(
            ab_mailing.ab_testing_schedule_datetime,
            "The schedule date has been set to default value",
        )
    ...
    def test_mailing_ab_testing_duplicate_date(self):
        ...
        ab_testing_mail_1.ab_testing_schedule_datetime = datetime.now() + timedelta(
            days=10
        )
        ...
        self.assertEqual(
            fields.Datetime.to_string(
                ab_testing_mailing_2.ab_testing_schedule_datetime
            ),
