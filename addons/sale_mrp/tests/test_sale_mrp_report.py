...
class TestSaleMrpInvoices(TestSaleCommon):
    ...
    def setUpClass(cls):
        ...
        cls.env["stock.quant"]._update_available_quantity(
            cls.product_by_lot, cls.stock_location, 10, lot_id=cls.lot
        )
    ...
    def test_report_forecast_for_mto_procure_method(self):
        ...
        report_lines = (
            ...
            .get_report_values(docids=product.ids)["docs"]["lines"]
        )
        ...
        self.assertEqual(
            [
                so_1_line["quantity"],
                so_1_line["move_out"]["id"],
                so_1_line["replenishment_filled"],
            ],
        ...
        self.assertEqual(
            [
                so_2_line["quantity"],
                so_2_line["move_out"]["id"],
                so_2_line["replenishment_filled"],
            ],
        ...
        self.assertEqual(
            [
                replenisment_line["document_in"],
                replenisment_line["document_out"],
                replenisment_line["quantity"],
                replenisment_line["move_out"],
                replenisment_line["replenishment_filled"],
            ],
