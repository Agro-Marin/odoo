            ...
            if order_line.qty_transferred_method == 'stock_move':
                ...
                if relevant_bom:
                    ...
                    if dropship:
                        ...
                        if any((m.location_dest_id.usage == 'customer' and m.state != 'done')
                            ...
                            order_line.qty_transferred = order_line.product_uom_qty
                        continue
                    ...
                    order_line.qty_transferred += relevant_bom.product_uom_id._compute_quantity(qty_transferred, order_line.product_uom_id)
                ...
                # do not correspond to the product sold => no relevant BOM.
                    ...
                    if all(m.state == 'done' and m.location_dest_id.usage == 'customer' for m in order_line.move_ids):
                        ...
                        order_line.qty_transferred = 0.0
