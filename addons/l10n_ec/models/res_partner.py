...
class ResPartner(models.Model):
    ...
    def _run_check_identification(self, validation="error"):
        ...
        if l10n_ec_partners and validation == "error":
            ...
            for partner in l10n_ec_partners.filtered(
                lambda p: p.l10n_latam_identification_type_id == it_dni
            ):
        ...
        return super(ResPartner, self - l10n_ec_partners)._run_check_identification(
