...
class TestSelfOrderCombo(SelfOrderCommonTest):
    def test_self_order_combo(self):
        ...
        self.assertEqual(
            parent_line_id.qty,
            combo_line_ids[0].qty,
            "The quantities should match with the parent",
        )
    ...
    def test_product_dont_display_all_variants(self):
        ...
        coke_template_never_always, coke_template_always, coke_template_never = (
                            ...
                            Command.create(
                                {
                                    ...
                                    "value_ids": [
                                        Command.set(
                                            [
                                                attribute_values[0].id,
                                                attribute_values[1].id,
                                            ]
                                        )
                                    ],
                                }
                            ...
                            Command.create(
                                {
                                    ...
                                    "value_ids": [
                                        Command.set(
                                            [
                                                attribute_values[2].id,
                                                attribute_values[3].id,
                                            ]
                                        )
                                    ],
                                }
