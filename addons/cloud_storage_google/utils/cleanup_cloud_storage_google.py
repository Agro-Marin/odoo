...
credentials = service_account.Credentials.from_service_account_info(
    google_cloud_account_info
).with_scopes(["https://www.googleapis.com/auth/devstorage.full_control"])
...
def get_blobs_to_be_deleted(blob_urls, batch_size=1000):
    ...
    for blob_urls_ in batched(blob_urls, batch_size):
        ...
        attachments = models.execute_kw(
            ...
            "ir.attachment",
            "search_read",
            [[("type", "=", "cloud_storage"), ("url", "in", blob_urls_)], ["url"]],
        )
