...
class TestDocumentsMulticompany(TransactionCaseDocuments):
        ...
        cls.admin_user = cls.env["res.users"].create(
            {
                ...
                "group_ids": [
                    Command.link(cls.env.ref("documents.group_documents_system").id)
                ],
                "login": "an_admin",
                "name": "An Admin",
            }
    ...
    def test_company_access_inherit(self):
        ...
        self.assertTrue(
            self.env["documents.document"].search([("id", "=", document.id)])
        )
    ...
    def test_folder_company_inheritance(self):
        ...
        self.assertFalse(
            self.env["documents.document"].create(folder_a_child_vals).company_id
        )
    ...
    def test_folder_move_company_propagation(self):
        ...
        document_without_company = self.env["documents.document"].create(
            {"name": "doc"}
        )
