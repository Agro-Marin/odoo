...
class TestDocumentsUserFolder(TransactionCaseDocuments):
    ...
    def setUpClass(cls):
        ...
        cls.env["documents.document"].search(
    ...
    def test_search_user_folder_id_in_and_not_in(self):
        ...
        actual = self.env["documents.document"].search(
        ...
        actual_company = self.env["documents.document"].search(
        ...
        actual_not_company = self.env["documents.document"].search(
        ...
        actual_shared = self.env["documents.document"].search(
        ...
        actual_not_shared = self.env["documents.document"].search(
        ...
        actual_folder_a = self.env["documents.document"].search(
        ...
        actual_not_folder_a = self.env["documents.document"].search(
