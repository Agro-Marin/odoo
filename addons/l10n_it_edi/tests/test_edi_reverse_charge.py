...
class TestItEdiReverseCharge(TestItEdi):
                        ...
                        Command.create(
                            {
                                ...
                                "tax_ids": [
                                    Command.set(
                                        self.purchase_tax_4p_already_in_italy.ids
                                    )
                                ],
                            }
                        ),
    ...
    def test_receive_bill_reverse_charge_internal(self):
        ...
        for line in invoice.invoice_line_ids:
            ...
            self.assertTrue(
                "vj12" in rc_tax.invoice_repartition_line_ids[0].tag_ids.mapped("name")
            )
