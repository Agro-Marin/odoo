...
class TestSurveyController(common.TestSurveyCommon, HttpCase):
    def test_submit_route_scoring_after_page(self):
            ...
            [
                {
                    ...
                    "suggested_answer_ids": [
                        Command.set((a_q1_partial | a_q1_correct | a_q1_incorrect).ids)
                    ],
                ...
                },
                {
                    ...
                    "question_type": "simple_choice",
                    "suggested_answer_ids": [
                        Command.set((a_q2_incorrect | a_q2_correct).ids)
                    ],
                    "triggering_answer_ids": [
                        Command.set((a_q1_partial | a_q1_incorrect).ids)
                    ],
                    "constr_mandatory": False,
                },
                {
                    ...
                    "question_type": "simple_choice",
                    "suggested_answer_ids": [
                        Command.set((a_q3_correct | a_q3_incorrect).ids)
                    ],
        ...
        cases = [
            ...
            (
                "one_page",
                a_q1_correct,
                {**q1_correct_answer, str(q3.id): [a_q3_correct.id]},
            ),
            (
                "one_page",
                a_q1_partial,
        ...
        for case_index, (layout, answer_q1, expected_correct_answers) in enumerate(
            cases
        ):
    ...
    def test_live_session_without_question(self):
            ...
            .create(
                {
                    ...
                    "session_question_start_time": datetime.datetime(
                        2023, 7, 7, 12, 0, 0
                    ),
                }
            )
        ...
        self.assertEqual(
            response.status_code, 200, "Should be able to open live session manage page"
        )
