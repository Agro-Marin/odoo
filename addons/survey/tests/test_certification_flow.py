    ...
    def test_flow_certification(self):
        ...
        with self.with_user("survey_user"):
            ...
            q01 = self._add_question(
                None,
                "When do you know it's the right time to use the SO line model?",
                "simple_choice",
                sequence=1,
            ...
            q02 = self._add_question(
                None,
                "On average, how many lines of code do you need when you use SO line widgets?",
                "simple_choice",
                sequence=2,
                constr_mandatory=True,
                constr_error_msg="Please select an answer",
            ...
            q03 = self._add_question(
                None,
                "What do you think about SO line widgets (not rated)?",
                "text_box",
                sequence=3,
                constr_mandatory=True,
                constr_error_msg="Please tell us what you think",
                survey_id=certification.id,
            )

            q04 = self._add_question(
                None,
                "On a scale of 1 to 10, how much do you like SO line widgets (not rated)?",
                "simple_choice",
                sequence=4,
                constr_mandatory=True,
                constr_error_msg="Please tell us what you think",
                survey_id=certification.id,
                labels=[{"value": "-1"}, {"value": "0"}, {"value": "100"}],
            )

            q05 = self._add_question(
                None,
                'Select all the correct "types" of SO lines',
                "multiple_choice",
                sequence=5,
                ...
                labels=[
                    ...
                    {
                        "value": "a_future_and_yet_unknown_model",
                        "is_correct": True,
                        "answer_score": 1.0,
                    },
            ...
            q06 = self._add_question(
                None,
                "Are you sure of all your answers (not rated)",
                "simple_choice",
                sequence=6,
                constr_mandatory=False,
                survey_id=certification.id,
        ...
        with self.mock_mail_gateway():
            self._answer_question(
                q01, q01.suggested_answer_ids.ids[3], answer_token, csrf_token
            )
            self._answer_question(
            ...
            self._answer_question(
                q04,
                q04.suggested_answer_ids.ids[0],
                answer_token,
                csrf_token,
                button_submit="previous",
            )
            self._answer_question(
                q03, "Just kidding, I don't like it...", answer_token, csrf_token
            )
            self._answer_question(
                q04,
                q04.suggested_answer_ids.ids[0],
                answer_token,
                csrf_token,
                submit_query_count=43,
                access_page_query_count=24,
            )
            q05_answers = q05.suggested_answer_ids.ids[0:2] + [
                q05.suggested_answer_ids.ids[3]
            ]
            self._answer_question(
                q05,
                q05_answers,
                answer_token,
                csrf_token,
                submit_query_count=28,
                access_page_query_count=24,
            )
            self._answer_question(
                q06,
                q06.suggested_answer_ids.ids[0],
                answer_token,
                csrf_token,
                submit_query_count=108,
                access_page_query_count=24,
            )
