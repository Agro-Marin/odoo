...
class TestUiFeedback(HttpCaseWithUserDemo):
                ...
                "question_and_page_ids": [
                    ...
                    (
                        ...
                        0,
                        {
                            ...
                            "constr_mandatory": True,
                            "suggested_answer_ids": [
                                (0, 0, {"value": "Totally disagree", "sequence": 1}),
                                (
                                    0,
                                    0,
                                    {
    ...
    def test_01_admin_survey_tour(self):
        ...
        self.start_tour(f"/survey/start/{access_token}", "test_survey", login="admin")
    ...
    def test_03_public_multilingual_survey_tour(self):
        ...
        self.survey_feedback.lang_ids = self.env["res.lang"].search(
            [("code", "in", ["fr_BE", "en_US"])]
        )
    ...
    def test_04_public_survey_with_triggers(self):
        ...
        self.start_tour(
            f"/survey/start/{access_token}",
            "test_survey_chained_conditional_questions",
        )
    ...
    def test_05_public_survey_with_trigger_on_different_page(self):
        ...
        q1 = survey_with_trigger_on_different_page.question_ids.filtered(
            lambda q: q.title == "Q1"
        )
        q1_a1 = q1.suggested_answer_ids.filtered(lambda a: a.value == "Answer 1")

        q2 = survey_with_trigger_on_different_page.question_ids.filtered(
            lambda q: q.title == "Q2"
        )
        q2_a1 = q2.suggested_answer_ids.filtered(lambda a: a.value == "Answer 1")

        q3 = survey_with_trigger_on_different_page.question_ids.filtered(
            lambda q: q.title == "Q3"
        )
        ...
        self.start_tour(
            f"/survey/start/{access_token}",
            "test_survey_conditional_question_on_different_page",
        )

    def test_06_survey_prefill(self):
        access_token = self.survey_feedback.access_token
        self.start_tour(f"/survey/start/{access_token}", "test_survey_prefill")
    ...
    def test_07_survey_roaming_mandatory_questions(self):
        ...
        self.start_tour(
            f"/survey/start/{access_token}", "test_survey_roaming_mandatory_questions"
        )
