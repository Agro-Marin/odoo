...
registry.category("web_tour.tours").add("test_survey_chained_conditional_questions", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger:
                'div.js_question-wrapper:contains("Q1") label:contains("Answer 1")',
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger:
                'div.js_question-wrapper:contains("Q2") label:contains("Answer 1")',
            run: "click",
        },
        {
            content: "Answer Q3 with Answer 1",
            trigger:
                'div.js_question-wrapper:contains("Q3") label:contains("Answer 1")',
            run: "click",
        },
        {
            content: "Answer Q1 with Answer 3", // This should hide Q2 and Q4 but not Q3.
            trigger:
                'div.js_question-wrapper:contains("Q1") label:contains("Answer 3")',
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger:
                'div.js_question-wrapper:contains("Q3") label:contains("Answer 2")',
            run: "click",
        },
        {
            content: "Answer Q1 with Answer 2", // This should hide all other questions.
            trigger:
                'div.js_question-wrapper:contains("Q1") label:contains("Answer 2")',
            run: "click",
        },
        {
...
export function expectHiddenQuestion(questionTitle, msg) {
    ...
    const matchingDivs = Array.from(divs).filter((div) =>
        div.textContent.includes(questionTitle),
    );
