...
registry.category("web_tour.tours").add("survey_tour_test_survey_form_triggers", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger:
                "div[name=question_and_page_ids] table tr:eq(3) div[name=sequence]",
        ...
        {
            content:
                "Open that question to check the server's misplacement evaluation agrees",
        ...
        ...changeTab("options"),
        {
            ...
            trigger:
                ".modal .o_field_widget[name=triggering_answer_ids] span:contains('Question 2') a.o_delete",
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger:
                "div[name=question_and_page_ids] table tr:eq(2) div[name=sequence]",
        ...
        {
            trigger:
                ".modal .modal-content .o_field_widget[name=triggering_answer_ids] input",
            run() {
        ...
        },
        {
            ...
            trigger:
                '.modal-content ul.ui-autocomplete a:contains("Question 2 : Answer B")',
            run: "click",
        },
        {
        ...
        // Move question 1 below question 3,
        {
            ...
            trigger:
                "div[name=question_and_page_ids] table tr:eq(1) div[name=sequence]",
            run: "drag_and_drop(div[name=question_and_page_ids] table tr:eq(4))",
        },
        {
            content: "Check that Question 3 has 'warning' trigger icon",
        ...
        ...changeTab("options"),
        {
            ...
            trigger:
                ".modal .o_field_widget[name=triggering_answer_ids] span:contains('Question 1') a.o_delete",
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger:
                "div[name=suggested_answer_ids] tr:contains('Answer B') button[name=delete]",
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger:
                "div[name=question_and_page_ids] tr:contains('Question 3') div.o_widget_survey_question_trigger:not(:has(button)):not(:visible)",
        },
        {
        ...
        },
        {
            ...
            trigger:
                "tr:contains('Question 2') div.o_widget_survey_question_trigger:not(:has(button)):not(:visible)",
        },
        {
...
function addTwoAnswers() {
    return [
        ...
        {
            trigger: ".modal tr:nth-child(2).o_selected_row div[name=value] input",
            run: "edit Answer B",
        },
    ];
}
