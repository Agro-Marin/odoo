...
registry
    ...
    .add("test_survey_conditional_question_on_different_page", {
        ...
        steps: () => [
            ...
            },
            {
                ...
                trigger:
                    'div.js_question-wrapper:contains("Q2") label:contains("Answer 2")',
                run: "click",
            },
            {
            ...
            },
            {
                ...
                run: () =>
                    expectHiddenQuestion(
                        "Q3",
                        "Q3 should be hidden as q1_a1 trigger is not selected anymore",
                    ),
            },
            {
