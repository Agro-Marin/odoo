...
class SurveySurvey(models.Model):
        ...
        return {
            ...
            "question_and_page_ids": [
                ...
                (
                    ...
                    {  # survey.question
                        "title": _(
                            "How many orders did you pass during the last 6 months?"
                        ),
    ...
    def _prepare_assessment_template_values(self) -> dict[str, Any]:
        survey_values = {
            ...
            "description": "".join(
                [
                    _(
                        "Welcome to this Odoo certification. You will receive 2 random questions out of a pool of 3."
                    ),
                    ...
                    {  # survey.question
                        ...
                        "suggested_answer_ids": [
                            ...
                            (
                                ...
                                {  # survey.question.answer
                                    "value": _(
                                        "One needs to get 50% of the total score"
                                    )
                                },
                            ),
                            (
        ...
        if mail_template:
            survey_values.update({"certification_mail_template_id": mail_template.id})
    ...
    def _prepare_live_session_template_values(self) -> dict[str, Any]:
        return {
            ...
            "description_done": _(
                "Thank you for your participation, hope you had a blast!"
            ),
            "progression_mode": "number",
