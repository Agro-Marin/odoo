...
class PosSession(models.Model):
    ...
    def _create_bank_payment_moves(self, data):
        ...
        for payment, amounts in split_receivables_online.items():
            ...
            payment_receivable_line = account_payment.move_id.line_ids.filtered(lambda line, account_payment=account_payment: line.account_id == account_payment.destination_account_id)
