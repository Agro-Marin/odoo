...
class PosSession(models.Model):
            ...
            for payment in order.payment_ids:
                ...
                if payment_type == "online":
                    split_receivables_online[payment] = self._update_amounts(
                        split_receivables_online[payment], {"amount": amount}, date
                    )
    ...
    def _get_split_receivable_op_vals(self, payment, amount, amount_converted):
        ...
        partial_vals = {
            ...
            % (
                ...
                payment.online_account_payment_id.payment_channel_id.payment_provider_id.name,
            ),
        }
    ...
    def _reconcile_account_move_lines(self, data):
        ...
        online_payment_to_receivable_lines = data.get(
            "online_payment_to_receivable_lines"
        )
