...
class AccountMoveSendWizard(models.TransientModel):
    ...
    def _compute_sending_method_checkboxes(self):
        ...
        for wizard in self:
            ...
            nemhandel_partner = (
                wizard.move_id.partner_id.commercial_partner_id.with_company(
                    wizard.company_id
                )
            )
            ...
            vals_not_valid = (
                {"readonly": True, "checked": False} if addendum_disable_reason else {}
            )
            addendum_mode = ""
    ...
    def action_send_and_print(self, allow_fallback_pdf=False):
        ...
        if self.sending_methods and "nemhandel" in self.sending_methods:
            ...
            if (
                move.partner_id.commercial_partner_id.nemhandel_verification_state
                != "valid"
            ):
                raise UserError(
