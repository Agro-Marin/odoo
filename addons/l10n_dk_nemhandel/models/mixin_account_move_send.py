...
class MixinAccountMoveSend(models.AbstractModel):
    ...
    def _hook_if_errors(self, moves_data, allow_raising=True):
        ...
        for move, move_data in moves_data.items():
            if "nemhandel" in move_data["sending_methods"] and move_data.get(
                "blocking_error"
            ):
    ...
    def _call_web_service_after_invoice_pdf_render(self, invoices_data):
        ...
        for invoice, invoice_data in invoices_data.items():
            ...
            if (
                not partner.nemhandel_identifier_type
            ...
            if (
                partner._get_nemhandel_verification_state(
            ...
            elif invoice.ubl_cii_xml_id and invoice.nemhandel_move_state not in {
                "processing",
                "done",
            }:
        ...
        try:
            ...
            if response.get("error"):
                ...
                invoices._message_log_batch(
                    bodies={invoice.id: log_message for invoice in invoices}
                )
                self.env.ref(
