...
class OnboardingOnboardingStep(models.Model):
    ...
    def action_set_just_done(self):
        ...
        steps_without_progress = self.filtered(
            lambda step: not step.current_progress_step_id
        )
        ...
        progress_step_values = [
            {
                ...
                "progress_ids": [
                    ...
                    for onboarding_progress_record in onboarding_progress_records.filtered(
                        lambda p, step_id=step_id: step_id in p.onboarding_id.step_ids
                    )
                ],
