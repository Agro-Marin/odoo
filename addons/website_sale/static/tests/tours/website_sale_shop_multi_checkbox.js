...
registry.category("web_tour.tours").add("tour_shop_multi_checkbox", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger:
                'input[data-value-name="Option 3"].css_not_available:not([disabled])',
        },
        {
        ...
        tourUtils.goToCart(),
        {
            ...
            trigger:
                '#cart_products div div.text-muted>span:contains("Options: Option 1, Option 2")',
        },
    ],
});
...
registry.category("web_tour.tours").add("tour_shop_multi_checkbox_single_value", {
    ...
    steps: () => [
        ...
        tourUtils.goToCart(),
        {
            ...
            trigger:
                '#cart_products div div.text-muted>span:contains("Toppings: cheese")',
        },
    ],
});
