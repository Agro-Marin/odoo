...
registry.category("web_tour.tours").add("website_sale_tour_1", {
    ...
    steps: () => [
        ...
        {
            content:
                "Check selected delivery address is same as typed in previous step",
            trigger:
        ...
        {
            content:
                "Configuration Settings for 'Tax Included' and sign up 'On Invitation'",
            trigger: "#wrapwrap",
            run: function () {
        ...
        },
        {
            ...
            trigger:
                '#delivery_address_list a[href^="/shop/address"]:contains("Add address")',
            run: "click",
            expectUnloadPage: true,
        },
        {
