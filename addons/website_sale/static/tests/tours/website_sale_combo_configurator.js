...
registry.category("web_tour.tours").add("website_sale_combo_configurator", {
    ...
    steps: () => [
        ...
        comboConfiguratorTourUtils.assertFooterButtonsEnabled(),
        {
            ...
            trigger:
                ".js_main_product small:contains(Final price may vary based on selection)",
        },
        ...
        ...wsTourUtils.assertCartContains({ productName: "3 x Product B2" }),
        {
            ...
            trigger:
                'div.o_cart_product:contains("No variant attribute: B: Some custom value")',
        },
        {
            content: "Verify the combo product's quantity",
            trigger:
                'div[name="website_sale_cart_line_quantity"] input.quantity:value(3)',
        },
        {
