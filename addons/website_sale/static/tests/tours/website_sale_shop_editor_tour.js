...
registerWebsitePreviewTour(
    "shop_editor_set_product_ribbon",
    {
        url: "/shop",
        edition: true,
    },
    ...
    () => [
        {
            ...
            trigger:
                ':iframe .oe_product_cart[aria-label="product_with_alternative"] a',
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger:
                ':iframe .oe_product_cart[aria-label="product_without_alternative"] a',
            run: "click",
        },
        {
