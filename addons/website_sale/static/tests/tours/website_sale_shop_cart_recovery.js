    ...
    steps: () => [
        ...
        },
        {
            ...
            run() {
                ...
                const url = "/odoo/action-sale.action_sale_order/" + orderId;
        ...
        },
        {
            ...
            trigger:
                ".modal main .o_form_view_container [name=subject] input:value(/^S0/)",
        },
        {
        ...
        },
        {
            ...
            run({ queryOne }) {
                var link = queryOne(
                    '.o-mail-Message-body a:contains("Resume order")',
                ).getAttribute("href");
