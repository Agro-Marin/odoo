    ...
    steps: () => [
        ...
        },
        {
            ...
            run: function () {
                ...
                assert(
                    isVisuallyHidden(buttons[0]),
                    true,
                    "first radio input is not hidden",
                );
                assert(
                    isVisuallyHidden(buttons[1]),
                    true,
                    "second radio input is not hidden",
                );
            ...
            run: function () {
                var button = [
                    ...document.querySelectorAll(
                        'input.js_variant_change[data-attribute-name="Size"][data-value-name="Small"]',
                    ),
                ];
