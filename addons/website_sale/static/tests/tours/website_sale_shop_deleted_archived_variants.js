...
registry.category("web_tour.tours").add("tour_shop_deleted_archived_variants", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger:
                'input[data-attribute-name="My Attribute"][data-value-name="My Value 2"]',
            run: "click",
        },
        {
            content: "click on the 3rd variant to reset the warning",
            trigger:
                'input[data-attribute-name="My Attribute"][data-value-name="My Value 3"]',
            run: "click",
        },
        {
            content: "check price (3rd variant)",
        ...
        },
        {
            ...
            trigger:
                'input[data-attribute-name="My Attribute"][data-value-name="My Value 1"]',
            run: "click",
        },
        {
