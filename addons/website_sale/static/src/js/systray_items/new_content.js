...
patch(NewContentSystrayItem.prototype, {
    setup() {
        ...
        const newProductElement = this.state.newContentElements.find(
            (element) => element.moduleXmlId === "base.module_website_sale",
        );
        newProductElement.createNewContent = () =>
            this.onAddContent("website_sale.product_product_action_add", true);
