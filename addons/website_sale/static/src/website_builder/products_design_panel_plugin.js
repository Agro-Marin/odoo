...
export class ProductsDesignPanelPlugin extends Plugin {
    ...
    resources = {
        ...
        product_design_list_to_save: {
            ...
            getData(el) {
                ...
                const gapToSave = el.style.getPropertyValue(
                    "--o-wsale-products-grid-gap",
                );
    ...
    setup() {
        ...
        this.savableSelector = this.productDesignListToSave
    ...
    handleMutations(records, currentOperation) {
        ...
        for (const record of records) {
            ...
            if (
                !isSavable ||
                targetEl.classList.contains("o_dirty_product_design_list")
            ) {
                continue;
            }
...
class ClassActionWithSuggestedAction extends BuilderAction {
    ...
    setup() {
        ...
        this.setClassRangeAction =
            this.dependencies.builderActions.getAction("setClassRange");
    }
...
registry
    ...
    .add(ProductsDesignPanelPlugin.id, ProductsDesignPanelPlugin);
