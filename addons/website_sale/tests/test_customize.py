...
class TestCustomize(
                    ...
                    Command.create(
                        {
                            ...
                            "value_ids": [
                                Command.set(product_attribute_no_variant.value_ids.ids)
                            ],
                        }
                    )
                ],
    ...
    def test_12_multi_checkbox_attribute_single_value(self):
        ...
        self.start_tour(
            "/", "tour_shop_multi_checkbox_single_value", login="website_user"
        )
    ...
    def test_shop_editor_no_alternative_products_visibility(self):
        ...
        self.start_tour(
            "/", "shop_editor_no_alternative_products_visibility_tour", login="admin"
        )
