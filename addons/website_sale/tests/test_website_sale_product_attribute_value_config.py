...
class TestWebsiteSaleProductAttributeValueConfig(
    AccountTestInvoicingCommon, TestProductAttributeValueCommon
):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_get_combination_info(self):
        ...
        with MockRequest(
            ...
            self.assertEqual(
                combination_info["price"], 2222 * discount_rate * currency_ratio
            )
            ...
            self.assertEqual(
                ...
                2222 * discount_rate * currency_ratio * tax_ratio,
            )
    ...
    def test_get_combination_info_with_fpos(self):
        ...
        with MockRequest(product.env, website=website):
            combination_info = product._get_combination_info()
        self.assertEqual(
            combination_info["price"], 500, "500% + 0% tax (mapped from fp 15% -> 0%)"
        )
        self.assertEqual(
