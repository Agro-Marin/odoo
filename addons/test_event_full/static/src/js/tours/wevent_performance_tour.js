...
var registerSteps = [
    ...
    {
        content:
            "Choose the 'Q1-Answer2' answer of the 'Question1' for the first ticket",
        trigger: 'select[name*="1-simple_choice"]',
        run: "selectByIndex 2",
    },
    {
        content:
            "Choose the 'Q2-Answer1' answer of the 'Question2' for the first ticket",
        trigger: 'select[name*="1-simple_choice"]:last',
        run: "selectByIndex 1",
    },
    {
        content:
            "Choose the 'Q1-Answer1' answer of the 'Question1' for the second ticket",
        trigger: 'select[name*="2-simple_choice"]',
        run: "selectByIndex 1",
    },
    {
        content:
            "Choose the 'Q2-Answer2' answer of the 'Question2' for the second ticket",
        trigger: 'select[name*="2-simple_choice"]:last',
        run: "selectByIndex 2",
    },
    {
        content:
            "Choose the 'Q1-Answer2' answer of the 'Question1' for the third ticket",
        trigger: 'select[name*="3-simple_choice"]',
        run: "selectByIndex 2",
    },
    {
        content:
            "Choose the 'Q2-Answer2' answer of the 'Question2' for the third ticket",
