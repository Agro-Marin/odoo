...
class TestWEventMenu(TestWEventCommon):
    ...
    def test_seo_data(self):
        ...
        self.assertFalse(
            self.event.website_meta_title, "Event should initially have no meta title"
        )
        self.event.write(
            {
        ...
        self.assertTrue(
            self.event.website_meta_title,
            "Event should have a meta title after writing",
        )
        ...
        for menu_field, menu_name in menus:
            ...
            self.assertFalse(
                menu.website_meta_title,
                f"{menu_name} page should initially have no meta title",
            )
            ...
            self.assertTrue(
                menu.website_meta_title,
                f"{menu_name} page should have a meta title after writing",
            )
