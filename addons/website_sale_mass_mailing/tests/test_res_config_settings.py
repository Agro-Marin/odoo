...
class TestResConfigSettings(TransactionCase):
    ...
    def test_newsletter_enabled_per_website(self):
        ...
        site_one_newsletter_view = self._get_newsletter_view_for_website(
            self.site_one_settings, self.site_one
        )
        self.assertTrue(
            site_one_newsletter_view.active,
            "Newsletter view should be active for Site One",
        )
        ...
        site_two_newsletter_view = self._get_newsletter_view_for_website(
            self.site_two_settings, self.site_two
        )
        self.assertTrue(
            site_two_newsletter_view.active,
            "Newsletter view should be active for Site Two",
        )
