...
class AccountMove(models.Model):
    ...
    def button_create_landed_costs(self):
        ...
        return dict(
            action, view_mode="form", res_id=landed_costs.id, views=[(False, "form")]
        )
    ...
    def action_view_landed_costs(self):
        ...
        views = (
            [(False, "form")]
            if len(self.landed_costs_ids) == 1
            else [
                (
                    self.env.ref("stock_landed_costs.view_stock_landed_cost_tree2").id,
                    "list",
                ),
                (False, "form"),
                (False, "kanban"),
