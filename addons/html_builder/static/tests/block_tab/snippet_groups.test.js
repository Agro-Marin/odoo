...
test("search snippet by label", async () => {
    const snippets = [
        { name: "foo_bar", groupName: "a", innerHTML: "content 1", label: "" },
        { name: "foo", groupName: "a", innerHTML: "content 2", label: "Hello World" },
        { name: "bar", groupName: "a", innerHTML: "content 3", label: "Goodbye World" },
    ];
    ...
    // A label only one snippet carries.
    ...
    // A word both labels share, and which no name or class carries.
