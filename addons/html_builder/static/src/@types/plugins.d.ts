declare module "plugins" {
    ...
    import {
        builder_components,
        BuilderComponentShared,
    } from "@html_builder/core/builder_component_plugin";
    import {
        builder_header_middle_buttons,
        builder_options,
        BuilderOptionsShared,
    ...
    } from "@html_builder/core/clone_plugin";
    ...
    } from "@html_builder/core/drop_zone_plugin";
    ...
    import {
        get_overlay_buttons,
        OverlayButtonsShared,
    } from "@html_builder/core/overlay_buttons/overlay_buttons_plugin";
    import {
        empty_node_predicates,
        is_unremovable_selector,
        on_removed_handlers,
        on_will_remove_handlers,
        RemoveShared,
    } from "@html_builder/core/remove_plugin";
    import {
        after_save_handlers,
        ...
        save_handlers,
        SaveShared,
    } from "@html_builder/core/save_plugin";
    import {
        after_setup_editor_handlers,
        before_setup_editor_handlers,
        o_editable_selectors,
        SetupEditorShared,
    } from "@html_builder/core/setup_editor_plugin";
    import {
        target_hide,
        target_show,
        VisibilityShared,
    } from "@html_builder/core/visibility_plugin";
    import {
        default_shape_handlers,
        image_shape_groups_providers,
        post_compute_shape_listeners,
    } from "@html_builder/plugins/image/image_shape_option_plugin";
    import {
        background_filter_target_providers,
        get_target_element_providers,
        on_bg_image_hide_handlers,
    } from "@html_builder/plugins/background_option/background_image_option_plugin";
    import {
        is_draggable_handlers,
        on_element_dragged_handlers,
        on_element_dropped_handlers,
        on_element_dropped_near_handlers,
        on_element_dropped_over_handlers,
        on_element_move_handlers,
        on_element_out_dropzone_handlers,
        on_element_over_dropzone_handlers,
        on_prepare_drag_handlers,
    } from "@html_builder/core/drag_and_drop_plugin";
    import {
        lower_panel_entries,
        on_mobile_preview_clicked,
        trigger_dom_updated,
    } from "@html_builder/builder";
    import { on_reveal_target_handlers } from "@html_builder/sidebar/invisible_elements_panel";
    import {
        on_snippet_dragged_handlers,
        on_snippet_dropped_handlers,
        on_snippet_dropped_near_handlers,
        on_snippet_dropped_over_handlers,
        on_snippet_move_handlers,
        on_snippet_out_dropzone_handlers,
        on_snippet_over_dropzone_handlers,
    } from "@html_builder/sidebar/block_tab";
    import {
        snippet_preview_dialog_bundles,
        snippet_preview_dialog_stylesheets_handlers,
    } from "@html_builder/snippets/add_snippet_dialog";
    import {
        background_shape_groups_providers,
        background_shape_target_providers,
    } from "@html_builder/plugins/background_option/background_shape_option_plugin";
    ...
    } from "@html_builder/core/builder_content_editable_plugin";
    import {
        builder_actions,
        BuilderActionsShared,
    } from "@html_builder/core/builder_actions_plugin";
    import {
        so_content_addition_selector,
        so_snippet_addition_selector,
    } from "@html_builder/core/dropzone_selector_plugin";
    ...
    export type BuilderResourcesAccess = EditorResourcesAccess &
        ResourcesTypesFactory<BuilderResourcesList>;
