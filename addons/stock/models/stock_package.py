...
class StockPackage(models.Model):
    ...
    def _compute_package_info(self):
        for package in self:
            ...
            if quants:
                ...
                if all(
                    p.company_id == package.child_package_ids[0]
    ...
    def _compute_outermost_package_id(self):
        ...
        for package in self:
            package.outermost_package_id = fetch_outermost_package(
        ...
        if "location_id" in vals:
            ...
            if not vals["location_id"] and not is_pack_empty:
                ...
                quant_to_move.move_quants(
                    location_dest_id,
                    message=self.env._("Package manually relocated"),
    ...
    def unpack(self):
        ...
        self.quant_ids.move_quants(
            message=self.env._("Quantities unpacked"), unpack=True
        )
