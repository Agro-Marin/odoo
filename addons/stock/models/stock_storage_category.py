...
class StockStorageCategory(models.Model):
    ...
    def _inverse_storage_capacity_ids(self):
        for storage_category in self:
            _debug.lifecycle(
                "capacities_updated",
                storage_category=storage_category.id,
                product_capacities=len(storage_category.product_capacity_ids),
                package_capacities=len(storage_category.package_capacity_ids),
            )
