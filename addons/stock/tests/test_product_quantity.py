...
from odoo.addons.stock.tests.common import DoneMoveCase, LocationCase
from odoo.addons.stock.tools.quantity import QuantityFilters


@tagged("post_install", "-at_install")
class TestProductQuantityEdgeCases(TransactionCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
...
class TestQuantityAtDateFollowsTheLines(DoneMoveCase):
...
class TestQuantitySearchCandidates(DoneMoveCase):
...
@tagged("post_install", "-at_install")
class TestTheDestinationDomainIsBuiltOnce(LocationCase):
