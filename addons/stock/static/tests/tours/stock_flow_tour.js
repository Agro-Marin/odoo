...
registry
    ...
    .add("test_basic_stock_flow_with_minimal_access_rights", {
        steps: () => [
            ...
            {
                trigger:
                    ".o-dropdown-item[data-menu-xmlid='stock.menu_stock_picking_incoming']",
                run: "click",
            },
            {
            ...
            {
                trigger:
                    ".o-dropdown-item[data-menu-xmlid='stock.menu_stock_picking_outgoing']",
                run: "click",
            },
            {
                content: "check that at least one picking is present in the view",
