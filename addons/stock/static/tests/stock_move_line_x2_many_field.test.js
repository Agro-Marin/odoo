...
test("updateDirtyQuantsData combines unsaved qty deltas and quant reassignments", async () => {
    ...
    onRpc("get_move_line_quant_match", ({ args }) => {
        ...
        return {
            quants: [
                { id: 201, available_quantity: 10, move_line_ids: [11] },
                { id: 202, available_quantity: 7, move_line_ids: [] },
            ],
            move_lines: [{ id: 12, quantity: 4, quant_id: 202 }],
        };
    });
