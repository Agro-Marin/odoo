...
export class GenerateDialog extends Component {
    ...
    async _generate(count, qtyToProcess) {
        ...
        // Decide what is being replaced BEFORE asking the server where to put the
        // new lines: those lines still occupy their destinations as far as the
        // database is concerned, and putaway would count capacity they are about
        // to give back.
        const replacedIds = this.keepLines.el.checked ? [] : [...lines.currentIds];
