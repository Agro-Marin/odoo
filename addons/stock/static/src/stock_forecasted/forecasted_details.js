...
export class ForecastedDetails extends Component {
    ...
    setup() {
        ...
        this._formatFloat = (num) => {
            return formatFloat(num, { digits: [false, this.props.docs.precision] });
        };
    }
    ...
    _sameLineRule(line, nextLine){
        ...
        return  (this.sameDocumentIn(line, nextLine) && sameReceiptDate) || (OnHand.includes(line) && OnHand.includes(nextLine)) || (NotAvailable.includes(line) && NotAvailable.includes(nextLine));
    }
