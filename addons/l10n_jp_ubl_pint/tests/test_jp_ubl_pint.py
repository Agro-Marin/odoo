...
class TestJpUBLPint(AccountTestInvoicingCommon):
        ...
        cls.company_data["company"].write(
            {
                ...
                "phone_ids": [
                    Command.create({"number": "+81 90-1234-5678", "type": "landline"})
                ],
            }
        )
        cls.partner_a.write(
            {
                ...
                "phone_ids": [
                    Command.create({"number": "+81 3-5798-5555", "type": "landline"})
                ],
            }
        )
    ...
    def test_invoice(self):
        ...
        actual_xml, errors = self.env["account.edi.xml.pint_jp"]._export_invoice(
            invoice
        )
