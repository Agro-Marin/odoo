...
class ProjectProject(models.Model):
    ...
    def _get_expenses_profitability_items(self, with_action=True):
        ...
        sol_read_group = self.env['sale.order.line'].sudo()._read_group(
            ...
            ['amount_to_invoice_taxexc:sum', 'untaxed_amount_invoiced:sum'],
        )
        ...
        for order, product, currency, amount_to_invoice_taxexc_sum, untaxed_amount_invoiced_sum in sol_read_group:
            ...
            if product_id in expense_data_per_product_id:
                dict_invoices_amount_per_currency[currency]['to_invoice'] += amount_to_invoice_taxexc_sum
