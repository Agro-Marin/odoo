...
class TestProjectSaleExpenseProfitability(
    TestProjectProfitabilityCommon,
    TestProjectHrExpenseProfitabilityCommon,
    TestSaleCommon,
):
    ...
    def test_project_profitability(self):
        ...
        expense = self.env["hr.expense"].create(
            {
                ...
                "total_amount_currency": self.company_data[
        ...
        expense_sol = self.sale_order.line_ids.filtered(
        ...
        self.assertDictEqual(
            expense_profitability["costs"],
            {
                "id": "expenses",
                "sequence": expense_sequence,
                "billed": expense.currency_id.round(-expense.untaxed_amount_currency),
                "to_bill": 0.0,
            },
        )
        ...
        self.assertDictEqual(
            project._get_profitability_items(False),
            {
                "revenues": {
                    ...
                    "total": {
                        k: v
                        for k, v in expense_profitability["revenues"].items()
                        if k in ["to_invoice", "invoiced"]
                    },
                },
                "costs": {
                    ...
                    "total": {
                        k: v
                        for k, v in expense_profitability["costs"].items()
                        if k in ["to_bill", "billed"]
                    },
                },
            },
        )
        ...
        self.assertDictEqual(
            expense_profitability["costs"],
            {
                "id": "expenses",
                "sequence": expense_sequence,
                "billed": expense.currency_id.round(billed),
                "to_bill": 0.0,
            },
        )
        ...
        self.assertDictEqual(
            expense_profitability.get("costs", {}),
            {
                "id": "expenses",
                "sequence": expense_sequence,
                "billed": expense.currency_id.round(
                    -expense_foreign.untaxed_amount_currency * 0.2
                ),
                "to_bill": 0.0,
            },
    ...
    def test_project_profitability_2(self):
        ...
        self.assertDictEqual(
            ...
            {
                "data": [
                    expense_profitability["revenues"],
                    revenue_items_from_sol["data"][0],
                ],
                "total": {
                    "invoiced": expense_profitability["revenues"]["invoiced"]
                    + revenue_items_from_sol["total"]["invoiced"],
                    "to_invoice": expense_profitability["revenues"]["to_invoice"]
