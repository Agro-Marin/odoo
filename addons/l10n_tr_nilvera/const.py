...
NILVERA_ERROR_CODE_MESSAGES = {
    ...
    2025: _lt(
        "The recipient is an e-invoice taxpayer. The e-Archive invoice cannot be sent"
    ),
    ...
    2063: _lt(
        "Since the Invoice Scenario is an e-Archive Invoice, it cannot be sent to the e-Invoice sender"
    ),
