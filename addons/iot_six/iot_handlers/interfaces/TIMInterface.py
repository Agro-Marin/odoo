...
if IS_WINDOWS:
    ...
    DOWNLOAD_URL = (
        "https://nightly.odoo.com/master/posbox/iotbox/six-timapiv25_10_w.zip"
    )
else:
    LIB_PATH = file_path("iot_drivers/iot_handlers/lib")
    DOWNLOAD_URL = (
        "https://nightly.odoo.com/master/posbox/iotbox/six-timapiv25_10_l.zip"
    )
...
if IS_WINDOWS:
    LIB_PATH = file_path("iot_drivers/iot_handlers/lib")
    os.environ["PATH"] = (
        file_path("iot_drivers/iot_handlers/lib/tim") + os.pathsep + os.environ["PATH"]
    )
else:
