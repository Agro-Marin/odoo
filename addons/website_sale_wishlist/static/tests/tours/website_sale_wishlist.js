...
registry.category("web_tour.tours").add("shop_wishlist", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            run: function () {
                document.querySelector('.oe_login_form input[name="login"]').value =
                    "admin";
                document.querySelector('.oe_login_form input[name="password"]').value =
                    "admin";
                document.querySelector('.oe_login_form input[name="redirect"]').value =
                    "/shop?search=Customizable Desk";
                ...
                rpc("/web/dataset/call_kw/product.attribute/create", {
                    ...
                    .then(function () {
                        window.location.href =
                            "/web/session/logout?redirect=/shop?search=Bottle";
                    });
            },
            expectUnloadPage: true,
        },
        ...
        {
            trigger:
                '.o_wsale_product_grid_wrapper:contains("Bottle") .o_add_wishlist.disabled',
        },
        {
        ...
        {
            content:
                "Check there is no wishlist button when selecting impossible variant",
        ...
        {
            content:
                "Click on wishlist when selecting a possible variant from /product",
            trigger: "#product_detail .o_add_wishlist_dyn:not(.disabled)",
            run: "click",
        },
        {
        ...
        },
        {
            ...
            run: function () {
                ...
                document
                    .querySelector("form.o_wsale_products_searchbar_form button")
                    .click();
            },
            expectUnloadPage: true,
        },
        {
            ...
            trigger:
                ".oe_product_cart .o_wsale_product_btn:has(.o_add_wishlist[disabled])",
        },
        {
        ...
        },
        {
            ...
            trigger:
                ".oe_product_cart .o_wsale_product_btn:not(:has(.o_add_wishlist[disabled]))",
        },
    ],
});
