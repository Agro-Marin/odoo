...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _prepare_demo_data_move(self, company=False):
        ...
        if company.tax_config_id.account_fiscal_country_id.code == "PK":
            ...
            moves.update(
                {
                            ...
                            Command.create(
                                {
                                    ...
                                    "price_unit": 40000.0,
                                    "tax_ids": [
                                        Command.set(["pk_sales_tax_services_10"])
                                    ],
                                }
                            ),
                            Command.create(
                            ...
                            Command.create(
                                {
                                    ...
                                    "price_unit": 300.0,
                                    "tax_ids": [
                                        Command.set(["pk_sales_tax_services_5"])
                                    ],
                                }
                            ),
                        ],
                    ...
                    self.company_xmlid("l10n_pk_demo_reconcile_1"): {
                        ...
                        "partner_id": "l10n_pk.res_partner_punjab",
                        "invoice_date": fields.Datetime.today() - relativedelta(days=1),
                        "delivery_date": fields.Datetime.today()
                            ...
                            Command.create(
                                {
                                    ...
                                    "price_unit": 1000.0,
                                    "tax_ids": [
                                        Command.set(["pk_sales_tax_services_15"])
                                    ],
                                }
                            ),
                            Command.create(
                            ...
                            Command.create(
                                {
                                    ...
                                    "quantity": 4,
                                    "price_unit": 1000.0,
                                    "tax_ids": [Command.set(["pk_sales_tax_17"])],
                                }
                            ),
                            Command.create(
                                {
                            ...
                            Command.create(
                                {
                                    ...
                                    "price_unit": 1000.0,
                                    "tax_ids": [
                                        Command.set(["pk_sales_tax_services_17"])
                                    ],
                                }
                            ),
                            Command.create(
