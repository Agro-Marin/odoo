...
class TestAnzUBLPint(AccountTestInvoicingCommon):
        ...
        cls.company_data["company"].write(
            {
                ...
                "phone_ids": [
                    Command.create({"number": "+61 412 345 678", "type": "landline"})
                ],
            }
        )
        cls.partner_a.write(
            {
                ...
                "phone_ids": [
                    Command.create({"number": "+64 21 123 4567", "type": "landline"})
                ],
            }
        )
    ...
    def test_invoice(self):
        ...
        actual_xml, errors = self.env["account.edi.xml.pint_anz"]._export_invoice(
            invoice
        )
