...
class TestDownloadDocs(
    TestUblBis3Common, TestUblCiiBECommon, AccountTestInvoicingHttpCommon
):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        ...
        assert (
            invoice_1.invoice_pdf_report_id
            and invoice_2.invoice_pdf_report_id
            and not invoice_3.invoice_pdf_report_id
        )
        assert (
            invoice_1.ubl_cii_xml_id
            and invoice_2.ubl_cii_xml_id
            and not invoice_3.ubl_cii_xml_id
        )
