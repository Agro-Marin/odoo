...
class TestUblExportBis3SelfbillingBE(TestUblBis3Common, TestUblCiiBECommon):
    ...
    def test_invoice_selfbilling(self):
        ...
        product = self._create_product(
            standard_price=100.0, supplier_taxes_id=tax_21.ids
        )
    ...
    def test_invoice_selfbilling_reverse_charge(self):
        ...
        product = self._create_product(
            standard_price=100.0, supplier_taxes_id=tax_21_reverse_charge.ids
        )
        ...
        self._assert_invoice_ubl_file(
            invoice, "test_invoice_selfbilling_reverse_charge"
        )
