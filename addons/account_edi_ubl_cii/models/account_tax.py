...
class AccountTax(models.Model):
    ...
    ubl_cii_tax_exemption_reason_code = fields.Selection(
        ...
        selection=[
            ...
            (
                "VATEX-FR-CGI261D-3",
                "VATEX-FR-CGI261D-3 - Exempt based on 3° of article 261 D of the Code Général des Impôts (CGI ; General tax code)",
            ),
            (
                "VATEX-FR-CGI261D-4",
    ...
    def _compute_ubl_cii_requires_exemption_reason(self):
        for tax in self:
            tax.ubl_cii_requires_exemption_reason = tax.ubl_cii_tax_category_code in [
                "AE",
                "E",
                "G",
                "O",
