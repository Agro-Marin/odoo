...
class AccountEdiXmlUbl_21(models.AbstractModel):
        ...
        document_node.update(
            {
                ...
                "cbc:CreditNoteTypeCode": {
                    "_text": 261 if vals["process_type"] == "selfbilling" else 381
                }
    ...
    def _add_invoice_line_period_nodes(self, line_node, vals):
        ...
        if vals["document_type"] in {"invoice", "credit_note"} and (
            base_line.get("deferred_start_date") or base_line.get("deferred_end_date")
        ):
