...
registry.category("web_tour.tours").add("forum_question", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger:
                ".modal.modal_shown.show:contains(thanks for posting!) button.btn-close",
            run: "click",
        },
        {
            content: "Check that the code still exists as it was written.",
            trigger:
                'div.o_wforum_post_content:contains("First Question <p>code here</p>")',
        },
        {
        ...
        },
        {
            ...
            trigger:
                'div.odoo-editor-editable p:contains("First Question <p>code here</p>")',
        },
        {
        ...
        },
        {
            content: "Close modal",
            trigger:
                ".modal_shown .modal-header:contains('Thanks for posting!') button.btn-close",
            run: "click",
        },
        {
