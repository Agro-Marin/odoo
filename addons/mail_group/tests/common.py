...
class TestMailListCommon(MailCommon):
    ...
    def setUpClass(cls):
        ...
        cls.email_from_unknown = tools.formataddr(
            ("Bob Lafrite", "bob.email@test.example.com")
        )
        ...
        cls.test_group_valid_members = (
            cls.test_group_member_1
            + cls.test_group_member_2
            + cls.test_group_member_4_emp
        )
