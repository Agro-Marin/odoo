...
class RepairOrder(models.Model):
    ...
    reference_ids = fields.Many2many(
        ...
        'repair_id', 'reference_id', string='References', copy=False)
    ...
    def action_repair_done(self):
        ...
        for repair in self:
            ...
            if repair.sale_order_line_id:
                ...
                if ro_origin_product.type == 'service' and (no_service_policy or ro_origin_product.service_policy == 'ordered_prepaid'):
                    repair.sale_order_line_id.qty_transfered = repair.sale_order_line_id.product_uom_qty
            if not repair.product_id:
                continue
        ...
        for sale_line in self.move_ids.sale_line_id:
            ...
            sale_line.write({'product_uom_qty': sale_line.qty_transfered, 'price_unit': price_unit})
