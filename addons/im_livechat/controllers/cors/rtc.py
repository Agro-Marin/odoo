...
class LivechatRtcController(RtcController):
    ...
    def livechat_channel_call_join(
        self, guest_token, channel_id, check_rtc_session_ids=None
    ):
    ...
    def livechat_channel_ping(
        self, guest_token, channel_id, rtc_session_id=None, check_rtc_session_ids=None
    ):
        force_guest_env(guest_token)
