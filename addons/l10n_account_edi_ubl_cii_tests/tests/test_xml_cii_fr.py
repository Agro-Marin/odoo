...
class TestCIIFR(TestUBLCommon):
        ...
        cls.partner_1 = cls.env["res.partner"].create(
            {
                ...
                "bank_ids": [
                    (
                        0,
                        0,
                        {"acc_number": "FR15001559627230", "allow_out_payment": True},
                    )
                ],
                "phone_ids": [
                    Command.create({"number": "+1 (650) 555-0111", "type": "landline"})
                ],
        ...
        cls.partner_2 = cls.env["res.partner"].create(
            {
                ...
                "bank_ids": [
                    (
                        0,
                        0,
                        {"acc_number": "FR90735788866632", "allow_out_payment": True},
                    )
                ],
                "ref": "ref_partner_2",
                "invoice_edi_format": "facturx",
    ...
    def test_export_pdf(self):
        ...
        facturx_filename = self.env["account.edi.xml.cii"]._export_invoice_filename(
            invoice
        )
    ...
    def test_export_with_fixed_taxes_case1(self):
        ...
        self._assert_invoice_attachment(
            invoice.ubl_cii_xml_id, None, "from_odoo/facturx_ecotaxes_case1.xml"
        )
    ...
    def test_export_with_fixed_taxes_case2(self):
            ...
            invoice_line_ids=[
                {
                    ...
                    "price_unit": 98,
                    "tax_ids": [
                        (6, 0, [self.recupel.id, self.auvibel.id, self.tax_21.id])
                    ],
                }
            ],
        )
        self.assertEqual(invoice.amount_total, 121)
        self._assert_invoice_attachment(
            invoice.ubl_cii_xml_id, None, "from_odoo/facturx_ecotaxes_case2.xml"
        )
    ...
    def test_export_with_fixed_taxes_case3(self):
        ...
        self.assertEqual(invoice.amount_total, 121)
        self._assert_invoice_attachment(
            invoice.ubl_cii_xml_id, None, "from_odoo/facturx_ecotaxes_case3.xml"
        )
    ...
    def test_import_partner_facturx(self):
        ...
        self._test_import_partner(
            invoice.ubl_cii_xml_id, self.partner_1, self.partner_2
        )
    ...
    def test_import_and_create_partner_facturx(self):
        ...
        expected_vals = {
            key: value for key, value in partner_vals.items() if key != "phone"
        }
        self.assertRecordValues(invoice.partner_id, [expected_vals])
        self.assertEqual(
            invoice.partner_id._phone_get_number().number, partner_vals["phone"]
        )
    ...
    def test_import_tax_included(self):
        ...
        invoice_vals = {
            ...
            "invoice_lines": [
                ...
                {
                    "price_unit": 190.48,
                    "price_subtotal": 171.43,
                    "quantity": 1,
                    "discount": 10.001049979000411,
                    "tax_ids": self.tax_5_purchase.ids,
                },
                {
                    "price_unit": 200,
    ...
    def test_import_fixed_taxes(self):
        ...
        self._assert_imported_invoice_from_file(
            filename="facturx_ecotaxes_case1.xml", **kwargs
        )
        self._assert_imported_invoice_from_file(
            filename="facturx_ecotaxes_case3.xml", **kwargs
        )
        ...
        self._assert_imported_invoice_from_file(
            filename="facturx_ecotaxes_case2.xml", **kwargs
        )
