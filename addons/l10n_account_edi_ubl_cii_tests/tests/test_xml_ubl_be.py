...
class TestUBLBE(TestUBLCommon, TestAccountMoveSendCommon):
    ...
    def test_import_invoice_xml(self):
        kwargs = {
            ...
            "invoice_vals": {
                ...
                "invoice_lines": [
                    ...
                    for (subtotal, price_unit, discount) in [
                        (1782, 990, 10),
                        (1000, 100, 0),
                        (-100, 100, 0),
                    ]
        ...
        self._assert_imported_invoice_from_file(
            filename="bis3_out_invoice.xml", **kwargs
        )
        # same as the file above, but the <cac:Price> are missing in the invoice lines
        self._assert_imported_invoice_from_file(
            filename="bis3_out_invoice_no_prices.xml", **kwargs
        )
    ...
    def test_import_invoice_xml_open_peppol_examples(self):
        ...
        self._assert_imported_invoice_from_file(
            ...
            invoice_vals={
                ...
                "amount_tax": 1225,
                "invoice_lines": [
                    {"price_subtotal": x} for x in (200, -200, 3999, 1, 1000, 899, 1)
                ],
            },
        )
    ...
    def test_import_existing_invoice_flip_move_type(self):
        ...
        self.assertRecordValues(
            invoice, [{"move_type": "out_refund", "amount_total": 3164.22}]
        )
