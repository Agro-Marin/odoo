...
class TestUBLDE(TestUBLCommon):
        ...
        cls.partner_1 = cls.env["res.partner"].create(
            {
                ...
                "vat": "DE257486969",
                "phone_ids": [
                    Command.create({"number": "+49 180 6 225789", "type": "landline"})
                ],
                ...
                "bank_ids": [
                    (
                        ...
                        0,
                        {
                            "acc_number": "DE48500105176424548921",
        ...
        cls.partner_2 = cls.env["res.partner"].create(
            {
                ...
                "bank_ids": [
                    (
                        ...
                        0,
                        {
                            "acc_number": "DE50500105175653254743",
                            "allow_out_payment": True,
                        },
                    )
                ],
    ...
    def setup_independent_company(cls, **kwargs):
        return super().setup_independent_company(
            phone_ids=[
                Command.create({"number": "+49(0) 30 227-0", "type": "landline"})
            ],
    ...
    def _detach_attachment(self, attachment):
        ...
        self.env.cr.execute(
            "UPDATE ir_attachment SET res_id = NULL WHERE id = %s", (attachment.id,)
        )
