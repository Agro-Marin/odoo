        ...
        cls.partner_1 = cls.env["res.partner"].create(
            {
                ...
                "vat": "NL000099998B57",
                "phone_ids": [
                    Command.create({"number": "+31 180 6 225789", "type": "landline"})
                ],
        ...
        cls.partner_2 = cls.env["res.partner"].create(
            {
                ...
                "bank_ids": [
                    (
                        0,
                        0,
                        {"acc_number": "NL93999574162167", "allow_out_payment": True},
                    )
                ],
                "peppol_eas": "9944",
            ...
            invoice_line_ids=[
                {
                    ...
                    "price_unit": 50.0,
                    "tax_ids": [
                        Command.set([self.tax_10_fixed.id, self.tax_7_purchase.id])
                    ],
                }
            ],
        )
