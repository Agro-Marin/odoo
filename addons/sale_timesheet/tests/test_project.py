...
class TestProject(TestCommonSaleTimesheet):
    ...
    def test_fetch_sale_order_items(self):
        ...
        self.assertEqual(
            self.project_global._get_sale_orders(), expected_sale_order_items.order_id
        )
    ...
    def test_analytic_account_balance(self):
        ...
        expected_analytic_account_balance = (
            -self.employee_user.hourly_cost * unit_amount
        )
        self.project_global.write(
            {
