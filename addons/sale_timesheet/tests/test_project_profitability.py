...
class TestSaleTimesheetProjectProfitability(TestCommonSaleTimesheet):
    ...
    def test_get_project_profitability_items(self):
        ...
        SaleOrderLineForeign = self.env["sale.order.line"].with_context(
            default_order_id=sale_order_foreign.id
        )
        ...
        sequence_per_invoice_type = (
            self.project_task_rate._get_profitability_sequence_per_invoice_type()
        )
        ...
        self.assertEqual(
            (foreign_timesheet1 + foreign_timesheet2).so_line,
            delivery_service_order_line,
        )
        self.assertEqual(
            delivery_service_order_line.qty_transferred,
            0.0,
                ...
                "costs": {
                    "data": [
                        ...
                        },
                        {
                            ...
                            "billed": (
                                foreign_timesheet1.unit_amount
                                + foreign_timesheet2.unit_amount
                            )
                            * -foreign_employee.hourly_cost
                            * 0.2,
                            "to_bill": 0.0,
                        },
                    ],
                ...
                "costs": {
                    "data": [
                        ...
                        },
                        {
                            "id": "billable_manual",
                            "sequence": sequence_per_invoice_type["billable_manual"],
                            "billed": (timesheet1.unit_amount + timesheet2.unit_amount)
                            * -self.employee_user.hourly_cost
                            + (
                                foreign_timesheet1.unit_amount
                                + foreign_timesheet2.unit_amount
                            )
        ...
        self.assertFalse(
            foreign_timesheet3.so_line,
            "This timesheet should be non billable since the user manually empty the SOL.",
        )
        self.assertDictEqual(
            self.project_task_rate._get_profitability_items(False),
            {
                ...
                "costs": {
                    "data": [
                        ...
                        },
                        {
                            ...
                            "billed": foreign_timesheet3.unit_amount
                            * -foreign_employee_2.hourly_cost
                            * 0.2,
                            "to_bill": 0.0,
                        },
                    ],
                    "total": {
                        ...
                        * -foreign_employee.hourly_cost
                        * 0.2
                        + foreign_timesheet3.unit_amount
                        * -foreign_employee_2.hourly_cost
                        * 0.2,
                    },
                },
        ...
        self.assertEqual(
            billable_timesheets.so_line,
            foreign_delivery_timesheet_order_line,
            "The SOL of the timesheets should be the one of the task.",
        )
        self.assertEqual(
            foreign_delivery_timesheet_order_line.qty_transferred,
                ...
                "revenues": {
                    "data": [
                        ...
                        },
                        {
                            ...
                            "to_invoice": foreign_delivery_timesheet_order_line.amount_taxexc_to_invoice
                            * 0.2,
                            "invoiced": 0.0,
                        },
                    ],
                ...
                "revenues": {
                    "data": [
                        ...
                        },
                        {
                            "id": "billable_time",
                            "sequence": sequence_per_invoice_type["billable_time"],
                            "to_invoice": delivery_timesheet_order_line.amount_taxexc_to_invoice
                            + foreign_delivery_timesheet_order_line.amount_taxexc_to_invoice
                            * 0.2,
                            "invoiced": 0.0,
                        },
                    ],
                    "total": {
                        ...
                        "to_invoice": foreign_delivery_timesheet_order_line.amount_taxexc_to_invoice
                        * 0.2
                        + delivery_timesheet_order_line.amount_taxexc_to_invoice,
                    },
                },
                "costs": {
                    "data": [
        ...
        task2_foreign_timesheet = Timesheet.with_context(
        ...
        self.assertFalse(
            [
                data
                for data in profitability_items["revenues"]["data"]
        ...
        self.assertDictEqual(
            [
                data
                for data in profitability_items["costs"]["data"]
                if data["id"] == "billable_milestones"
            ][0],
            {
                "id": "billable_milestones",
                "sequence": sequence_per_invoice_type["billable_milestones"],
                "to_bill": 0.0,
                "billed": task2_foreign_timesheet.amount * 0.2,
            },
        )
        ...
        self.assertDictEqual(
            ...
            ][0],
            {
                "id": "billable_milestones",
                "sequence": sequence_per_invoice_type["billable_milestones"],
                "to_invoice": milestone_foreign_order_line.amount_taxexc_to_invoice
                * 0.2,
                "invoiced": 0.0,
            },
        )
        ...
        task3_timesheet = Timesheet.with_context(
            default_task_id=task3_milestone.id
        ).create(
            {
                "name": "/",
                "project_id": self.project_task_rate.id,
        ...
        self.assertDictEqual(
            ...
            ][0],
            {
                ...
                "sequence": sequence_per_invoice_type["billable_milestones"],
                "to_bill": 0.0,
                "billed": task2_timesheet.amount
                + task2_foreign_timesheet.amount * 0.2
                + task3_timesheet.amount,
            },
        )
        ...
        self.assertDictEqual(
            ...
            ][0],
            {
                ...
                "to_invoice": milestone_foreign_order_line.amount_taxexc_to_invoice
                * 0.2
                + milestone_order_line.amount_taxexc_to_invoice,
                "invoiced": 0.0,
            },
        )
    ...
    def test_profitability_revenue(self):
        ...
        saleOrderLine_revenue = self.env["sale.order.line"].with_context(
        ...
        profitability_item_data = {
            "revenues": {
                ...
                "total": {"invoiced": 0.0, "to_invoice": 200.0},
            },
        ...
        profitability_before = self.project_task_rate.get_panel_data()[
            "profitability_items"
        ]
        product_profitability_items.active = False
        profitability_after = self.project_task_rate.get_panel_data()[
            "profitability_items"
        ]
        self.assertEqual(
