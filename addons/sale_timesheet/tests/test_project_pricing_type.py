...
class TestProjectPricingType(TestCommonSaleTimesheet):
    def test_pricing_type(self):
        ...
        self.assertFalse(
            project.filtered_domain(_search_pricing_type("=", "task_rate"))
        )
        self.assertFalse(
            project.filtered_domain(_search_pricing_type("=", "fixed_rate"))
        )
        self.assertFalse(
            project.filtered_domain(_search_pricing_type("=", "employee_rate"))
        )
        ...
        self.assertTrue(
            project.allow_billable,
            "The allow_billable should be updated and equal to True.",
        )
        ...
        self.assertFalse(
            project.sale_line_employee_ids, "The employee mappings should be empty."
        )
        self.assertEqual(
            project.pricing_type,
            "task_rate",
            "The pricing type should be equal to task_rate.",
        )
        ...
        self.assertEqual(
            ...
            self.so.line_ids[0],
            "The sales order item should be the one chosen.",
        )
        self.assertEqual(
            project.pricing_type,
            "fixed_rate",
        ...
        self.assertEqual(
            len(project.sale_line_employee_ids),
            1,
            "The project should have an employee mapping.",
        )
        self.assertEqual(
            project.pricing_type,
            "employee_rate",
        ...
        self.assertFalse(
            project.sale_order_id, "The sales order of the project should be empty."
        )
        self.assertFalse(
            project.sale_line_id, "The sales order item of the project should be empty."
        )
        self.assertEqual(
            project.pricing_type,
            "employee_rate",
