    ...
    def _select(self):
        return super()._select() + """,
            ...
            CASE
                ...
                THEN 0
                WHEN T.invoice_policy = 'order' AND SOL.qty_transfered != 0
                THEN (SOL.price_subtotal / SOL.qty_transfered) * (A.unit_amount / sol_product_uom.factor * a_product_uom.factor)
