...
registry
    ...
    .add("website_livechat.chatbot_user_input_saved_on_last_step", {
        steps: () => [
            {
            ...
            {
                trigger:
                    ".o-livechat-root:shadow .o-mail-Message:contains(Enter your phone number)",
            },
            {
            ...
            {
                trigger:
                    ".o-livechat-root:shadow .o-mail-Message:contains(Enter your email address)",
            },
            {
                trigger: ".o-livechat-root:shadow .o-mail-Composer-input",
            ...
            {
                trigger:
                    ".o-livechat-root:shadow span:contains(This livechat conversation has ended)",
            },
        ],
    });
