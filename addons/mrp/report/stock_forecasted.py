...
class StockForecasted_Product_Product(models.AbstractModel):
    ...
    def _prepare_report_line(
        ...
        line["move_out"]["raw_material_production_id"] = (
            move_out.raw_material_production_id.read(
                fields=["id", "unreserve_visible", "reserve_visible", "priority"]
            )[0]
        )
        return line
    ...
    def _get_reservation_data(self, move):
        ...
        return {"_name": move[m2o]._name, "name": move[m2o].name, "id": move[m2o].id}
