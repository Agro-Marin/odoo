    ...
    steps: () => [
        {
            ...
            trigger:
                ".o_mrp_bom_report_page h2 a:contains('[alpaca] Product Test Sync (L)')",
            run: () => {},
        },
        {
        ...
        },
        {
            ...
            trigger:
                ".o-autocomplete--dropdown-menu.show li.o-autocomplete--dropdown-item:eq(1)",
            run: "click",
        },
        {
            content: "Ensure the second variant is displayed",
            trigger:
                ".o_mrp_bom_report_page h2 a:contains('[zebra] Product Test Sync (S)')",
            run: () => {},
        },
    ],
});
