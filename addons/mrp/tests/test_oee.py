...
class TestOee(TestMrpCommon):
    ...
    def test_unset_end_date(self):
        with Form(self.env["mrp.workcenter.productivity"]) as workcenter_productivity:
            ...
            self.assertEqual(
                workcenter_productivity.duration,
                0.0,
    ...
    def test_workcenter_oee(self):
        ...
        self.assertEqual(
            ...
            "Wrong blocked time on workcenter.",
        )
        self.assertEqual(
            self.workcenter_1.productive_time,
            round(productive_time / 60, 2),
        ...
        computed_oee = round(
            (
                ...
                / ((productive_time / 60) + (blocked_time / 60))
            ),
            2,
        )
        self.assertEqual(
