...
class TestProjectPurchase(TestProjectPurchaseProfitability):
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.project_plan, _other_plans = cls.env[
    ...
    def test_project_on_pol_with_analytic_distribution_model(self):
        ...
        distribution_model_product = self.env[
        ...
        ].create(
            {
                ...
                "analytic_distribution": {
                    ",".join(
                        [str(analytic_account_1.id), str(analytic_account_2.id)]
                    ): 100
                },
                "company_id": self.company.id,
            }
        )
        distribution_model_partner = self.env[
            "account.analytic.distribution.model"
        ].create(
            {
        ...
        self.assertEqual(
            purchase_order.line_ids.analytic_distribution,
            distribution_model_product.analytic_distribution
        ...
        self.assertEqual(
            purchase_order.line_ids.analytic_distribution, expected_distribution_project
        )
    ...
    def test_compute_purchase_orders_count(self):
        ...
        self.env["purchase.order"].create(
            [
                ...
                },
                {
                    ...
                    "line_ids": [Command.create(order_line_values)],
                },
                {
        ...
        self.assertEqual(
            self.project1.purchase_orders_count,
            3,
        ...
        self.assertEqual(
            project2.purchase_orders_count,
            2,
