...
class TestL10nAccountWithholdingTaxesAmounts(TestTaxCommon):
    ...
    def setUpClass(cls):
        ...
        cls.company_data[
            "company"
        ].tax_config_id.tax_calculation_rounding_method = "round_per_line"

    def test_case_a(self):
        vat_tax_incl_affecting = self.percent_tax(
            15, price_include_override="tax_included", include_base_amount=True
        )
        wth_tax_affecting = self.percent_tax(
            -10,
                    ...
                    Command.create(
                        {
                            ...
                            "tax_ids": [
                                Command.set(
                                    (vat_tax_incl_affecting | wth_tax_affecting).ids
                                )
                            ],
                        }
                    )
                    ...
                    Command.create(
                        {
                            ...
                            "price_unit": 1000.0,
                            "tax_ids": [
                                Command.set((vat_tax_incl | wth_tax_affecting).ids)
                            ],
                        }
                    )
                ],
                    ...
                    Command.create(
                        {
                            ...
                            "price_unit": 1000.0,
                            "tax_ids": [
                                Command.set((vat_tax_affecting | wth_tax_affecting).ids)
                            ],
                        }
                    )
                ],
    ...
    def test_case_g(self):
        ...
        vat_tax_affecting_affected = self.percent_tax(
            15, include_base_amount=True, is_base_affected=False
        )
        wth_tax_affecting = self.percent_tax(
            -10,
            include_base_amount=True,
                    ...
                    Command.create(
                        {
                            ...
                            "tax_ids": [
                                Command.set(
                                    (vat_tax_incl | vat_tax | wth_tax_affecting).ids
                                )
                            ],
                        }
                    )
                    ...
                    Command.create(
                        {
                            ...
                            "tax_ids": [
                                Command.set(
                                    (
                                        vat_tax_affecting | wth_tax_affecting | wth_tax
                                    ).ids
                                )
                            ],
                        }
    ...
    def test_case_n(self):
        ...
        wth_tax_affected = self.percent_tax(
            -10,
            is_withholding_tax_on_payment=True,
