...
class TestWorkEntry(TestWorkEntryBase):
    ...
    def test_work_entry_different_calendars(self):
        ...
        self.assertEqual(
            len(half1_entries), 15
        )  # 1 work entry per day (including weekend)
        ...
        self.assertEqual(
            len(half2_entries), 11
        )  # 1 work entries per day, no work entries for weekend
        ...
        self.assertEqual(
            len(half1_entries), 15
        )  # work entries cover the entire duration
