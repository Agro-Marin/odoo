...
registry.category("web_tour.tours").add("project_create_sol_tour", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            content:
                "Open the project dropdown of project name 'Test History Project'.",
        ...
        {
            trigger:
                ".o_field_widget[name=sale_line_id] .o-autocomplete--dropdown-menu .o_m2o_dropdown_option_create a",
