...
class TestReInvoice(TestSaleCommon):
    ...
    def test_at_cost(self):
        ...
        self.assertEqual(
            (
                ...
                sale_order_line3.product_uom_qty,
        ...
        self.assertEqual(
            (
                ...
                sale_order_line4.product_uom_qty,
        ...
        self.assertEqual(
            (
                ...
                sale_order_line5.product_uom_qty,
        ...
        self.assertEqual(
            (
                ...
                sale_order_line6.product_uom_qty,
        ...
        invoices = self.env["account.move"].create(
            [
                ...
                },
                {
                    ...
                    "invoice_date": "2020-01-10",
                    "invoice_line_ids": [
                        (0, 0, {"product_id": self.product_a.id, "price_unit": 500.0})
                    ],
                },
                {
                    ...
                    "date": "2020-01-01",
                    "invoice_line_ids": [
                        (0, 0, {"product_id": self.product_a.id, "price_unit": 800.0})
                    ],
                },
            ]
        )
    ...
    def test_not_reinvoicing_invoiced_so_lines(self):
        ...
        so_line3 = self.sale_order.line_ids.filtered(
            lambda sol: (
                sol != so_line1
                and sol.product_id == self.company_data["product_delivery_cost"]
            )
        )
        so_line4 = self.sale_order.line_ids.filtered(
            lambda sol: (
                sol != so_line2
                and sol.product_id == self.company_data["product_delivery_sales_price"]
            )
        ...
        self.assertFalse(
            so_line3,
            "No re-invoicing should have created a new sale line with product #1",
        )
        self.assertFalse(
            so_line4,
            "No re-invoicing should have created a new sale line with product #2",
        )
        self.assertEqual(
            so_line1.qty_transferred,
            1,
            "No re-invoicing should have impacted exising SO line 1",
        )
        self.assertEqual(
            so_line2.qty_transferred,
            1,
            "No re-invoicing should have impacted exising SO line 2",
        )
                        ...
                        Command.create(
                            {
                                ...
                                "analytic_distribution": {
                                    self.sale_order.project_account_id.id: 100
                                },
                            }
                        ),
                    ],
