...
class TestSaleOrderAccess(TransactionCase):
    ...
    def test_user_with_company_1_access_can_open_sale_order(self):
        Form(
            self.sale_order_company_1.with_user(self.admin_user).with_company(
                self.company_1
            )
        )
        Form(
            self.sale_order_company_1.with_user(self.user_company_1).with_company(
                self.company_1
            )
        )
