...
class TestSoLineMilestones(TestSaleCommon):
    ...
    def test_reached_milestones_delivered_quantity(self):
        ...
        self.assertEqual(
            self.sol1.qty_transferred, 0.0, "Delivered quantity should start at 0"
        )
        self.assertEqual(
            self.sol2.qty_transferred, 0.0, "Delivered quantity should start at 0"
        )

        self.milestone1.is_reached = True
        self.assertEqual(
            self.sol1.qty_transferred,
            10.0,
            "Delivered quantity should update after a milestone is reached",
        )

        self.milestone2.is_reached = True
        self.assertEqual(
            self.sol2.qty_transferred,
            6.0,
            "Delivered quantity should update after a milestone is reached",
        )
    ...
    def test_update_reached_milestone_quantity(self):
        self.milestone1.is_reached = True
        self.assertEqual(
            self.sol1.qty_transferred, 10.0, "Delivered quantity should start at 10"
        )
    ...
    def test_remove_reached_milestone(self):
        ...
        self.assertEqual(
            self.sol1.qty_transferred,
            0.0,
            "Delivered quantity should update when a milestone is removed",
        )
    ...
    def test_compute_sale_line_in_task(self):
        ...
        self.assertEqual(
            task.sale_line_id,
            self.sol1,
            "The task should have the one of the project linked",
        )
        ...
        self.assertEqual(
            task.sale_line_id,
            self.sol1,
            "The task should keep the SOL linked to the milestone.",
        )
    ...
    def test_default_values_milestone(self):
        ...
        milestone = (
            ...
            .with_context({"default_project_id": project.id})
            .create(
                {
                    "name": "Test milestone",
    ...
    def test_compute_qty_milestone(self):
        ...
        self.assertEqual(
            self.milestone1.quantity_percentage / self.milestone1.product_uom_qty,
            ratio,
    ...
    def test_so_with_milestone_products(self):
        ...
        products = (
            ...
            | self.product_delivery_milestones3
        )
        ...
        self.assertEqual(
            len(project.milestone_ids),
            3,
            "The project should have a milestone for each product.",
        )
        self.assertCountEqual(
            {m.name for m in project.milestone_ids},
    ...
    def test_project_template_with_milestones(self):
        ...
        self.assertEqual(
            len(project.milestone_ids),
            4,
            "The generated project should have 4 milestones.",
        )
        self.assertEqual(
            {m.quantity_percentage for m in project.milestone_ids},
            {0.25},
            "All milestones of the generated project should have a quantity percentage of 25%.",
        )
        self.assertTrue(
            project.allow_milestones,
            "The project should allow milestones as it was created from a product configured to create milestones.",
        )
    ...
    def test_project_template_with_milestones_multiple_products(self):
        ...
        project = sale_order.project_ids
        self.assertEqual(
            len(project.milestone_ids), 5, "The project should have 5 milestones"
        )
        self.assertTrue(
            project.allow_milestones,
            "The project should allow milestones as it was created from a product configured to create milestones.",
