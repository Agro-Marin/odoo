...
registry.category("web_tour.tours").add("test_error_website", {
    ...
    steps: () => [
        ...
        // HTTP ERROR
        {
            ...
            run: function () {
                window.location.href =
                    window.location.origin + "/test_user_error_http?debug=0";
            },
        ...
        },
        {
            ...
            run: function () {
                window.location.href =
                    window.location.origin + "/test_user_error_http?debug=1";
            },
            expectUnloadPage: true,
        },
        {
        ...
        },
        {
            ...
            trigger:
                'div#error_main.collapse.show pre:contains("This is a user http test")',
        },
        {
            content: "http user error page debug has traceback closed",
            trigger:
                "body:has(div#error_traceback.collapse:not(.show) pre#exception_traceback)",
            run: function () {
                window.location.href =
                    window.location.origin + "/test_validation_error_http?debug=0";
            },
            expectUnloadPage: true,
        },
        {
        ...
        },
        {
            ...
            run: function () {
                window.location.href =
                    window.location.origin + "/test_validation_error_http?debug=1";
            },
            expectUnloadPage: true,
        },
        {
        ...
        },
        {
            ...
            trigger:
                'div#error_main.collapse.show pre:contains("This is a validation http test")',
        },
        {
            ...
            run: function () {
                window.location.href =
                    window.location.origin + "/test_access_error_http?debug=0";
            },
            expectUnloadPage: true,
        },
        {
        ...
        },
        {
            ...
            run: function () {
                window.location.href =
                    window.location.origin + "/test_access_error_http?debug=1";
            },
            expectUnloadPage: true,
        },
        {
        ...
        },
        {
            ...
            trigger:
                'div#error_main.collapse.show pre:contains("This is an access http test")',
        },
        {
            ...
            run: function () {
                window.location.href =
                    window.location.origin + "/test_view_access_error?debug=0";
            },
            expectUnloadPage: true,
        },
        {
        ...
        },
        {
            content: "http access error page has title and message",
            trigger:
                'div.container pre:contains("Uh-oh! Looks like you have stumbled upon some top-secret records.")',
            run: function () {
                window.location.href =
                    window.location.origin + "/test_view_access_error?debug=1";
            },
            expectUnloadPage: true,
        },
        {
        ...
        },
        {
            content: "http access error page debug has title and message open",
            trigger:
                'div#error_main.collapse.show pre:contains("Uh-oh! Looks like you have stumbled upon some top-secret records.")',
        },
        {
            content: "http access error page debug has traceback closed",
            trigger:
            ...
            run: function () {
                window.location.href =
                    window.location.origin + "/test_missing_error_http?debug=0";
            },
            expectUnloadPage: true,
        },
        {
            ...
            run: function () {
                window.location.href =
                    window.location.origin + "/test_missing_error_http?debug=1";
            },
            expectUnloadPage: true,
        },
        {
            ...
            run: function () {
                window.location.href =
                    window.location.origin + "/test_access_denied_http?debug=1";
            },
            expectUnloadPage: true,
        },
        {
