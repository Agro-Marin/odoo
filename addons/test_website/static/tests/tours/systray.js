...
const canPublish = () => [
    ...
    },
    {
        ...
        trigger:
            '.o_menu_systray .o_menu_systray_item:contains("Published"):not([data-processing])',
    },
    {
        content: "Unpublish",
    ...
    },
    {
        ...
        trigger:
            '.o_menu_systray .o_menu_systray_item:contains("Unpublished"):not([data-processing])',
    },
];
...
const canToggleMobilePreview = () => [
    {
        ...
        trigger:
            ".o_menu_systray .o_menu_systray_item.o_mobile_preview:not(.o_mobile_preview_active) span",
        run: "click",
    },
    {
        content: "Disable mobile preview",
        trigger:
            ".o_menu_systray .o_menu_systray_item.o_mobile_preview.o_mobile_preview_active span",
        run: "click",
    },
];
...
const canSwitchWebsiteNoCheck = () => [
    {
        ...
        trigger:
            '.o_menu_systray .o_menu_systray_item.o_website_switcher_container .dropdown-toggle:contains("My Website"):not(:contains("My Website 2"))',
        run: "click",
    },
    {
...
const cannotAddNewContent = () => [
    {
        ...
        trigger:
            ".o_menu_systray:not(:has(.o_menu_systray_item.o_new_content_container))",
    },
];
...
const canEdit = () => [
    ...clickOnEditAndWaitEditMode(),
    {
        ...
        trigger:
            ':iframe span[data-oe-expression="test_model.name"][contenteditable="true"]',
        run: "click",
    },
    {
        content: "Change name",
    ...
    ...clickOnSave(),
    {
        ...
        trigger:
            ':iframe span[data-oe-expression="test_model.name"]:contains("Better name")',
    },
];
