        ...
        async onChangeFileInput() {
            ...
            let files = [
                ...
                getFileFromB64([
                    "image/webp",
                    "image.webp",
                    "UklGRhwAAABXRUJQVlA4TBAAAAAvE8AEAAfQhuh//wMR0f8A",
                ]),
                getFileFromB64([
                    "image/png",
                    "image.png",
                    "",
                ]),
                getFileFromB64([
                    "image/jpeg",
                    "image.jpeg",
                    "",
                ]),
            ];
    ...
    () => [
        ...
        },
        {
            ...
            run() {
                ...
                document.body
                    .querySelector(".o_select_media_dialog .o_file_input")
        ...
        },
        {
            ...
            trigger:
                ".o_we_progressbar:contains('image.webp'):contains('File has been uploaded')",
        },
        {
            content: "check upload progress bar is correctly shown (3)",
            trigger:
                ".o_we_progressbar:contains('image.png'):contains('File has been uploaded')",
        },
        {
            content: "check upload progress bar is correctly shown (4)",
            trigger:
                ".o_we_progressbar:contains('image.jpeg'):contains('File has been uploaded')",
        },
        {
        ...
        {
            content:
                "toaster should disappear after a few seconds if the uploaded image is successful",
...
registerWebsitePreviewTour(
    ...
    () => [
        ...
        },
        {
            ...
            trigger:
                ".o_we_media_dialog_img_wrapper:has(img[alt~=fox]) + .o_button_area",
            run: "click",
        },
        {
            trigger: ".o_notification_close",
        },
        {
            ...
            trigger:
                ".o_we_progressbar:contains('fox'):contains('File has been uploaded')",
        },
        {
        ...
        },
        {
            ...
            trigger:
                ":iframe #wrap .s_image_gallery img[data-original-src^='/unsplash/HQqIOc8oYro/fox']",
            run() {
                unpatchMediaDialog();
            },
        },
