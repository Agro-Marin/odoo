...
class WebsiteTest(Home):
    ...
    def test_view_access_error(self, **kwargs):
        ...
        return request.render(
            "test_website.test_view_access_error", {"record": record.with_user(public)}
        )
    ...
    @http.route(
        "/test_get_dbname", type="jsonrpc", auth="public", website=True, sitemap=False
    )
    ...
    @http.route(
        "/test_error_view", type="http", auth="public", website=True, sitemap=False
    )
    def test_error_view(self, **kwargs):
        return request.render("test_website.test_error_view")

    @http.route(
        "/test_user_error_http", type="http", auth="public", website=True, sitemap=False
    )
    ...
    def test_model(self, test_model, **kwargs):
        return request.render(
            "test_website.test_model_page_layout",
