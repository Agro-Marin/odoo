...
class BlogPost(models.Model):
    ...
    def write(self, vals):
        ...
        for post in self:
            ...
            if (published_in_vals and 'published_date' not in vals and
                ...
                copy_vals['published_date'] = (vals[next(iter(published_in_vals))] and fields.Datetime.now()) or False
    ...
    def copy_data(self, default=None):
        ...
        return [dict(vals, name=self.env._("%s (copy)", blog.name)) for blog, vals in zip(self, vals_list, strict=True)]
