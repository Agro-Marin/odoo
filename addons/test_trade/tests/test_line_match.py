...
class TestLineMatch(TestTradeOrderCase):
    ...
    def _rows(self, order=None, move=None):
        ...
        Match = self.env["test_trade.order.line.match"]
        domain = []
        if order and move:
            domain = [
                "|",
    ...
    def test_opening_a_row_goes_to_the_document_it_came_from(self):
        ...
        self.assertEqual(order_row.action_view_line()["res_model"], "test_trade.order")
