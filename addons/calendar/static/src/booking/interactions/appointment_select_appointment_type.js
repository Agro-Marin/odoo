...
export class AppointmentTypeSelect extends Interaction {
    ...
    async onAppointmentTypeChange(ev) {
        ...
        let messageIntro;
        try {
            messageIntro = await this.waitFor(
            ...
            this.el.querySelector(".o_appointment_intro")?.replaceChildren();
            throw error;
        }
        this.bindDeferred(() => {
            ...
            this.el
                .querySelector(".o_appointment_intro")
                ?.replaceChildren(...parsedElements);
        })();
    }
...
registry
    ...
    .add("calendar.appointment_type_select", AppointmentTypeSelect);
