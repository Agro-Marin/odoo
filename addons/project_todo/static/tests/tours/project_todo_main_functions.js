...
registry.category("web_tour.tours").add("project_todo_main_functions", {
    ...
    steps: () => [
        ...
        {
            trigger:
                ".o_project_task_kanban_view .o_column_quick_create.o_quick_create_folded div",
        ...
        {
            trigger:
                ".o_project_task_kanban_view .o_column_quick_create .o_kanban_header input",
            content: "Create a personal stage from the To-do kanban view",
            run: "edit Stage 1",
        },
        {
        ...
        },
        {
            ...
            content:
                "Drag &amp; drop the card to change the personal task from personal stage.",
        ...
        {
            trigger:
                ".o_breadcrumb .o_control_panel_breadcrumbs_actions button:enabled",
        ...
        {
            trigger:
                ".o_todo_conversion_form_view .o_field_many2one[name=project_id] input",
            content: "Create a new project that will be set to the task",
            run: "edit Project test 1",
        },
        {
            trigger:
                ".o_todo_conversion_form_view .o_field_many2one[name=project_id] li.o_m2o_dropdown_option_create a",
