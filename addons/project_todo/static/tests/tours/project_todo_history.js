...
registry.category("web_tour.tours").add("project_todo_history_tour", {
    ...
    steps: () => [
        ...
        {
            content:
                "Go back to kanban view of todos. this step is added because it takes some time to save the changes, so it's a sort of timeout to wait a bit for the save",
        ...
        {
            content:
                "Verify that 5 revisions are displayed (default empty description after the creation of the todo + 3 edits)",
