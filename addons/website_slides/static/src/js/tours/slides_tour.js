...
registerWebsitePreviewTour(
    ...
    () => [
        ...
        },
        {
            ...
            content: markup(
                _t("Click on the <b>Save</b> button to create your first course."),
            ),
            run: "click",
        },
        {
        ...
        },
        {
            ...
            content: markup(
                _t("First, let's add a <b>Document</b>. It has to be a .pdf file."),
            ),
            tooltipPosition: "bottom",
            run: "click",
        },
        ...
        },
        {
            ...
            content: markup(
                _t("Mark the correct answer by checking the <b>correct</b> mark."),
            ),
        ...
        },
        {
            ...
            content: markup(
                _t("Click on your <b>Course</b> to go back to the table of content."),
            ),
            tooltipPosition: "top",
            run: "click",
        },
        {
            ...
            content: markup(
                _t("Once you're done, don't forget to <b>Publish</b> your course."),
            ),
            tooltipPosition: "bottom",
            run: "click",
        },
        ...
        },
        {
            ...
            content: markup(
                _t("Finally you can click here to enjoy your content in fullscreen"),
            ),
            tooltipPosition: "bottom",
            run: "click",
        },
