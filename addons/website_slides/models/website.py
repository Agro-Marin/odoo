...
class Website(models.Model):
    ...
    def get_suggested_controllers(self):
        ...
        suggested_controllers.append(
            (_("Courses"), self.env["ir.http"]._url_for("/slides"), "website_slides")
        )
