        ...
        self.assertEqual(
            ...
            len(
                channel_publisher.slide_content_ids.filtered(
                    lambda s: s.slide_category == "infographic"
                )
            ),
        )
        self.assertEqual(
...
class TestSlideStatistics(common.SlidesCase):
    ...
    def test_slide_statistics_categories(self):
        ...
        self.assertEqual(
            ...
            len(
                category.channel_id.slide_ids.filtered(
                    lambda s: (
                        s.category_id == category and s.slide_category == "document"
                    )
                )
            ),
        )
        ...
        self.assertEqual(
            category.completion_time, 4.5, "The first category should be 4.5 hours long"
        )
        other_category = (
