/** @odoo-module native */
import { AccountReportDebugPopover } from "@report_formula/components/account_report/line/popover/debug_popover";
...
export class AccountReportLine extends Component {
    static template = "report_formula.AccountReportLine";
    static props = {
        lineIndex: Number,
        line: Object,
    };
