/** @odoo-module native */
import { AccountReportButtonsBar } from "@report_formula/components/account_report/buttons_bar/buttons_bar";
import { AccountReportCogMenu } from "@report_formula/components/account_report/cog_menu/cog_menu";
import { AccountReportController } from "@report_formula/components/account_report/controller";
import { AccountReportEllipsis } from "@report_formula/components/account_report/ellipsis/ellipsis";
import { AccountReportFilters } from "@report_formula/components/account_report/filters/filters";
import { AccountReportHeader } from "@report_formula/components/account_report/header/header";
...
export class AccountReport extends Component {
    static template = "report_formula.AccountReport";
    ...
    getTemplate(name) {
        ...
        return `report_formula.${name}Customizable`;
    }
