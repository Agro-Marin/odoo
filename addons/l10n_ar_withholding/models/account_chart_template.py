...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_ar_base_withholding_account_account(self):
        return self._prepare_csv_vals(
            "ar_base", "account.account", module="l10n_ar_withholding"
        )
    ...
    def _get_ar_ex_withholding_account_tax_group(self):
        return self._prepare_csv_vals(
            "ar_ex", "account.tax.group", module="l10n_ar_withholding"
        )

    @template("ar_ex", "account.tax")
    def _get_ar_ex_withholding_account_tax(self):
        additional = self._prepare_csv_vals(
            "ar_ex", "account.tax", module="l10n_ar_withholding"
        )
