r"""Pre-migration: ``lunch.product`` favorites move onto ``mixin.user.favorite``.
...
``lunch_product_res_users_rel``, with columns ``lunch_product_id`` and
...
OLD_RELATION = "lunch_product_favorite_user_rel"
NEW_RELATION = "lunch_product_res_users_rel"
COLUMNS = (("product_id", "lunch_product_id"), ("user_id", "res_users_id"))
