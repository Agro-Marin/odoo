...
class TestDocTypes(AccountTestInvoicingCommon):
    ...
    def test_credit_note(self):
        self.assertEqual(
            self.invoice.l10n_latam_document_type_id.code, "121", "Not Export e-Invoice"
        )
        ...
        expected_docs = (
            ["122"]
            if self.env["ir.module.module"]._get("l10n_uy_edi").state == "installed"
            else ["122", "222"]
        )
        self.assertEqual(
