...
class AccountMove(models.Model):
    ...
    def _get_starting_sequence(self):
        ...
        if (
            ...
            and self.company_id.tax_config_id.account_fiscal_country_id.code == "UY"
    ...
    def _get_domain_last_sequence(self, relaxed=False):
        ...
        if (
            self.company_id.tax_config_id.account_fiscal_country_id.code == "UY"
    ...
    def _get_domain_l10n_latam_documents(self):
        ...
        if self.country_code == "UY" and (
            ...
            matching_subtype_codes = [
                subtype
                for subtype in UY_DOC_SUBTYPES
            ...
            if matching_subtype_codes:
                ...
                codes = (
                    self.env["l10n_latam.document.type"].search(domain).mapped("code")
                )
