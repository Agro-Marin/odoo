...
class TestAr(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.company_ri.partner_id.write({
            ...
            "zip": '2000',
            "phone_ids": [Command.create({"number": '+1 555 123 8069', "type": "landline"})],
        ...
        cls.res_partner_adhoc = cls.env['res.partner'].create({
            ...
            "phone_ids": [Command.create({"number": "(+54) (341) 208 0203", "type": "landline"})],
        ...
        cls.res_partner_gritti_mono = cls.env['res.partner'].create({
            ...
            "phone_ids": [Command.create({"number": "(+54) (341) 111 2222", "type": "landline"})],
        ...
        cls.res_partner_montana_sur = cls.env['res.partner'].create({
            ...
            "phone_ids": [Command.create({"number": "(+54) (297) 4876 123", "type": "landline"})],
        ...
        cls.res_partner_servicios_globales = cls.env['res.partner'].create({
            ...
            "phone_ids": [Command.create({"number": "(+54) (341) 333 4444", "type": "landline"})],
        ...
        cls.res_partner_barcelona_food = cls.env['res.partner'].create({
            ...
            "phone_ids": [Command.create({"number": "(+00) (11) 222 3333", "type": "landline"})],
        ...
        cls.partner_mipyme = cls.env['res.partner'].create({
            ...
            "phone_ids": [Command.create({"number": "(123)-456-7890", "type": "landline"})],
