...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _prepare_demo_data(self, company=False):
        ...
        if company.tax_config_id.account_fiscal_country_id.code == "AR":
            demo_data = {
    ...
    def _prepare_demo_data_move(self, company=False):
        ...
        if company.tax_config_id.account_fiscal_country_id.code == "AR":
            ...
            data[self.company_xmlid("demo_invoice_equipment_purchase")][
                "l10n_latam_document_number"
            ] = "1-2"
            data[self.company_xmlid("demo_move_auto_reconcile_3")][
                "l10n_latam_document_number"
            ] = "1-3"
            data[self.company_xmlid("demo_move_auto_reconcile_4")][
                "l10n_latam_document_number"
            ] = "1-4"
        return data
