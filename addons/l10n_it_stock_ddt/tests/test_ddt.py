...
class TestDDT(TestSaleCommon):
    ...
    def test_ddt_flow(self):
        ...
        self.assertTrue(
            pick.l10n_it_ddt_number, "The outgoing picking should have a DDT number"
        )
        self.inv1 = self.so._create_invoices()
        self.inv1.action_post()
        self.assertEqual(
            self.inv1.l10n_it_ddt_ids.ids,
            pick.ids,
            "DDT should be linked to the invoice",
        )
    ...
    def test_ddt_flow_2(self):
        ...
        self.assertEqual(
            invoice_1.l10n_it_ddt_ids.ids,
            picking_1.ids,
            "DDT picking_1 should be linked to the invoice_1",
        )
        self.assertEqual(
            invoice_2.l10n_it_ddt_ids.ids,
            picking_2.ids,
