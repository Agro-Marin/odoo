...
patch(AddProductToWishlistButton.prototype, {
    ...
    async addProduct() {
        ...
        const saveForLaterButton = document.querySelector(
            "#wsale_save_for_later_button",
        );
        const addedToWishListAlert = document.querySelector(
            "#wsale_added_to_your_wishlist_alert",
        );
