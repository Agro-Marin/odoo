...
class TestEmployeeDeleteWizard(TestHrCommon):
    ...
    def test_delete_wizard_single_employee_with_timesheet(self):
        ...
        self.assertEqual(
            returned_action_Record["context"]["active_ids"],
            [employee_A.id],
            "Employee should have been selected",
        )
        self.assertEqual(
            returned_action_Record["context"]["employee_termination"],
            True,
            "Employee Termination should have been set",
        )
