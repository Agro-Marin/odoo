...
class TestProjectProject(TransactionCase):
    def test_create_projects(self):
        ...
        self.assertFalse(
            project1.account_id, "Project 1 should not have an analytic account"
        )
        self.assertTrue(
            project2.account_id, "Project 2 should have an analytic account"
        )
        self.assertEqual(
            project2.name,
        ...
        self.assertFalse(
            project3.account_id, "Project 3 should not have an analytic account"
        )
        self.assertTrue(
            project4.account_id, "Project 4 should have an analytic account"
        )
        self.assertEqual(
            project4.name,
    ...
    def test_create_projects_with_default_analytic_account(self):
        project_plan_id = int(
            ...
            .sudo()
            .get_param("analytic.analytic_plan_projects")
        )
        ...
        project1, project2 = (
            ...
            .with_context(default_account_id=analytic_account.id)
            .create(
                [
                    {
                        "name": "Project 1 (no timesheets)",
        ...
        self.assertEqual(
            project1.account_id,
            analytic_account,
            "Project 1 should have the default analytic account",
        )
        self.assertEqual(
            project2.account_id,
            analytic_account,
            "Project 2 should have the default analytic account",
        )
    ...
    def test_compute_total_timesheet_time(self):
        ...
        self.assertEqual(
            project.total_timesheet_time,
            0.75,
            "The total timesheet time should be 0.75 (00:45) hours.",
        )
