...
class TestAccountMoveDE(AccountTestInvoicingCommon):
    ...
    def test_missing_invoice_delivery_date(self):
        ...
        move = (
            ...
            .with_context(company_id=self.company_data["company"].id)
            .create(
                {
    ...
    def test_out_invoice_custom_currency_rate_with_missing_delivery_date(self):
        ...
        if not self.env["ir.module.module"].search(
            [("name", "=", "l10n_hu_edi"), ("state", "=", "installed")]
        ):
            self.skipTest(
                "This test requires the installation of the l10n_hu_edi module."
            )
