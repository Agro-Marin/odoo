...
class TestDeliveryCost(DeliveryCommon, SaleCommon):
    ...
    def test_01_taxes_on_delivery_cost(self):
        ...
        self.assertRecordValues(sale_order.line_ids, [{'price_subtotal': 9.09, 'price_total': 10.45}])
    ...
    def test_get_invalid_delivery_weight_lines(self):
        ...
        order.line_ids = [
            *[Command.create({
            ...
            }) for product, combo in zip(self.product + weightless_product, combos, strict=True)],
