    ...
    steps: () => [
        {
            ...
            trigger:
                "div[name='child_ids'] .o_org_chart_entry button > .badge:contains('2')",
            run: "click",
        },
        {
            content: "Click Indirect Subordinates",
            trigger:
                ".o_org_chart_popup a.o_employee_sub_redirect[data-type='indirect']",
            run: "click",
        },
    ],
});
registry.category("web_tour.tours").add("employee_view_access_multicompany", {
    steps: () => [
        ...
        },
        {
            ...
            trigger:
                "div[name='child_ids'] .o_org_chart_entry button > .badge:contains('1')",
            run: "click",
        },
    ],
});
