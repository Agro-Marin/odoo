    ...
    def create(self, vals_list):
        ...
        for i, (st_line, vals) in enumerate(zip(st_lines, vals_list)):
            ...
            with self.env.protecting(
                self.env["account.move"]._get_protected_vals(vals, st_line)
            ):
    ...
    def _synchronize_from_moves(self, changed_fields):
        ...
        for st_line in self.with_context(skip_account_move_synchronization=True):
            ...
            if "line_ids" in changed_fields:
                ...
                journal_currency = (
                    st_line.journal_id.currency_id
                    if st_line.journal_id.currency_id != company_currency
                    else False
                )
            ...
            st_line.write(
                move._cleanup_write_orm_values(st_line, st_line_vals_to_write)
            )
