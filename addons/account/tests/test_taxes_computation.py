...
class TestTaxesComputation(TestTaxCommon):
    ...
    def test_random_case_1(self):
        tax_percent_8_price_included = self.percent_tax(
            8.0, price_include_override="tax_included"
        )
        tax_percent_0_price_included = self.percent_tax(
            0.0, price_include_override="tax_included"
        )
    ...
    def test_random_case_2(self):
        tax_percent_5_price_included = self.percent_tax(
            5.0, price_include_override="tax_included"
        )
    ...
    def test_random_case_3(self):
        ...
        tax_percent_5_5_price_included = self.percent_tax(
            5.5, price_include_override="tax_included"
        )
    ...
    def test_random_case_4(self):
        tax_percent_12_price_included = self.percent_tax(
            12.0, price_include_override="tax_included"
        )
    ...
    def test_random_case_5(self):
        ...
        tax_percent_19_price_included = self.percent_tax(
            19.0, price_include_override="tax_included"
        )
        currency_dp_0 = 1.0
        ...
        self.assert_taxes_computation(
            ...
            27000.0,
            {
                ...
                "taxes_data": ((22689.07563, 4310.92437),),
            },
            rounding_method="round_globally",
        )
        self.assert_taxes_computation(
            ...
            10920.0,
            {
                ...
                "taxes_data": ((9176.470588, 1743.529412),),
            },
            rounding_method="round_globally",
        )
        self._run_js_tests()
    ...
    def test_random_case_6(self):
        tax_percent_20_price_included = self.percent_tax(
            20.0, price_include_override="tax_included"
        )
        ...
        self.assert_taxes_computation(
            ...
            399.999999,
            {
                ...
                "taxes_data": ((333.3333325, 66.6666665),),
            },
            rounding_method="round_globally",
        )
        self._run_js_tests()
    ...
    def test_random_case_7(self):
        tax_percent_21_price_included = self.percent_tax(
            21.0, price_include_override="tax_included"
        )
        currency_dp_6 = 0.000001
    ...
    def test_random_case_9(self):
        tax_division_100 = self.division_tax(
            100.0, price_include_override="tax_included"
        )
    ...
    def test_fixed_tax_price_included_affect_base_on_0(self):
        tax = self.fixed_tax(
            0.05, price_include_override="tax_included", include_base_amount=True
        )
        self.assert_taxes_computation(
            tax,
            0.0,
