...
class TestFiscalCountryCodes(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.other_company.tax_config_id.account_fiscal_country_id = cls.quick_ref(
            "base.be"
        )
    ...
    def test_control_the_two_companies_have_different_fiscal_countries(self):
        self.assertNotEqual(
            ...
            self.other_company.tax_config_id.account_fiscal_country_id,
    ...
    def test_every_model_answers_for_the_active_companies(self):
        wanted = self.other_company.tax_config_id.account_fiscal_country_id.code
    ...
    def test_a_company_bound_record_answers_for_its_own_company(self):
        ...
        self.assertEqual(
            ...
            self.other_company.tax_config_id.account_fiscal_country_id.code,
        )
