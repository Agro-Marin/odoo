...
class TestCashFlowReport(TestAccountReportsCommon):
    ...
    def setUpClass(cls):
        ...
        cls.report = cls.env.ref("account.cash_flow_report")
    ...
    def test_growth_comparison(self):
        """Test the growth comparison column works on a report with dynamic lines."""
        ...
        options = self._update_comparison_filter(
            options, self.report, "previous_period", 1
        )
                ...
                "line_ids": [
                    ...
                    (
                        ...
                        0,
                        {
                            "debit": 0.0,
                            "credit": 200.0,
                            "account_id": self.account_no_tag.id,
                        },
                    ),
                ],
            }
    ...
    def test_cash_flow_comparison(self):
        ...
        options = self._update_comparison_filter(
            options, self.report, comparison_type="previous_period", number_period=1
        )
        ...
        self._reconcile_on(
            (invoice_current_period + payment_current_period).line_ids,
            self.account_receivable_1,
        )
        ...
        self._reconcile_on(
            (invoice_past_period + payment_past_period).line_ids,
            self.account_receivable_1,
        )
    ...
    def test_cash_flow_column_groups(self):
        ...
        options = self._generate_options(
            self.report,
            fields.Date.from_string("2016-01-01"),
            fields.Date.from_string("2016-01-31"),
        )
        options = self._update_comparison_filter(
            options, self.report, comparison_type="previous_period", number_period=1
        )
                ...
                "line_ids": [
                    ...
                    (
                        ...
                        0,
                        {
                            "debit": 0.0,
                            "credit": 1000.0,
                            "account_id": self.account_operating.id,
                        },
                    ),
                ],
            }
        ...
        self._reconcile_on(
            (invoice_previous_period + payment_previous_period).line_ids,
            self.account_receivable_1,
        )
    ...
    def test_cash_flow_multi_company_multi_currency_unfolding(self):
        ...
        for company_data in (self.company_data, self.company_data_2, company_data_3):
                        ...
                        "line_ids": [
                            ...
                            (
                                ...
                                0,
                                {
                                    "debit": 0.0,
                                    "credit": 1150.0,
                                    "account_id": account_operating.id,
                                },
                            ),
                        ],
                    }
            ...
            payment.action_post()
            self._reconcile_on(
                (invoice + payment).line_ids, company_data["default_account_receivable"]
            )
    ...
    def test_cash_flow_tricky_case_1(self):
        """Test the cash flow report when:

        - reconciling multiple payments.
        - dealing with multiple receivable lines.
        - dealing with multiple partials on the same line.
        - making an advance payment.
        - adding entries after the report date.
        """
        options = self._generate_options(
            self.report,
            fields.Date.from_string("2016-01-01"),
    ...
    def test_cash_flow_tricky_case_2(self):
        ...
        - dealing with multiple receivable accounts.
        - making a reconciliation involving multiple liquidity moves.
        """
        options = self._generate_options(
            self.report,
            fields.Date.from_string("2016-01-01"),
                ...
                "line_ids": [
                    ...
                    (
                        ...
                        0,
                        {
                            "debit": 0.0,
                            "credit": 250.0,
                            "account_id": self.account_receivable_3.id,
                        },
                    ),
                    (
                        0,
                ...
                "line_ids": [
                    ...
                    (
                        ...
                        0,
                        {
                            "debit": 4500.0,
                            "credit": 0.0,
                            "account_id": self.account_financing.id,
                        },
                    ),
                    (
                        0,
        ...
        self._reconcile_on(
            (misc_move + liquidity_move_1).line_ids, self.account_receivable_1
        )
        ...
        self._reconcile_on(
            (misc_move + liquidity_move_2).line_ids, self.account_receivable_2
        )
        ...
        self._reconcile_on(
            (liquidity_move_1 + liquidity_move_2).line_ids, self.account_receivable_3
        )
    ...
    def test_cash_flow_tricky_case_3(self):
        ...
        - reconciling entries on a non receivable/payable account.
        - dealing with unusual liquidity moves.
        """
        move_1 = self.env["account.move"].create(
            {
                "move_type": "entry",
        ...
        options = self._generate_options(
            self.report,
            fields.Date.from_string("2016-01-01"),
            fields.Date.from_string("2016-02-01"),
        )
    ...
    def test_cash_flow_tricky_case_4(self):
        """Check the liquidity move paying the misc move at 1000 / 3000 = 1/3.

        The sign matters here: the 3000 in credit must become 1000 in debit.
        """
        options = self._generate_options(
            self.report,
            fields.Date.from_string("2016-01-01"),
        ...
        self._reconcile_on(
            move_1.line_ids.filtered("credit") + move_2.line_ids, self.account_financing
        )
    ...
    def test_cash_flow_tricky_case_5(self):
        """Same as test_cash_flow_tricky_case_4 with reversed debit/credit."""
        options = self._generate_options(
            self.report,
            fields.Date.from_string("2016-01-01"),
            fields.Date.from_string("2016-01-01"),
        ...
        self._reconcile_on(
            move_1.line_ids.filtered("debit") + move_2.line_ids, self.account_financing
        )
    ...
    def test_cash_flow_tricky_case_6(self):
        """Test the additional lines on liquidity moves (e.g. bank fees) are correctly reported."""
        options = self._generate_options(
            self.report,
            fields.Date.from_string("2016-01-01"),
            fields.Date.from_string("2016-01-01"),
                    ...
                    "line_ids": [
                        ...
                        (
                            ...
                            0,
                            {
                                "debit": 0.0,
                                "credit": 1000.0,
                                "account_id": self.account_investing.id,
                            },
                        ),
                        (
                            0,
    ...
    def test_cash_flow_tricky_case_7(self):
        """Test cross reconciliation between liquidity moves with additional lines when the liquidity
        account is reconcilable.
        """
        options = self._generate_options(
            self.report,
            fields.Date.from_string("2016-01-01"),
    ...
    def test_cash_flow_tricky_case_8(self):
        ...
        - the liquidity moves are reconciled to a move having a total amount of 0.0.
        - the liquidity and the misc moves are reconciled twice.
        - the reconciliations are partial.
        ...
        self._reconcile_on(
            move_1.line_ids + move_2.line_ids.filtered("debit"), self.account_no_tag
        )
        self._reconcile_on(
            move_1.line_ids + move_2.line_ids.filtered("debit"), self.account_financing
        )
    ...
    def test_cash_flow_tricky_case_9(self):
        ...
        self._reconcile_on(
            move_1.line_ids + move_2.line_ids.filtered("credit"), self.account_no_tag
        )
        self._reconcile_on(
            move_1.line_ids + move_2.line_ids.filtered("credit"), self.account_financing
        )
    ...
    def test_cash_flow_handle_multiple_tags(self):
        """Ensure the balances are correct when:

        - several non-cash-flow-report account tags are set.
        - a mix of several non-cash-flow-report tags and one cash flow report tag is set.
        """
        ...
        (self.account_no_tag + self.account_financing).write(
            {
                "tag_ids": [
                    Command.link(unrelated_tag_1.id),
                    Command.link(unrelated_tag_2.id),
                ],
            }
        )
    ...
    def test_cash_flow_hierarchy(self):
        """Test the 'hierarchy' option gives each report section (e.g. "Cash and cash equivalents,
        beginning of period" and "Cash and cash equivalents, closing balance") its own dedicated
        ...
        self.env["account.group"].create(
            [
                {
                    "name": "Group Bank & Cash",
                    "code_prefix_start": "10",
                    "code_prefix_end": "10",
                },
                {
                    "name": "Group Bank",
                    "code_prefix_start": "1014",
                    "code_prefix_end": "1014",
                },
                {
                    "name": "Group Cash",
                    "code_prefix_start": "1015",
                    "code_prefix_end": "1015",
                },
            ]
        )
        ...
        expected_values_wo_hierarchy = [
            ...
            {
                "name": "Total Cash and cash equivalents, beginning of period",
                "level": 1,
                "book_value": "$\xa0150.00",
            },
            {
            ...
            {"name": "10150199 Cash", "level": 1, "book_value": "$\xa050.00"},
            {
                "name": "Total Cash and cash equivalents, closing balance",
                "level": 1,
                "book_value": "$\xa0150.00",
            },
        ]
