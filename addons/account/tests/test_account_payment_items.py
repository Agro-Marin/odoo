...
class TestAccountPaymentItems(AccountTestInvoicingCommon):
                ...
                "invoice_line_ids": [
                    (
                        ...
                        0,
                        {
                            ...
                            "price_unit": 100,
                            "tax_ids": [],
                            "discount_date": date(2023, 3, 1)
                            + timedelta(days=discount_days)
                            if discount_days
                            else False,
    ...
    def test_payment_date(self):
        ...
        self.assertEqual(
            str(self.late_discount_bill.line_ids[0].payment_date), "2023-04-20"
        )
    ...
    def test_search_payment_date(self):
        for today, search, expected in [
            ...
            (
                ...
                + self.late_bill
                + self.discount_bill
                + self.late_discount_bill,
            ),
            ("2023-03-15", "2023-03-01", self.late_bill),
            (
                "2023-03-15",
                "2023-03-30",
                self.bill + self.late_bill + self.discount_bill,
            ),
