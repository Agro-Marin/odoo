...
registry.category("web_tour.tours").add("account_accountant_bank_rec_widget", {
    ...
    steps: () => [
        ...
        {
            content:
                "Statement line is reconciled because move with same partner and amount",
...
registry
    ...
    .add("account_accountant_set_partner_with_child_contact", {
        url: "/odoo",
        steps: () => [
            stepUtils.showAppsMenuItem(),
            ...accountTourSteps.goToAccountMenu("Open the accounting module"),
            ...
            },
            {
                ...
                trigger:
                    "body:not(:has(tbody > tr > td[name='complete_name']:contains('test child contact')))",
            },
        ],
    });
