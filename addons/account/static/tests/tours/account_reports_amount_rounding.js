    ...
    steps: () => [
        {
            ...
            trigger:
                '.line_name:contains("Receivables") + .line_cell:contains("1,150,000.00")',
            run: "click",
        },
        // Units
        {
        ...
        },
        {
            ...
            trigger:
                '.line_name:contains("Receivables") + .line_cell:contains("1,150,000")',
            run: "click",
        },
        // Thousands
        {
        ...
        {
            trigger:
                '.line_name:contains("Receivables") + .line_cell:not(:contains("1,150,000"))',
        },
        {
            ...
            // We check the new value.
            trigger:
                '.line_name:contains("Receivables") + .line_cell:contains("1,150")',
            run: "click",
        },
        // Millions
        {
        ...
        {
            trigger:
                '.line_name:contains("Receivables") + .line_cell:not(:contains("1,150"))',
        },
        {
