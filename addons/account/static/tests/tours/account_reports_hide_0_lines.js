...
registry.category("web_tour.tours").add("account_reports_hide_0_lines", {
    url: "/odoo/action-account.action_account_report_bs",
    steps: () => [
        {
        ...
        {
            content:
                "test if the Current Year Unallocated Earnings line is present (but the value is 0)",
            trigger: '.line_name:contains("Current Year Unallocated Earnings")',
            run: "click",
        },
        {
            content:
                "test if the Earnings line is present (but value is different from 0 and so should be there after the hide_0_lines",
        ...
        {
            content:
                "test if the Current Year Unallocated Earnings line is not present",
        ...
        {
            content:
                "test again if the Bank and Cash line is present (but the value is 0)",
            trigger: '.line_name:contains("Bank and Cash Accounts")',
            run: () => null,
        },
    ],
...
registry
    ...
    .add("account_reports_hide_0_lines_with_string_columns", {
        url: "/odoo/action-account.action_account_report_general_ledger",
        steps: () => [
            {
                content:
                    "Check if the 211000 Account Payable line is present (but the value is 0)",
                trigger: ".name:contains('211000 Account Payable')",
                run: "click",
            },
            {
                content:
                    "Check if the MISC item line is present with string values set up, but all amounts are at 0",
            ...
            {
                content:
                    "Check again if the MISC item line is present (but the value is 0)",
                trigger: ".name:contains('Coucou les biloutes')",
            },
        ],
    });
...
registry.category("web_tour.tours").add("account_reports_hide_0_lines_load_more", {
    ...
    steps: () => [
        ...
        {
            content:
                "Check if the first MISC item line is present with string values set up, but all amounts are at 0",
            trigger: ".name:contains('Coucou les biloutes 0')",
        },
        {
            content: "Check if the Load more line is present",
        ...
        {
            content:
                "Check if the second MISC item line is present with string values set up, but all amounts are at 0",
