...
export function showProductColumn() {
    ...
    return [
        ...
        },
        {
            ...
            trigger:
                '.o-dropdown-item input[name="product_id"], .o-dropdown-item input[name="product_template_id"]',
...
export function addSectionFromProductCatalog() {
    return [
        ...
        },
        {
            ...
            trigger:
                '.o_search_panel_sections .o_selected_section:contains("Section A")',
        },
        {
        ...
        },
        {
            ...
            trigger:
                '.o_kanban_record:contains("Test Product"):not(:has(.fa-shopping-cart))',
        },
        {
        ...
        },
        {
            ...
            trigger:
                '.o_section_and_note_list_view tbody tr:nth-child(2):contains("Test Product")',
        },
    ];
}
