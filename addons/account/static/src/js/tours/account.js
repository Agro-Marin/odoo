...
registry.category("web_tour.tours").add("account_tour", {
    url: "/odoo",
    steps: () => [
        ...accountTourSteps.goToAccountMenu(
            markup(
                _t(
        ...
        ...accountTourSteps.newInvoice(),
        {
            ...
            content: markup(
                _t(
                    "Write a customer name to <b>create one</b> or <b>see suggestions</b>.",
                ),
            ),
        ...
        },
        {
            ...
            content: markup(
                _t(
                    "Once everything is set, you are good to continue. You will be able to edit this later in the <b>Customers</b> menu.",
                ),
            ),
            run: "click",
        },
        ...
        },
        {
            ...
            content: _t(
                "Send the invoice to the customer and check what he'll receive.",
            ),
            tooltipPosition: "bottom",
            run: "click",
        },
        {
            ...
            content: markup(
                _t("Write here <b>your own email address</b> to test the flow."),
            ),
