...
patch(accountTourSteps, {
    ...
    endSteps() {
        return [
            {
                trigger:
                    ".dropdown-item[data-menu-xmlid='account.menu_board_journal_1']",
...
registry.category("web_tour.tours").add("account_accountant_tour", {
    ...
    steps: () => [
        ...
        // While not ideal, it is ok, since that means the user obviously knows how to create a vendor bill...
        {
            ...
            content: markup(
                _t(
                    "Create your first vendor bill.<br/><br/><i>Tip: If you don’t have one on hand, use our sample bill.</i>",
                ),
            ),
            tooltipPosition: "bottom",
            run: "click",
        },
        {
            ...
            content: _t(
                "After the data extraction, check and validate the bill. If no vendor has been found, add one before validating.",
            ),
            tooltipPosition: "bottom",
            run: "click",
        },
        ...
        {
            trigger:
                ".o_bank_rec_widget_kanban_view div[name=payment_ref] input[id=payment_ref_0]",
        ...
        },
        {
            isActive: ["auto"],
            trigger:
                ".o_kanban_renderer:not(:has(.o_bank_reconciliation_quick_create))",
        },
        {
            isActive: ["auto"],
            trigger: ".o_bank_reconciliation_container",
        ...
        {
            trigger:
                ".o_bank_rec_widget_kanban_view div[name='bank_statement_line']:first",
