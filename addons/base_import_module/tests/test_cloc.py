...
class TestClocFields(test_cloc.TestClocCustomization):
    ...
    def test_fields_from_studio(self):
        ...
        cl.count_customization(self.env)
        self.assertEqual(
            cl.code.get("studio_customization", 0),
            0,
            "Don't count field generated by studio",
        )
        ...
        self.assertEqual(
            cl.code.get("studio_customization", 0),
            1,
            "Count manual field created via studio",
        )
    ...
    def test_count_qweb_imported_module(self):
        ...
        cl.count_customization(self.env)
        self.assertEqual(
            cl.code.get("test_imported_module", 0),
            5,
    ...
    def test_count_attachment_imported_module(self):
        ...
        with ZipFile(stream, "w") as archive:
            ...
            archive.writestr(
                "test_imported_module/static/src/js/test.js", test_cloc.JS_TEST
            )
            archive.writestr(
                "test_imported_module/static/src/js/test.scss", test_cloc.SCSS_TEST
            )
    ...
    def test_exclude_qweb(self):
        ...
        self.assertEqual(
            cl.code.get("test_imported_module", 0),
            0,
            "Do not count view with cloc_exclude",
        )
    ...
    def test_exclude_cloc_imported_module(self):
        ...
        attachments = self.env["ir.attachment"].search(
            [("url", "ilike", "test_imported_module/static/src/js/test_js")]
        )
        self.assertFalse(
            attachments, "No more attachment from assets should remain in the db"
        )
        ...
        irmodeldata = self.env["ir.model.data"].search(
