...
class L10nHuEdiTestCommon(AccountTestInvoicingCommon):
    ...
    def _create_simple_move(self, move_type="out_invoice", currency=None, amount=None):
        journal = (
            ...
            else self.company_data["default_journal_purchase"]
        )
    ...
    def create_invoice_simple(self, currency=None, amount=None):
        ...
        return self._create_simple_move(
            move_type="out_invoice", currency=currency, amount=amount
        )
        ...
        return self.env["account.move"].create(
            {
                ...
                "invoice_cash_rounding_id": self.env.ref(
                    "l10n_hu_edi.cash_rounding_1_huf"
                ).id,
                "invoice_line_ids": [
                    Command.create(
                        {
    ...
    def create_reversal(self, invoice, is_modify=False, amount=None):
        ...
        if amount:
            reversal_moves.invoice_line_ids.write({"price_unit": amount})
    ...
    def create_debit_note(self, invoice, amount=None):
        ...
        if amount:
            debit_note.invoice_line_ids.write({"price_unit": amount})
        return debit_note
    ...
    def create_cancel_wizard(self):
        ...
        cancel_wizard = (
            ...
            .with_context({"default_invoice_id": invoice.id})
            .create(
                {
                    "code": "ERRATIC_DATA",
                    "reason": "Some reason...",
