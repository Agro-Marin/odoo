...
class UtmCampaign(models.Model):
    ...
    def _compute_mailing_sms_count(self):
        ...
        for campaign in self:
            ...
            campaign.ab_testing_mailings_sms_count = sum(
                ab_testing_mapped_sms_data[campaign.id]
            )
    ...
    def _cron_process_mass_mailing_ab_testing(self):
        ...
        for campaign in ab_testing_campaign:
            ab_testing_mailings = campaign.mailing_sms_ids.filtered(
...
class UtmMedium(models.Model):
    ...
    def _unlink_except_utm_medium_sms(self):
        utm_medium_sms = self.env.ref(
            "mass_mailing_sms.utm_medium_sms", raise_if_not_found=False
        )
    ...
    def SELF_REQUIRED_UTM_MEDIUMS_REF(self):
        return super().SELF_REQUIRED_UTM_MEDIUMS_REF | {
            "mass_mailing_sms.utm_medium_sms": "SMS"
        }
