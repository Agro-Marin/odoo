...
registry
    ...
    .add("test_basic_purchase_flow_with_minimal_access_rights", {
        steps: () => [
            ...
            {
                trigger:
                    ".o_statusbar_status .o_arrow_button_current:contains(Purchase Order)",
            },
            {
                ...
                run: async () => {
                    ...
                    await inputFiles(".o_widget_purchase_file_uploader input", [
                        testFile,
                    ]);
                },
            },
            {
                ...
                trigger:
                    ".o_statusbar_status:contains(Posted) .o_arrow_button_current:contains(Draft)",
            },
            {
