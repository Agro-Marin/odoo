...
class PurchaseOrder(models.Model):
    ...
    def _merge_get_line_key(self, line):
        ...
        return (
            ...
            frozenset(line.analytic_distribution.items()) if line.analytic_distribution else frozenset(),
            line.discount,
        )
    ...
    def _create_supplier_to_product(self):
        ...
        for line in self.line_ids:
            ...
            if (
                ...
                and len(line.product_id.seller_ids) <= const.MAX_SUPPLIERS_PER_PRODUCT
            ):
