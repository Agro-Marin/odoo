...
class PurchaseOrderLine(models.Model):
    ...
    # Section-related fields (sequence, display_type, is_downpayment,
    # is_expense provided by order.line.fields.mixin)
    ...
    # product_uom_qty provided by order.line.amount.mixin
    ...
    # price_subtotal, price_tax, price_total provided by order.line.amount.mixin
    # price_unit_discounted_*, qty_transferred_method provided by mixin
    qty_transferred_method = fields.Selection(string="Received Qty Method")
    ...
    # qty_invoiced, qty_to_invoice provided by order.line.invoice.mixin
    ...
    # amount_taxexc/taxinc_invoiced/to_invoice provided by order.line.invoice.mixin
    amount_to_invoice_at_date = fields.Float(
        string="Amount",
        compute="_compute_amount_to_invoice_at_date",
    )
    # invoice_state provided by order.line.invoice.mixin
    ...
    def write(self, vals):
        # Write validation handled by order.line.fields.mixin.write via MRO
    ...
    # _compute_parent_id provided by order.line.fields.mixin
    ...
    # _compute_product_uom_qty provided by order.line.amount.mixin
    ...
    # _compute_amounts provided by order.line.amount.mixin (batched by company)
    # _compute_price_unit_discounted_* provided by order.line.amount.mixin
    ...
    # _get_invoice_lines provided by order.line.invoice.mixin
    ...
    # _get_protected_fields provided by order.line.fields.mixin
    ...
    # _get_posted_invoice_lines provided by order.line.invoice.mixin

    def _get_price_precision(self):
        """Override: include currency decimal places for multi-currency accuracy."""
        self.ensure_one()
        return max(self.currency_id.decimal_places, super()._get_price_precision())
    ...
    # _merge_order_line provided by order.line.fields.mixin
    # (replaces old _merge_po_line)
    ...
    # _prepare_base_line_for_taxes_computation provided by order.line.amount.mixin
    ...
    # _check_line_unlink provided by order.line.fields.mixin
    ...
    # Write validation (_validate_write_vals, _get_validate_write_vals_methods,
    # _validate_write_display_type, _validate_write_locked_order) provided by
    # order.line.fields.mixin
