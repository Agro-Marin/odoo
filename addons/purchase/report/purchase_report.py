...
class PurchaseReport(models.Model):
    ...
    def _table_query(self) -> SQL:
        ...
        with_clause = self._with_purchase()
        if with_clause:
            return SQL(
                "WITH %s ( %s %s %s %s )",
                with_clause,
    ...
    def _select_purchase(self) -> SQL:
        ...
        base_select = SQL(
            ...
            SELECT
                ...
                )::decimal(16,2) * account_currency_table.rate AS price_unit,
                (
                    SUM(
                ...
                )::decimal(16,2) * account_currency_table.rate AS price_subtotal,
                COUNT(*) AS nbr_lines
            """,
        )
    ...
    def _from_purchase(self) -> SQL:
        ...
        return SQL(
            ...
            FROM
                ...
                LEFT JOIN %(currency_table)s ON o.company_id=account_currency_table.company_id
    ...
    def _group_by_purchase(self) -> SQL:
