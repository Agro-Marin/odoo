...
class TestFormattedReadGroup(common.TransactionCase):
    ...
    def test_limit_offset(self):
        ...
        self.assertEqual(
            Model.formatted_read_group(
                [], groupby=["key"], aggregates=["value:sum"], limit=2
            ),
            [
                {
    ...
    def test_groupby_date_part_number(self):
        ...
        self.assertEqual(
            ...
            [
                {
                    "datetime:hour_number": 13,
                    "__extra_domain": [("datetime.hour_number", "=", 13)],
                    "__count": 2,
                },
                {
                    "datetime:hour_number": 14,
                    "__extra_domain": [("datetime.hour_number", "=", 14)],
                    "__count": 2,
                },
                {
                    "datetime:hour_number": 15,
                    "__extra_domain": [("datetime.hour_number", "=", 15)],
                    "__count": 3,
                },
                {
        ...
        self.assertEqual(
            ...
            [
                {
                    "date:day_of_year": 29,
                    "__extra_domain": [("date.day_of_year", "=", 29)],
                    "__count": 3,
                },
                {
                    "date:day_of_year": 30,
                    "__extra_domain": [("date.day_of_year", "=", 30)],
                    "__count": 1,
                },
                {
                    "date:day_of_year": 31,
                    "__extra_domain": [("date.day_of_year", "=", 31)],
                    "__count": 1,
                },
                {
                    "date:day_of_year": 32,
                    "__extra_domain": [("date.day_of_year", "=", 32)],
                    "__count": 1,
                },
                {
                    "date:day_of_year": 149,
                    "__extra_domain": [("date.day_of_year", "=", 149)],
                    "__count": 1,
                },
                {
                    "date:day_of_year": False,
                    "__extra_domain": [("date.day_of_year", "=", False)],
                    "__count": 1,
                },
            ],
        )
        ...
        self.assertEqual(
            ...
            [
                {
                    "date:day_of_month": 1,
                    "__extra_domain": [("date.day_of_month", "=", 1)],
                    "__count": 1,
                },
                {
                    "date:day_of_month": 29,
                    "__extra_domain": [("date.day_of_month", "=", 29)],
                    "__count": 4,
                },
                {
                    "date:day_of_month": 30,
                    "__extra_domain": [("date.day_of_month", "=", 30)],
                    "__count": 1,
                },
                {
                    "date:day_of_month": 31,
                    "__extra_domain": [("date.day_of_month", "=", 31)],
                    "__count": 1,
                },
                {
                    "date:day_of_month": False,
                    "__extra_domain": [("date.day_of_month", "=", False)],
                    "__count": 1,
                },
            ],
        )
        ...
        self.assertEqual(
            ...
            [
                ...
                {
                    "date:day_of_week": 2,
                    "__extra_domain": [("date.day_of_week", "=", 2)],
                    "__count": 1,
                },
                {
                    "date:day_of_week": 6,
                ...
                },
                {
                    ...
                    "__extra_domain": [("date.day_of_week", "=", False)],
                    "__count": 1,
                },
            ],
        )
        ...
        self.assertEqual(
            ...
            [
                {
                    "date:iso_week_number": 4,
                    "__extra_domain": [("date.iso_week_number", "=", 4)],
                    "__count": 4,
                },
                {
                    "date:iso_week_number": 5,
                    "__extra_domain": [("date.iso_week_number", "=", 5)],
                    "__count": 2,
                },
                {
                    "date:iso_week_number": 21,
        ...
        self.assertEqual(
            ...
            [
                {
                    "date:month_number": 1,
                    "__extra_domain": [("date.month_number", "=", 1)],
                    "__count": 5,
                },
                {
                    "date:month_number": 2,
                    "__extra_domain": [("date.month_number", "=", 2)],
                    "__count": 1,
                },
                {
                    "date:month_number": 5,
                    "__extra_domain": [("date.month_number", "=", 5)],
                    "__count": 1,
                },
                {
                    "date:month_number": False,
                    "__extra_domain": [("date.month_number", "=", False)],
                    "__count": 1,
                },
            ],
        )
            ...
            [
                {
                    ...
                    "__extra_domain": [("date.quarter_number", "=", 1)],
                    "__count": 6,
                },
                {
                    "date:quarter_number": 2,
                    "__extra_domain": [("date.quarter_number", "=", 2)],
                    "__count": 1,
                },
                {
            ...
            [
                {
                    ...
                    "__extra_domain": [("date.year_number", "=", 2022)],
                    "__count": 6,
                },
                {
                    "date:year_number": 2023,
                    "__extra_domain": [("date.year_number", "=", 2023)],
                    "__count": 1,
                },
                {
                    "date:year_number": False,
                    "__extra_domain": [("date.year_number", "=", False)],
                    "__count": 1,
                },
            ],
        )
    ...
    def test_groupby_datetime_part_with_timezone(self):
        ...
        result = Model.with_context({"tz": "Pacific/Auckland"}).search(
    ...
    def test_related(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                {
                    "__count": 2,
                    "__extra_domain": [("foo_id_name_sudo", "=", False)],
                    "foo_id_name_sudo": False,
                },
            ],
        )
        ...
        for fname in (
            ...
            expected = [
                {
                    "__count": 3,
                    "__extra_domain": [(fname, "=", "bar_a")],
                    fname: "bar_a",
                },
                {
                    "__count": 2,
                    "__extra_domain": [(fname, "=", False)],
                    fname: False,
                },
            ]
        ...
        self.assertEqual(
            RelatedBase.formatted_read_group(
                [], aggregates=["foo_id_bar_id_name:count_distinct"]
            ),
            [
                {
                    "__extra_domain": [(1, "=", 1)],
                    "foo_id_bar_id_name:count_distinct": 1,
                }
            ],
        )
    ...
    def test_inherited(self):
        ...
        self.assertEqual(
            ...
            [
                {
                    "__count": 3,
                    "__extra_domain": [("name", "=", "a")],
                    "name": "a",
                },
                {
                    "__count": 1,
                    "__extra_domain": [("name", "=", "b")],
                    "name": "b",
                },
                {
                    "__count": 1,
                    "__extra_domain": [("name", "=", False)],
                    "name": False,
                },
            ],
        )
    ...
    def test_related_many2many_groupby(self):
        ...
        bars = self.env["test_read_group.related_bar"].create(
            [
                ...
                {
                    "base_ids": [
                        Command.link(bases[0].id),
                        Command.link(bases[1].id),
                    ]
                },
    ...
    def test_order_by_many2one_id_perf(self):
        ...
        with self.assertQueries([expected_query + " DESC"]):
            OrderLine.formatted_read_group(
        ...
        expected_query = """
            ...
            GROUP BY "test_read_group_order_line"."order_id"
            ORDER BY ANY_VALUE((COALESCE("test_read_group_order_line__order_id"."company_dependent_name"->%s,to_jsonb(%s::VARCHAR))->>0)::VARCHAR)
        """
        self.env["ir.default"].set(
            "test_read_group.order", "company_dependent_name", "name with space"
        )
            ...
            with self.assertQueries([query_expected]):
                ...
                self.assertEqual(
                    ...
                    [
                        {
                            "__count": 3,
                            "__extra_domain": domain_for_sequence(
    ...
    def test_groupby_chain_fnames_date(self):
        ...
        result = RelatedBase.formatted_read_group(
            [], ["foo_id.schedule_datetime:day"], ["__count"]
        )
        self.assertEqual(
            result,
            [
...
class TestFormattedReadGroupMonetary(common.TransactionCase):
    ...
    def test_monetary_fields_agg_in_fields_get(self):
        ...
        self.assertEqual(
            field_infos["total_in_related_stored_currency_id"].get("aggregator"),
            "sum",
        )
        self.assertFalse(
            field_infos["total_in_related_non_stored_currency_id"].get("aggregator"),
            False,
        )
    ...
    def test_sum_monetary_rated_us(self):
        ...
        self.assertEqual(
            self.MonetaryAgg.formatted_read_grouping_sets(
                [], grouping_sets, aggregates
            ),
            [
                self.MonetaryAgg.formatted_read_group([], groupy, aggregates)
                for groupy in grouping_sets
            ],
        )
