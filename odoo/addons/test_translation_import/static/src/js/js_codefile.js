...
export class TestTranslationExportModel {
    testFunction() {
        ...
        _t("JS Export 05 %(named)s", {
            named: _t("JS Export 06 (Nested Named)"),
        });

        _t(
            "JS Export 07 %s",
            dummyFunction(_t("JS Export 08 (Double Nested)")),
        );
        ...
        _t(
            "JS Export 11 %s",
            dummy.dummyFunction(_t("JS Export 12 (Double Nested)")),
        );
        _t("JS Export 13 %(named)s", {
            named: dummy.dummyFunction(
                _t("JS Export 14 (Double Nested Named)"),
            ),
        });

        _t(
            "JS Export 15 %s",
            dummy["dummyFunction"](_t("JS Export 16 (Double Nested)")),
        );
        _t("JS Export 17 %(named)s", {
            named: dummy["dummyFunction"](
                _t("JS Export 18 (Double Nested Named)"),
            ),
        });
        ...
        dummyFunction(
            `NO - JS Export 08${_t("JS Export 27")}NO - JS Export 09`,
        );
    }
}
