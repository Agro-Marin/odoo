...
registry.category("web_tour.tours").add("widget_x2many", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger:
                ".o_field_widget[name=moderator] .o-autocomplete--dropdown-menu .o_m2o_dropdown_option_create_edit a",
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger:
                'tr:has(td:text(Mitchell Admin)) .o_list_record_selector input[type="checkbox"]',
            run: "click",
        },
        {
            trigger:
                'tr:has(td:text(Mitchell Admin)) .o_list_record_selector input[type="checkbox"]:checked',
        },
        {
        ...
        {
            trigger:
                ".o_field_widget[name=participants] .o_data_cell:text(Mitchell Admin)",
        },
        ...stepUtils.saveForm(),
        {
        ...
        },
        {
            ...
            trigger:
                'tr:has(td:text(Marc Demo)) .o_list_record_selector input[type="checkbox"]',
            run: "click",
        },
        {
            trigger:
                'tr:has(td:text(Marc Demo)) .o_list_record_selector input[type="checkbox"]:checked',
        },
        {
            content: "save selected participants",
            trigger: ".o_select_button",
        ...
        {
            trigger:
                "body:not(:has(.o_field_widget[name=participants] tbody .o_data_row:eq(3)))",
        },
        {
            content: "check data 3",
            trigger:
                ".o_content:has(.o_field_widget[name=participants] tbody .o_data_row:eq(2))",
        },
        {
        ...
        },
        {
            ...
            trigger:
                '.o_field_widget[name="author"] .o-autocomplete--dropdown-menu li:contains(Marc Demo)',
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger:
                '.o_field_widget[name="message_concat"] textarea:value([test_trigger] Mitchell Admin:e)',
        },
        {
            content: "save changes",
            trigger: ".modal-footer .o_form_button_save",
        ...
        },
        {
            content: "remove e",
            trigger:
                ".o_field_widget[name=messages] .o_data_row:has(.o_data_cell:text(e)) .o_list_record_remove",
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger:
                ".o_content:has(.o_field_widget[name=messages] tbody:has(tr td:text(aaa)):has(tr td:text(c)):has(tr td:text(d)))",
        },
        {
        ...
        {
            trigger:
                ".o_content:not(:has(.o_field_widget[name=participants] tbody .o_data_row:eq(3)))",
        },
        {
        ...
        {
            content:
                "switch to the second form view to test one2many with editable list (toggle menu dropdown)",
            trigger:
                'button[data-menu-xmlid="test_orm.menu_main"], li.o_extra_menu_items a i.fa-plus',
            run: "click",
        },
        {
            content:
        ...
        },
        {
            ...
            trigger:
                '.o_field_widget[name=messages] .o_field_many2one[name="author"] input',
            run: "click",
        },
        {
            content: "test one2many's line onchange",
            trigger:
                ".o_field_widget[name=messages] .o_selected_row td:eq(3):contains(3)",
        },
        {
        ...
        },
        {
            content: "test one2many's line onchange after many2one",
            trigger:
                ".o_field_widget[name=messages] td:contains([test_trigger2] Marc Demo)",
        },
        {
            content: "change text value",
            trigger: '.o_field_widget[name="body"] textarea',
        ...
        },
        {
            ...
            trigger:
                '.o_field_widget[name="message_concat"] textarea:value([test_trigger2] Marc Demo:ccccc)',
        },
        {
            content: "click outside to trigger one2many onchange",
        ...
        },
        {
            content: "add a tag",
            trigger:
                '.o_field_widget[name="categories"] .o-autocomplete--dropdown-menu li a:first',
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger:
                '.o_content:not(:has(.o_field_widget[name="message_concat"] textarea:value(Mitchell Admin:d)))',
        },
        {
        ...
        {
            trigger:
                "body:not(:has(.o_field_widget[name=messages] tbody .o_data_row:eq(2)))",
        },
        {
        ...
        {
            content:
                "switch to the third form view to test onchange changing one2many (toggle menu dropdown)",
            trigger:
                'button[data-menu-xmlid="test_orm.menu_main"], li.o_extra_menu_items a i.fa-plus',
            run: "click",
        },
        ...
        {
            trigger:
                ".o_field_widget[name=important_messages] .o_data_row .o_list_number:text(13)",
        },
        {
            content: "check new dummy message happened",
            trigger:
                ".o_field_widget[name=messages] .o_data_row .o_list_number:text(13)",
        },
        {
            content: "check field not in embedded view received correctly",
            trigger:
                '.o_field_widget[name=messages] .o_data_row input[type="checkbox"]:checked',
        },
        {
        ...
        },
        {
            ...
            trigger:
                ".o_field_widget[name=messages] .o_data_row td:contains([removed_title])",
        },
        {
            content: "set discussion title to generate dummy message",
            trigger: ".o_field_widget[name=name] input",
        ...
        {
            trigger:
                ".o_field_widget[name=important_messages] .o_data_row .o_list_number:text(22)",
        },
        {
            content: "check update and new dummy message happened",
            trigger:
                ".o_field_widget[name=messages] .o_data_row .o_list_number:text(22)",
        },
        ...stepUtils.discardForm(),
    ],
});
