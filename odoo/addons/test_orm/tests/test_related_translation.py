...
class TestRelatedTranslation(odoo.tests.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.test1 = (
            cls.env["test_orm.related_translation_1"]
        ...
        cls.test1.update_field_translations(
            "html",
            {
                "fr_FR": {
                    "Knife": "Couteau",
        ...
        cls.test12.update_field_translations(
            "html",
            {
                "fr_FR": {
                    "Knife 2": "Couteau 2",
        ...
        cls.test2 = (
            cls.env["test_orm.related_translation_2"]
            .with_context(lang="en_US")
            .create(
                {
        ...
        cls.test3 = (
            cls.env["test_orm.related_translation_3"]
            .with_context(lang="en_US")
            .create(
                {
    ...
    def test_translate_from_ori(self):
        ...
        self.assertEqual(self.test2.with_context(lang="fr_FR").name, "Couteau")
        self.assertEqual(
            self.test2.with_context(lang="en_US").computed_name, "New knife"
        )
        ...
        self.assertEqual(
            self.test2.with_context(lang="fr_FR").computed_name,
            "Nouveau couteau",
        )
        self.assertEqual(self.test3.with_context(lang="en_US").name, "New knife")
        self.assertEqual(self.test3.with_context(lang="fr_FR").name, "Nouveau couteau")
    ...
    def test_write_from_ori_term(self):
        self.test1.with_context(
            lang="fr_FR"
        ).html = "<p>Nouveau couteau</p><p>Fourchette</p><p>Cuiller</p>"
        self.assertEqual(
            self.test1.with_context(lang="en_US").html,
            "<p>Nouveau couteau</p><p>Fork</p><p>Spoon</p>",
        )
        self.assertEqual(
            self.test1.with_context(lang="fr_FR").html,
            "<p>Nouveau couteau</p><p>Fourchette</p><p>Cuiller</p>",
        )
        self.assertEqual(
            self.test2.with_context(lang="en_US").html,
            "<p>Nouveau couteau</p><p>Fork</p><p>Spoon</p>",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            self.test3.with_context(lang="fr_FR").html,
            "<p>Nouveau couteau</p><p>Fourchette</p><p>Cuiller</p>",
        )

    def test_delay_write_from_ori_term(self):
        self.test1.with_context(
            lang="fr_FR", delay_translations=True
        ).html = "<p>Nouveau couteau</p><p>Fourchette</p><p>Cuiller</p>"
        self.assertEqual(
            self.test1.with_context(lang="en_US").html,
            "<p>Knife</p><p>Fork</p><p>Spoon</p>",
        )
        self.assertEqual(
            self.test1.with_context(lang="fr_FR").html,
            "<p>Nouveau couteau</p><p>Fourchette</p><p>Cuiller</p>",
        ...
        self.assertEqual(
            self.test1.with_context(lang="en_US", check_translations=True).html,
            "<p>Nouveau couteau</p><p>Fork</p><p>Spoon</p>",
        )
        self.assertEqual(
            self.test1.with_context(lang="fr_FR", check_translations=True).html,
            "<p>Nouveau couteau</p><p>Fourchette</p><p>Cuiller</p>",
        )
        self.assertEqual(
            self.test2.with_context(lang="en_US", check_translations=True).html,
            "<p>Nouveau couteau</p><p>Fork</p><p>Spoon</p>",
        )
        self.assertEqual(
            self.test2.with_context(lang="fr_FR", check_translations=True).html,
            "<p>Nouveau couteau</p><p>Fourchette</p><p>Cuiller</p>",
        )
        self.assertEqual(
            self.test3.with_context(lang="en_US", check_translations=True).html,
            "<p>Nouveau couteau</p><p>Fork</p><p>Spoon</p>",
        )
        self.assertEqual(
            self.test3.with_context(lang="fr_FR", check_translations=True).html,
            "<p>Nouveau couteau</p><p>Fourchette</p><p>Cuiller</p>",
        )
    ...
    def test_translate_from_ori_term(self):
        ...
        self.assertEqual(
            self.test1.with_context(lang="fr_FR").html,
            "<p>Couteau</p><p>Fourchette</p><p>Cuiller</p>",
        )
        self.assertEqual(
            self.test2.with_context(lang="en_US").html,
            "<p>Knife</p><p>Fork</p><p>Spoon</p>",
        ...
        self.assertEqual(
            self.test2.with_context(lang="en_US").computed_html,
            "<p>Knife</p><p>Fork</p><p>Spoon</p>",
        )
        self.assertEqual(
            self.test2.with_context(lang="fr_FR").computed_html,
            "<p>Couteau</p><p>Fourchette</p><p>Cuiller</p>",
        )
        self.assertEqual(
            self.test3.with_context(lang="en_US").html,
        ...
        self.test1.update_field_translations(
            "html", {"fr_FR": {"Knife": "Nouveau couteau"}}
        )
        self.assertEqual(
            self.test1.with_context(lang="en_US").html,
            "<p>Knife</p><p>Fork</p><p>Spoon</p>",
    ...
    def test_translate_from_related_term(self):
        ...
        self.test3.update_field_translations(
            "html", {"fr_FR": {"Knife": "Nouveau couteau"}}
        )
        self.assertEqual(
            self.test1.with_context(lang="en_US").html,
    ...
    def test_translate_change_many2one(self):
        ...
        self.assertEqual(
            self.test3.with_context(lang="en_US").html,
            "<p>Knife 2</p><p>Fork 2</p><p>Spoon 2</p>",
        )
        self.assertEqual(
            self.test3.with_context(lang="fr_FR").html,
            "<p>Couteau 2</p><p>Fourchette 2</p><p>Cuiller 2</p>",
        )
    ...
    def test_translate_mapped(self):
        self.assertEqual(
            self.test2.with_context(lang="en_US").mapped("name"), ["Knife"]
        )
        self.test1.with_context(lang="en_US").name = "New knife"
        self.assertEqual(
            self.test1.with_context(lang="en_US").mapped("name"), ["New knife"]
        )
        self.assertEqual(
            self.test1.with_context(lang="fr_FR").mapped("name"), ["Couteau"]
        )
        self.assertEqual(
            self.test2.with_context(lang="en_US").mapped("name"), ["New knife"]
        )
        self.assertEqual(
            self.test2.with_context(lang="en_US").mapped("related_id.name"),
            ["New knife"],
        )
        self.assertEqual(
            self.test2.with_context(lang="fr_FR").mapped("name"), ["Couteau"]
        )
        self.assertEqual(
            self.test2.with_context(lang="fr_FR").mapped("related_id.name"),
            ["Couteau"],
        )
        self.assertEqual(
            self.test3.with_context(lang="en_US").mapped("name"), ["New knife"]
        )
        self.assertEqual(
            self.test3.with_context(lang="fr_FR").mapped("related_id.name"),
            ["Couteau"],
        )
        self.assertEqual(
            self.test3.with_context(lang="fr_FR").mapped("name"), ["Couteau"]
        )
        self.assertEqual(
            self.test3.with_context(lang="fr_FR").mapped("related_id.name"),
            ["Couteau"],
        ...
        self.assertEqual(
            self.test1.with_context(lang="fr_FR").mapped("name"),
            ["Nouveau couteau"],
        )
        self.assertEqual(
            self.test2.with_context(lang="en_US").mapped("name"), ["New knife"]
        ...
        self.assertEqual(
            self.test2.with_context(lang="fr_FR").mapped("name"),
            ["Nouveau couteau"],
        )
        self.assertEqual(
            self.test2.with_context(lang="fr_FR").mapped("related_id.name"),
        ...
        self.assertEqual(
            self.test3.with_context(lang="en_US").mapped("related_id.name"),
            ["New knife"],
        )
        self.assertEqual(
            self.test3.with_context(lang="fr_FR").mapped("name"),
            ["Nouveau couteau"],
        )
        self.assertEqual(
            self.test3.with_context(lang="fr_FR").mapped("related_id.name"),
    ...
    def test_new_records(self):
        ...
        child_en = self.env["test_orm.related_translation_2"].new(
            {"related_id": record_en.id}
        )
    ...
    def test_new_records_html(self):
        ...
        self.assertEqual(
            record_en.html, "<p>Couteau</p><p>Fourchette</p><p>Cuiller</p>"
        )
        self.assertEqual(
            record_fr.html, "<p>Couteau</p><p>Fourchette</p><p>Cuiller</p>"
        )
