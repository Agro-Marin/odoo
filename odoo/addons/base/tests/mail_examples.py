...
HOTMAIL_1 = """<div>
    <div dir="ltr"><br>
        ...
        <div>
            ...
            <hr id="stopSpelling">
            Subject: Re: your Odoo.com registration<br>From: xxx@xxx.xxx<br>To: xxx@xxx.xxx<br>Date: Wed, 27 Mar 2013 17:12:12 +0000
            <br><br>
            Hello xxx,
            <br>
            I noticed you recently created an Odoo.com account to access Odoo Apps.
            <br>
            You indicated that you wish to use Odoo in your own company.
...
HOTMAIL_1_OUT = [
    ...
    """<pre data-o-mail-quote="1">
                <a href="http://odoo.com" target="_blank" data-o-mail-quote="1">http://odoo.com</a>
                Belgium: +32.81.81.37.00
                U.S.: +1 (650) 307-6736
                India: +91 (79) 40 500 100
            </pre>""",
...
<div class="WordSection1">
        ...
        <p class="MsoNormal">
            <span style="font-size:11.0pt;font-family:&quot;Calibri&quot;,&quot;sans-serif&quot;;color:#1F497D">
                ...
                If we adopt Odoo we will probably move to Linux or look for a hosted SaaS option.
            </span>
        </p>
        <p></p>
        <p></p>
            ...
            <div style="border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0in 0in 0in">
                <p class="MsoNormal">
                    ...
                    <span style="font-size:10.0pt;font-family:&quot;Tahoma&quot;,&quot;sans-serif&quot;">
                        Odoo Enterprise [mailto:sales@odoo.com]
                        <br><b>Sent:</b> Monday, 11 March, 2013 14:47<br><b>To:</b> Alan Widmer<br><b>Subject:</b> Re: your Odoo.com registration
                    </span>
                </p>
                <p></p>
                <p></p>
        ...
        <p></p>
        <p>I noticed you recently downloaded Odoo. </p>
        <p></p>
        <p>
            Uou mentioned you wish to use Odoo in your own company. Please let me more about your
            business needs and requirements? When will you be available to discuss about your project?
        </p>
        <p></p>
        <p>Thanks for your interest in Odoo, </p>
        <p></p>
...
MSOFFICE_1_OUT = [
    "I noticed you recently downloaded Odoo.",
    "Uou mentioned you wish to use Odoo in your own company.",
    "Belgium: +32.81.81.37.00",
]
...
<div style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman'; COLOR: #000000">
    ...
    <div>&nbsp;</div>
    <div class="o_web_client oe_webclient">
    ...
    <div role="dialog" tabindex="-1" aria-hidden="false" class="modal in" style="DISPLAY: block" data-backdrop="static">
        <div class="modal-dialog modal-lg">
            <div class="modal-content o_web_client">
