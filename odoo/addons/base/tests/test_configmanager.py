...
class TestConfigManager(TransactionCase):
        ...
        self.assertConfigEqual(
            {
                ...
                "with_demo": False,
                "registry_lru_size": 42,
                "registry_idle_timeout": 0,
    ...
    def test_06_syslog_logfile_exclusive_cli(self, error):
        ...
        error.assert_has_calls(
            2 * [call("the syslog and logfile options are exclusive")]
        )
    ...
    def test_10_init_update_incompatible_with_multidb(self, error):
        ...
        self.parse_reset(
            ["-c", file_path("base/tests/config/multidb.conf"), "-i", "base"]
        )
        self.parse_reset(
            ["-c", file_path("base/tests/config/multidb.conf"), "-u", "base"]
        )
        error.assert_has_calls(
            4
            * [
