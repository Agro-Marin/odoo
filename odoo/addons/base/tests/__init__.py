...
from . import test_res_users_rehash_audit
from . import test_ir_actions_report_audit
from . import test_ir_cron_audit
from . import test_ir_default_audit
from . import test_ir_module_audit
from . import test_ir_autovacuum_audit
from . import test_ir_mail_server_audit
from . import test_ir_ui_view_audit
from . import test_res_config_audit
from . import test_res_company_audit
from . import test_report_layout_audit
from . import test_res_users_deletion_audit
from . import test_ir_actions_audit
from . import test_ir_qweb_audit
from . import test_res_lang_audit
from . import test_ir_asset_audit
from . import test_res_partner_barcode_audit
...
from . import test_properties_base_definition_audit
