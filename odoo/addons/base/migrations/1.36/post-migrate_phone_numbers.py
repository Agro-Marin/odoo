...
SOURCES = (
    ("res_partner", "phone", "landline", "res_partner_phone_number_rel", "partner_id"),
    ("res_partner", "mobile", "mobile", "res_partner_phone_number_rel", "partner_id"),
    ("res_bank", "phone", "landline", "res_bank_phone_number_rel", "bank_id"),
)
