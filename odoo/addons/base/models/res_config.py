    ...
    *   For the other fields, the method ``execute`` invokes `set_values`.
    ...
    def set_values(self) -> None:
        ...
        for name, groups, implied_group in sorted(
            ...
            # tests) where the env user may not carry that group explicitly.
            groups = groups.sudo()
    ...
    def execute(self) -> dict[str, Any]:
        ...
        if installation_status:
            # After the install call, the registry and environments
    ...
    def get_option_path(self, menu_xml_id: str) -> tuple[str, int]:
        ...
        :param str menu_xml_id: the xml id of the menuitem where the view is located,
    ...
    def get_option_name(self, full_field_name: str) -> str:
        ...
        :param str full_field_name: the full name of the field, structured as follows:
