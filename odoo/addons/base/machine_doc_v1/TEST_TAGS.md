...
```bash
# All base tests (4249 methods, 853 classes, 152 files)
...
### Tagged Files (90 files, 506 classes)
...
| Total test classes | 853 |
| Total test methods | 4249 |
| Files with @tagged | 90 (59%) |
