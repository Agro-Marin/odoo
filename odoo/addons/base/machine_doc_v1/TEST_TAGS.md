...
```bash
# All base tests (4157 methods, 836 classes, 146 files)
...
### Tagged Files (85 files, 494 classes)
...
| Total test methods | 4157 |
| Files with @tagged | 85 (58%) |
| Files without @tagged | 61 (42%) |
| Classes using post_install | 284 |
| Unique tags | 29 |
