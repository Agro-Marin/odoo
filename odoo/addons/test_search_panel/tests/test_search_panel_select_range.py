...
class TestSelectRange(odoo.tests.TransactionCase):
    ...
    def setUp(self):
        ...
        self.TargetModelNoParentName = self.env[
    ...
    def test_many2one(self):
        ...
        children_folders = self.TargetModel.create(
            [
                {
                    "name": "Folder 3",
                    "parent_name_id": f1_id,
                },
                {
                    "name": "Folder 4",
                    "parent_name_id": f2_id,
                },
            ]
        )
        ...
        self.assertEqual(
            result,
            {
                "parent_field": "parent_name_id",
                "values": [],
            },  # should not be a SEARCH_PANEL_ERROR
        )
    ...
    def test_many2one_deep_hierarchy(self):
        ...
        folders_level_2 = self.TargetModel.create(
            [
                {
                    "name": "Folder 7",
                    "parent_name_id": f4_id,
                },
                {
                    "name": "Folder 8",
                    "parent_name_id": f6_id,
                },
            ]
        )
        ...
        self.assertEqual(
            ...
            [
                ...
                {
                    "__count": 0,
                    "display_name": "Folder 5",
                    "id": f5_id,
                    "parent_name_id": f2_id,
                },
                {
                    "__count": 3,
                    "display_name": "Folder 6",
                    "id": f6_id,
                    "parent_name_id": f2_id,
                },
                {
                    "__count": 2,
                    "display_name": "Folder 7",
                    "id": f7_id,
                    "parent_name_id": f4_id,
                },
                {
                    "__count": 2,
                    "display_name": "Folder 8",
                    "id": f8_id,
                    "parent_name_id": f6_id,
                },
                {
                    "__count": 1,
                    "display_name": "Folder 9",
                    "id": f9_id,
                    "parent_name_id": f8_id,
                },
            ],
