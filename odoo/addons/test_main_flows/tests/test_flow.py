...
class TestUi(BaseTestUi):
    ...
    def _setup_multicompany_access_error(self):
        ...
        record_p2 = self.env["test.model_multicompany"].create(
    ...
    def test_company_access_error_redirect(self):
        ...
        with mute_logger("odoo.http"):
            self.start_tour(
                ...
                "test_company_access_error_redirect",
                login="admin",
                cookies={"cids": f"{company1.id}"},
            )
    ...
    def test_company_switch_access_error_debug(self):
        ...
        with mute_logger("odoo.http"):
            self.start_tour(
                f"/odoo/action-{act_window.id}?debug=assets",
                "test_company_switch_access_error",
                login="admin",
                cookies={"cids": current_companies},
            )
