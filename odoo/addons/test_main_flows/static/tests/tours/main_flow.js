...
registry.category("web_tour.tours").add("main_flow_tour", {
    ...
    steps: () => [
        ...
        {
            trigger:
                ".dropdown-item:contains('Products'), nav.o_burger_menu_content li[data-menu-xmlid='sale.menu_product_template_action']",
            content: _t("Let's create products."),
            tooltipPosition: "bottom",
            run: "click",
        },
        ...
        {
            trigger:
                '.o_field_widget[name=route_ids] .form-check > label:contains("Manufacture")',
        ...
        {
            trigger:
                '.o_field_widget[name=route_ids] .form-check > label:contains("Buy")',
        ...
        {
            trigger:
                '.o_field_widget[name=route_ids] .form-check > label:contains("Replenish on Order (MTO)")',
        ...
        },
        {
            isActive: ["mobile"],
            trigger:
                '.modal-body .o_form_editable .o_field_widget[name="name"] textarea',
            content: _t("Select a product, or create a new one on the fly."),
            tooltipPosition: "right",
            run: "edit the_flow.component1",
        },
        ...
        },
        {
            isActive: ["desktop"],
            trigger:
                ".o_field_widget[name=seller_ids] .o_field_x2many_list_row_add > a",
        ...
        },
        {
            isActive: ["mobile"],
            trigger:
                ".modal:not(.o_inactive_modal) .o_form_editable div:contains('Vendor')",
        },
        {
            isActive: ["mobile"],
            trigger:
        ...
        },
        {
            isActive: ["mobile"],
            trigger:
                ".modal:not(.o_inactive_modal) .modal-title:contains(create vendor)",
        },
        {
            isActive: ["mobile"],
        ...
        },
        {
            isActive: ["mobile"],
            trigger:
                ".o_field_widget[name=min_qty] + .o_field_widget[name=product_uom_id] input",
            run: "click",
        },
        {
            isActive: ["mobile"],
        ...
        },
        {
            isActive: ["mobile"],
            trigger:
                ".modal:not(.o_inactive_modal) .modal-footer .btn-primary:contains(Save & Close):enabled",
        ...
        },
        {
            isActive: ["mobile"],
            trigger:
                ".modal:not(.o_inactive_modal) .modal-footer .btn-primary:contains(Save):enabled",
            content: _t("Save"),
            tooltipPosition: "right",
            run: "click",
        },
        ...
        },
        {
            isActive: ["mobile"],
            trigger:
                ".modal:not(.o_inactive_modal) .modal-body .o_form_editable .o_field_widget[name=name] textarea",
            content: _t("Select a product, or create a new one on the fly."),
            tooltipPosition: "right",
        ...
        },
        {
            isActive: ["desktop"],
            trigger:
                ".o_field_widget[name=bom_line_ids] .o_data_row:nth-child(2).o_selected_row",
        },
        {
            isActive: ["desktop"],
            trigger:
        ...
        },
        {
            isActive: ["mobile"],
            trigger:
                ".modal:not(.o_inactive_modal) .modal-footer .btn-primary:contains(Save & Close)",
            content: _t("Save & Close"),
            tooltipPosition: "right",
            run: "click",
        },
        {
            isActive: ["mobile"],
            trigger:
                ".modal:not(.o_inactive_modal) .modal-title:contains(create component)",
        },
        {
            isActive: ["mobile"],
            trigger:
        ...
        },
        {
            isActive: ["mobile"],
            trigger:
                ".modal:not(.o_inactive_modal) .o_field_widget[name=name] textarea",
            content: _t("Let's enter the name."),
            tooltipPosition: "left",
            run: "edit the_flow.project",
        },
        ...
        },
        {
            ...
            content: markup(
                _t(
                    "Click here to <b>create your first opportunity</b> and add it to your pipeline.",
                ),
            ),
            tooltipPosition: "bottom",
            run: "click",
        ...
        },
        {
            isActive: ["mobile"],
            trigger:
                ".modal:not(.o_inactive_modal) .o_field_widget[name=name] textarea:not(.o_invisible_modifier), .modal:not(.o_inactive_modal) .o_field_widget[name=name] input:not(.o_invisible_modifier)",
            content: _t("Let's enter the name."),
            tooltipPosition: "left",
            run: "edit the_flow.customer",
        },
        ...
        },
        {
            isActive: ["desktop"],
            trigger:
                ".o_kanban_group:first .o_kanban_record span:contains('the_flow.opportunity')",
            content: markup(
                _t(
        ...
        },
        {
            isActive: ["desktop"],
            trigger:
                ".o_kanban_group:eq(2) > .o_kanban_record span:contains('the_flow.opportunity')",
        ...
        {
            isActive: ["mobile"],
            trigger: ".o_field_widget[name=line_ids] .btn:contains(Add)",
            content: _t("Click here to add some lines to your quotations."),
            tooltipPosition: "bottom",
            run: "click",
        },
        ...
        },
        {
            isActive: ["mobile"],
            trigger:
                ".modal:not(.o_inactive_modal) .modal-footer .btn-primary:contains('Save & New')",
            content: _t("Save & New"),
            tooltipPosition: "right",
            run: "click",
        },
        ...
        },
        {
            isActive: ["mobile"],
            trigger:
                ".o_field_widget[name=line_ids] .o_kanban_record:contains(the_flow.product)",
        },
        {
            isActive: ["mobile"],
            trigger: ".o_field_widget[name=product_id] input",
        ...
        {
            trigger:
                ".o-mail-RecipientsInputTagsListPopover .btn-primary:contains(Set Email)",
        ...
        {
            trigger:
                ".modal:not(.o_inactive_modal) .modal-footer .btn-primary:contains(Send)",
        ...
        },
        {
            isActive: ["desktop"],
            trigger:
                ".o_menu_sections button[data-menu-xmlid='stock.menu_stock_warehouse_mgmt']",
        ...
        {
            trigger:
                ".dropdown-item[data-menu-xmlid='stock.menu_reordering_rules_replenish'], nav.o_burger_menu_content li[data-menu-xmlid='stock.menu_reordering_rules_replenish']",
        ...
        ),
        {
            isActive: ["desktop"],
            trigger:
                '.o_data_row:has(.o_data_cell:contains("the_flow.vendor")) .o_data_cell:first',
        ...
        ),
        {
            isActive: ["mobile"],
            trigger:
                ".o_breadcrumb .active:contains('Manufacturing Orders'), .o_breadcrumb .active:contains('Work Centers Overview')",
        },
        {
            isActive: ["mobile"],
            trigger: ".o_menu_toggle",
        ...
        },
        {
            isActive: ["desktop"],
            trigger:
                ".o_menu_sections button[data-menu-xmlid='mrp.menu_mrp_manufacturing']",
        ...
        {
            trigger:
                ".dropdown-item[data-menu-xmlid='mrp.menu_mrp_production_action'], nav.o_burger_menu_content li[data-menu-xmlid='mrp.menu_mrp_production_action']",
        ...
        },
        {
            isActive: ["desktop"],
            trigger:
                '.o_data_row:has(.o_data_cell:contains("the_flow.product")):first .o_data_cell:first',
        ...
        ...stepUtils.statusbarButtonsSteps(
            "Produce All",
            _t("Produce All"),
            ".o_statusbar_status .dropdown-toggle:contains('To Close')",
        ),
        ...stepUtils.toggleHomeMenu(),
        ...stepUtils.goToAppSteps(
            "sale.menu_sale_root",
        ...
        {
            trigger:
                ".dropdown-item[data-menu-xmlid='sale.menu_sale_order'], nav.o_burger_menu_content li[data-menu-xmlid='sale.menu_sale_order']",
        ...
        },
        {
            ...
            content: _t("Open the Kanban Record"),
            run: "click",
        },
        {
        ...
        ...stepUtils.statusbarButtonsSteps(
            "Confirm",
            _t("Validate"),
            ".o_breadcrumb .active:contains('Draft Invoice')",
        ),
        ...stepUtils.statusbarButtonsSteps(
            "Pay",
            _t("Pay"),
            ".o_statusbar_status .dropdown-toggle:contains('Posted')",
        ),
        {
            trigger: ".modal .modal-footer .btn-primary",
            content: _t("Validate"),
        ...
        },
        {
            isActive: ["enterprise", "desktop"],
            trigger:
                ".o_selected_row .o_field_widget[name=partner_id] .o_external_button",
        },
        {
            isActive: ["enterprise", "desktop"],
            trigger: ".o_list_button_save",
