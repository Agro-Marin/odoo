"""Transient model implementation.

TransientModel provides a base class for temporary records that are
automatically cleaned up after a configurable time period.
"""
